var Es=new Map;function pe(e,t,a,r,o,i,d,s,c="owner"){let u=Object.freeze({id:e,kind:t,version:a,cardinality:r,validate:o,identities:i,identityScope:c,serviceCalls:d,serviceMetadata:s});return Es.set(`${t}:${e}@${a}`,u),u}var da="edit",Rt=256,la=1e4;function Sn(e){let t=new Map(e.map(a=>[a.name,a]));return{tools:e.map(({run:a,...r})=>Object.freeze({...r})),execute:async(a,r,o)=>{let i=t.get(a);if(!i)throw new Error(`Unknown provider-owned agent tool: ${a}`);return i.run(r,o)}}}var K=e=>!!e&&typeof e=="object"&&!Array.isArray(e),ce=(e,t)=>typeof e[t]=="function",bt=e=>e===void 0,$t=e=>typeof e=="boolean",G=e=>typeof e=="string",Ie=e=>e===void 0||G(e),Cs=e=>e===void 0||typeof e=="number",Is=e=>e===void 0||typeof e=="boolean",ae=(e,t)=>e.length===t.length&&t.every((a,r)=>a(e[r])),xe=e=>K(e)&&typeof e.ok=="boolean"&&(e.error===void 0||typeof e.error=="string"),Sr=e=>K(e),Cr=e=>K(e)&&G(e.id)&&G(e.title)&&G(e.date)&&(e.documentRef===void 0||K(e.documentRef)&&G(e.documentRef.pluginId)&&G(e.documentRef.sourceId)&&G(e.documentRef.itemId)),Ds=e=>K(e)&&G(e.date)&&Ie(e.startTime)&&Ie(e.endTime)&&Ie(e.sourceId)&&Ie(e.itemId),As=e=>K(e)&&G(e.url)&&Ie(e.title)&&Is(e.newTab),Ts=e=>K(e)&&G(e.query),Ir=e=>K(e)&&G(e.name)&&Ie(e.context)&&Number.isFinite(e.lng)&&Number.isFinite(e.lat),Ns=e=>Array.isArray(e)&&e.every(Ir),Ps=e=>e===null||Ir(e),Ms=e=>e===void 0||K(e)&&Ie(e.approvalToken)&&(e.cancellation===void 0||K(e.cancellation)),Os=e=>typeof e=="string"||K(e)&&typeof e.text=="string",_s=e=>K(e)&&typeof e.name=="string"&&e.name.trim().length>0&&typeof e.description=="string"&&K(e.parameters)&&(e.sideEffect==="read"||e.sideEffect==="write")&&Ie(e.commandId)&&(e.commandDispatch===void 0||e.commandDispatch==="dynamic")&&(e.timeoutMs===void 0||Number.isSafeInteger(e.timeoutMs)&&Number(e.timeoutMs)>0&&Number(e.timeoutMs)<=3e5),Dr=e=>K(e)&&G(e.id)&&G(e.label)&&Ie(e.labelKey)&&Ie(e.description)&&(e.danger===void 0||typeof e.danger=="boolean")&&(e.enabled===void 0||typeof e.enabled=="boolean")&&(e.submenu===void 0||Array.isArray(e.submenu)&&e.submenu.every(Dr)),Ar={list:{args:e=>e.length===0,result:e=>Array.isArray(e)&&e.every(Cr)},create:{args:e=>ae(e,[G,Sr]),result:$t},update:{args:e=>ae(e,[G,Sr]),result:$t},remove:{args:e=>ae(e,[G]),result:$t},open:{args:e=>ae(e,[G]),result:bt},configure:{args:e=>e.length===0,result:bt},actions:{args:e=>ae(e,[G]),result:e=>Array.isArray(e)&&e.every(Dr)},runAction:{args:e=>ae(e,[G,G]),result:$t}},Tr=e=>K(e)&&G(e.name)&&G(e.version)&&Ie(e.description)&&Ie(e.author)&&(e.localized===void 0||K(e.localized)&&Object.values(e.localized).every(t=>K(t)&&G(t.name)&&Ie(t.description))),ca=pe("calendar.itemSource","service","1.3.0","many",e=>K(e)&&ce(e,"list")&&(e.integration===void 0||Tr(e.integration)),void 0,Ar,e=>e.integration),Ia=e=>typeof e=="string"&&/^\d{4}-\d{2}-\d{2}$/.test(e)&&Number.isFinite(Date.parse(`${e}T00:00:00Z`))&&new Date(`${e}T00:00:00Z`).toISOString().slice(0,10)===e,kn=e=>typeof e=="string"&&e.length>0&&e.length<=8192,Ls=e=>K(e)&&Ia(e.startDate)&&Ia(e.endDate)&&e.startDate<=e.endDate&&typeof e.limit=="number"&&Number.isInteger(e.limit)&&e.limit>0&&e.limit<=Rt&&(e.cursor===void 0||kn(e.cursor)),zs=e=>K(e)&&kn(e.revision)&&(e.cursor===void 0||kn(e.cursor))&&Array.isArray(e.items)&&e.items.length<=Rt&&e.items.every(t=>Cr(t)&&Ia(t.date)&&(t.endDate===void 0||Ia(t.endDate)&&t.endDate>=t.date))&&new Set(e.items.map(t=>t.id)).size===e.items.length,vt=pe("calendar.itemSource","service","2.0.0","many",e=>K(e)&&ce(e,"list")&&(e.integration===void 0||Tr(e.integration)),void 0,{...Ar,list:{args:e=>ae(e,[Ls]),result:zs}},e=>e.integration),Da=pe("calendar.itemSourceRevision","state","1.0.0","many",e=>typeof e=="number"&&Number.isSafeInteger(e)&&e>=0),En=pe("calendar.navigator","service","1.0.0","one",e=>K(e)&&ce(e,"openDate"),void 0,{openDate:{args:e=>ae(e,[Ds]),result:bt}}),wt=pe("calendar.panelSelection","state","1.0.0","one",e=>K(e)&&(e.selectedDate===null||typeof e.selectedDate=="string")&&(e.rangeStart===null||typeof e.rangeStart=="string")&&(e.rangeEnd===null||typeof e.rangeEnd=="string")),Fs=pe("web.activeContext","state","1.0.0","one",e=>K(e)&&typeof e.instanceId=="string"&&typeof e.url=="string"&&typeof e.title=="string");function Er(e){return K(e)&&typeof e.id=="string"&&typeof e.displayName=="string"&&(e.avatarUrl===void 0||typeof e.avatarUrl=="string")&&Array.isArray(e.emails)&&e.emails.every(t=>K(t)&&typeof t.address=="string"&&(t.label===void 0||typeof t.label=="string"))}var $s=pe("contacts.directory","service","1.0.0","one",e=>K(e)&&["search","resolveEmails","open"].every(t=>ce(e,t)),void 0,{search:{args:e=>e.length===2&&typeof e[0]=="string"&&e[0].length<=1e3&&Number.isInteger(e[1])&&Number(e[1])>0&&Number(e[1])<=50,result:e=>Array.isArray(e)&&e.length<=50&&e.every(Er)},resolveEmails:{args:e=>e.length===1&&Array.isArray(e[0])&&e[0].length<=200&&e[0].every(t=>typeof t=="string"&&t.length<=1e3),result:e=>Array.isArray(e)&&e.every(t=>K(t)&&typeof t.address=="string"&&Array.isArray(t.contacts)&&t.contacts.every(Er))},open:{args:e=>e.length>=1&&e.length<=2&&typeof e[0]=="string"&&(e[1]===void 0||K(e[1])&&(e[1].newTab===void 0||typeof e[1].newTab=="boolean")),result:bt}}),Rs=pe("contacts.directoryRevision","state","1.0.0","one",e=>Number.isSafeInteger(e)&&Number(e)>=0),Cn=pe("web.navigator","service","1.0.0","one",e=>K(e)&&ce(e,"open"),void 0,{open:{args:e=>ae(e,[As]),result:bt}}),Ks=pe("selection.textAction","extension","1.0.0","many",e=>K(e)&&typeof e.id=="string"&&typeof e.labelKey=="string"&&typeof e.label=="string"&&Array.isArray(e.surfaces)&&ce(e,"run"),e=>[e.id]),In=pe("geo.navigator","service","1.0.0","one",e=>K(e)&&ce(e,"open"),void 0,{open:{args:e=>ae(e,[Ts]),result:bt}}),Gs=pe("geo.search","service","1.0.0","one",e=>K(e)&&ce(e,"search")&&ce(e,"reverse"),void 0,{search:{args:e=>ae(e,[G]),result:Ns},reverse:{args:e=>ae(e,[t=>Number.isFinite(t),t=>Number.isFinite(t)]),result:Ps}}),Dn=pe("agent.toolProvider","service","1.0.0","many",e=>K(e)&&Array.isArray(e.tools)&&e.tools.every(_s)&&ce(e,"execute"),e=>e.tools.map(t=>t.name),{execute:{args:e=>ae(e,[G,K,Ms]),result:Os}},e=>({tools:e.tools}),"global"),js=pe("guard.runtime","service","1.0.0","one",e=>K(e)&&["resolve","requestApproval","consumeToken","audit"].every(t=>ce(e,t)),void 0,{resolve:{args:e=>ae(e,[K]),result:K},requestApproval:{args:e=>ae(e,[K]),result:$t},consumeToken:{args:e=>e.length>=1&&e.length<=2&&G(e[0])&&Ie(e[1]),result:$t},audit:{args:e=>ae(e,[K]),result:bt}}),Vs=pe("browser.automation","service","1.0.0","one",e=>K(e)&&["list","open","switch","close","snapshot","readText","readHtml","screenshot","navigate","back","forward","reload","click","type","select","scroll","pressKey"].every(t=>ce(e,t)),void 0,{list:{args:e=>e.length===0,result:xe},open:{args:e=>ae(e,[G]),result:xe},switch:{args:e=>ae(e,[G]),result:xe},close:{args:e=>ae(e,[G]),result:xe},snapshot:{args:e=>ae(e,[G]),result:xe},readText:{args:e=>e.length>=1&&e.length<=2&&G(e[0])&&Cs(e[1]),result:xe},readHtml:{args:e=>ae(e,[G]),result:xe},screenshot:{args:e=>ae(e,[G]),result:xe},click:{args:e=>ae(e,[G,t=>typeof t=="number"]),result:xe},type:{args:e=>e.length>=3&&e.length<=4&&G(e[0])&&typeof e[1]=="number"&&G(e[2])&&(e[3]===void 0||typeof e[3]=="boolean"),result:xe},select:{args:e=>ae(e,[G,t=>typeof t=="number",G]),result:xe},scroll:{args:e=>ae(e,[G,t=>typeof t=="number",t=>typeof t=="number"]),result:xe},pressKey:{args:e=>ae(e,[G,G]),result:xe},navigate:{args:e=>ae(e,[G,G]),result:xe},back:{args:e=>ae(e,[G]),result:xe},forward:{args:e=>ae(e,[G]),result:xe},reload:{args:e=>ae(e,[G]),result:xe}}),Us=pe("fileTree.contextItem","extension","1.0.0","many",e=>K(e)&&typeof e.id=="string"&&typeof e.label=="string"&&Ie(e.labelKey)&&ce(e,"run"),e=>[e.id]),Hs=pe("newTab.entry","extension","1.0.0","many",e=>K(e)&&typeof e.id=="string"&&typeof e.labelKey=="string"&&ce(e,"run"),e=>[e.id]),qs=pe("search.resultCard","extension","1.0.0","many",e=>K(e)&&typeof e.cardKind=="string"&&ce(e,"render")&&ce(e,"open"),e=>[e.cardKind]),Kt=pe("metadataPanel.segment","extension","1.0.0","many",e=>K(e)&&typeof e.id=="string"&&typeof e.labelKey=="string"&&ce(e,"render"),e=>[e.id]),An=pe("workspace.surface","extension","1.0.0","many",e=>K(e)&&typeof e.id=="string"&&["left_sidebar","right_sidebar","main_workspace","footer"].includes(String(e.surface))&&ce(e,"getSnapshot")&&ce(e,"subscribe")&&ce(e,"restore"),e=>[e.id]),Bs=pe("metadata.plugin","extension","1.0.0","many",e=>K(e)&&typeof e.id=="string"&&typeof e.labelKey=="string"&&ce(e,"facts"),e=>[e.id]),Ws=pe("workspace.viewState","extension","1.0.0","many",e=>K(e)&&typeof e.id=="string"&&["left_sidebar","right_sidebar","main_workspace"].includes(String(e.surface))&&ce(e,"capture")&&ce(e,"restore")&&ce(e,"subscribe"),e=>[e.id]);var Nr=["title","kind","aliases","frontmatter","mtimeMs","size","ctimeMs","links","linkPaths","embedPaths","tags","excluded"],Ys=new Set(["note","asset","view","other"]),Xs=e=>e.length>0&&e.length<=1024&&!["__proto__","constructor","prototype"].includes(e);function Pr(e){if(!e||typeof e!="object"||Array.isArray(e)||Object.keys(e).some(o=>!["kinds","extensions","pathPrefix","fields","frontmatterKeys"].includes(o)))throw new Error("Invalid index scope");let t=(o,i)=>{if(o!==void 0){if(!Array.isArray(o)||o.length>64||o.some(d=>typeof d!="string"||!i(d)))throw new Error("Invalid index scope selection");return[...new Set(o)].sort()}},a=e.pathPrefix;if(a!==void 0&&(typeof a!="string"||a.length>4096||a.startsWith("/")||a.includes("\\")||a.includes("\0")||a.split("/").some(o=>o==="."||o===".."||!o)))throw new Error("Invalid index path prefix");let r=t(e.fields,o=>Nr.includes(o))??[...Nr].sort();if(e.frontmatterKeys!==void 0&&!r.includes("frontmatter"))throw new Error("Frontmatter keys require the frontmatter field");return{fields:r,...e.kinds===void 0?{}:{kinds:t(e.kinds,o=>Ys.has(o))},...e.extensions===void 0?{}:{extensions:t(e.extensions,o=>/^\.[a-z0-9][a-z0-9._-]{0,31}$/.test(o))},...a===void 0?{}:{pathPrefix:a},...e.frontmatterKeys===void 0?{}:{frontmatterKeys:t(e.frontmatterKeys,Xs)}}}function Mr(e,t){return e===t||!!(e&&t&&e.vaultGeneration===t.vaultGeneration&&e.scopeGeneration===t.scopeGeneration&&e.revision===t.revision)}function Nn(e,t){let a=Pr(t),r={status:"loading",version:null,entries:Object.freeze([])},o=new Map,i=!0,d=!1,s=!0,c=0,u,h,p,m=Promise.resolve(),y,S,I=new WeakMap,M=k=>{let q=I.get(k);return q||(q=k.dispose(),I.set(k,q)),q},L=new Set,R=k=>{if(i){r=Object.freeze(k);for(let q of[...L])if(L.has(q))try{q()}catch(z){console.error("Index observer listener failed",z)}}},N=new Error("Index revision changed during read"),b=(k,q)=>{if(!k||!["loading","ready","error"].includes(k.status)||!Array.isArray(k.entries)||!Array.isArray(k.missing)||!Number.isSafeInteger(k.count)||k.count<0||k.entries.some(z=>!z||typeof z.relPath!="string")||k.status==="ready"&&(!k.version||typeof k.version.scopeGeneration!="string"||!k.version.scopeGeneration||!Number.isSafeInteger(k.version.vaultGeneration)||!Number.isSafeInteger(k.version.revision)))throw new Error("Invalid index page");if(k.reset||q&&!Mr(k.version,q))throw N;if(k.status==="error")throw new Error(k.error??"Index observation failed")},w=async()=>{if(d||!h||!i)return;d=!0;let k=0;try{for(;i&&s;){s=!1;let q=c,z=u;u=void 0;try{let U,B,ye="ready",de;if(z&&!z.reset&&r.status==="ready"&&r.version&&z.version&&z.version.vaultGeneration===r.version.vaultGeneration&&z.version.scopeGeneration===r.version.scopeGeneration&&z.previousRevision===r.version.revision&&z.version.revision===r.version.revision+1){U=new Map(o),B=z.version;let v=async D=>{if(!i||q!==c)throw N;let F;try{F=await h.read({version:B,keys:D})}catch(j){if(D.length>1&&j instanceof Error&&j.message==="Index keyed read exceeds page bounds; request fewer keys"){let E=Math.ceil(D.length/2);await v(D.slice(0,E)),await v(D.slice(E));return}throw j}if(b(F,B),F.missing.length||F.entries.length!==D.length||new Set(F.entries.map(j=>j.relPath)).size!==D.length||F.entries.some(j=>!D.includes(j.relPath)))throw N;for(let j of F.entries)U.set(j.relPath,j)};for(let D=0;D<z.changed.length;D+=128)await v(z.changed.slice(D,D+128));for(let D of z.deleted)U.delete(D);if(U.size!==z.count)throw N;de=Object.freeze({previousRevision:z.previousRevision,changed:Object.freeze(z.changed.map(D=>U.get(D)).filter(Boolean)),deleted:Object.freeze([...z.deleted])})}else{U=new Map,B=null;let v=0;for(;;){if(!i||q!==c)throw N;let D=await h.read({...B?{version:B}:{},offset:v,limit:128});b(D,B),B=D.version,ye=D.status;for(let F of D.entries){if(U.has(F.relPath))throw new Error("Duplicate index page entry");U.set(F.relPath,F)}if(D.next===null){if(U.size!==D.count)throw new Error("Incomplete index snapshot");break}if(!Number.isSafeInteger(D.next)||D.next<=v||!B)throw new Error("Invalid index page cursor");v=D.next}}if(!i||q!==c){s=i;continue}if(ye==="loading"){R({...r,status:ye,change:void 0});continue}let le=v=>{!v||typeof v!="object"||Object.isFrozen(v)||(Object.values(v).forEach(le),Object.freeze(v))};for(let v of U.values())le(v);o=U,R({status:ye,version:B,entries:Object.freeze([...U.values()]),...de?{change:de}:{}})}catch(U){if(!i)break;if((q!==c||U===N)&&++k<=3){s=!0,u=void 0;continue}s=!1,R({...r,status:"error",change:void 0,error:U instanceof Error?U.message:"Index observation failed"})}}}finally{d=!1}},P=()=>(!d&&i&&h&&(m=w()),m),_=()=>{p||!i||(p=Promise.resolve().then(()=>e.index.observe(a,k=>{i&&(c++,u=!s&&!d?k:void 0,s=!0,P())})).then(async k=>{if(!i){await M(k);return}h=k,await P()}).catch(k=>{if(!i)throw k;R({...r,status:"error",change:void 0,error:k instanceof Error?k.message:"Index observation failed"})}).finally(()=>{p=void 0}))};return _(),{getSnapshot:()=>r,subscribe(k){return L.add(k),()=>{L.delete(k)}},retry(){!i||y||(c++,u=void 0,s=!0,y=(async()=>{if(await p,await m,!i)return;let k=h;h=void 0,k&&await M(k),_()})().catch(k=>{if(!i)throw k;R({...r,status:"error",change:void 0,error:k instanceof Error?k.message:"Index observation failed"})}).finally(()=>{y=void 0}))},dispose(){return S||(i=!1,L.clear(),S=(async()=>{let q=(await Promise.allSettled([h?M(h):void 0,p,m,y])).find(z=>z.status==="rejected");if(q?.status==="rejected")throw q.reason})(),S)}}}var ua="valley";var jc=`.${ua}`,Vc=`app.${ua}`;function Zs(e){return e.trim().replace(/\\/g,"/").replace(/\/{2,}/g,"/").replace(/^\.?\/+/,"").replace(/\/+$/,"")}var Qs=/^[a-zA-Z]:/;function Pn(e){if(typeof e!="string")return"";let t=Zs(e);return!t||t==="."||Qs.test(t)||t.split("/").some(a=>a==="..")?"":t}function Ta(e){if(typeof e=="string")return Pn(e)||void 0}var Pe=`.${ua}`,Js="plugins",Na=`${Pe}/${Js}`,ed="external",qc=`${Na}/${ed}`,Bc=`${Na}/data`;var Wc=`${Na}/plugin.json`,Yc=`${Na}/config.json`,Xc=`${Pe}/state`,Gt=`${Pe}/settings`,jt=`${Pe}/app`,Pa=`${Pe}/accounts`,Zc=`${Pa}/providers`,Qc=`${Pa}/providers.lock.json`,Jc=`${Pe}/trash`,Mn=`${Pe}/cache`,eu=`${Mn}/accounts`,td=`${Mn}/search`,tu=`${Mn}/providers`;var au=`${jt}/logs`,nu=`${jt}/whats-new`,ru=`${jt}/setup.json`,ou=`${td}/index.jsonl`,iu=`${jt}/recovery/drafts`,su=`${jt}/recovery/transactions`;var Aa="design";var du={app:`${jt}/app.json`,appearance:`${Pe}/${Aa}/appearance.json`,pallette:`${Pe}/${Aa}/pallette.json`,group:`${Pe}/${Aa}/group.json`,metadata:`${Gt}/metadata.json`,notification:`${Gt}/notification.json`,preferences:`${Gt}/preferences.json`,markdown:`${Gt}/markdown.json`,files:`${Gt}/files.json`,search:`${Gt}/search.json`,design:`${Pe}/${Aa}/appearance.json`,accounts:`${Pa}/accounts.json`},lu=`${Pa}/secrets.json`;var Or=ua,_r="open";var Lr=["http:","https:","mailto:","obsidian:"];var pu=[Pe,`${Pe}/**/secrets.json`,".git","node_modules","**/.env","**/.env.*"];function zr(e,t){return new Date(e,t,0).getDate()}function Vt(e,t,a){if(t<1||t>12||a<1||a>31)return!1;let r=new Date(e,t-1,a);return r.getFullYear()===e&&r.getMonth()===t-1&&r.getDate()===a}var nd=/^(dd|mm|yyyy)([^a-z])(dd|mm|yyyy)(?:([^a-z])(dd|mm|yyyy))?$/;function On(e){let t=nd.exec(e.trim().toLowerCase());if(!t)return null;let a=[t[1],t[3],t[5]].filter(Boolean),r=[t[2],t[4]].filter(o=>o!==void 0);return new Set(a).size!==a.length||!a.includes("dd")||!a.includes("mm")?null:{tokens:a,separators:r}}var rd={dd:"(\\d{1,2})",mm:"(\\d{1,2})",yyyy:"(\\d{4})"};function od(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function Fr(e,t){let a=On(t);if(!a)return null;let{tokens:r,separators:o}=a,i=r.map((p,m)=>rd[p]+(m<o.length?od(o[m]):"")).join(""),d=new RegExp(`^${i}$`).exec(e.trim());if(!d)return null;let s={};r.forEach((p,m)=>{s[p]=Number(d[m+1])});let c=s.dd,u=s.mm,h=s.yyyy;return Vt(h??2e3,u,c)?h==null?{month:u,day:c}:{year:h,month:u,day:c}:null}function Je(){let e=new Date;return{view:"month",cursor:`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}-01`,selectedDate:null,rangeStart:null,rangeEnd:null,selectedTime:null,timeRange:null}}function dt(e){if(typeof e!="string"||!/^\d{4}-\d{2}-\d{2}$/.test(e))return!1;let[t,a,r]=e.split("-").map(Number);return Vt(t,a,r)}var _n=e=>typeof e=="string"&&/^(?:[01]\d|2[0-3]):[0-5]\d$/.test(e);function Ln(e,t,a){if(!e||typeof e!="object"||Array.isArray(e))return null;let{start:r,end:o}=e;return!_n(r)||!_n(o)?null:(dt(t)&&dt(a)?`${t}T${r}`<`${a}T${o}`:r<o)?{start:r,end:o}:null}function $r(e){let t=e&&typeof e=="object"?e:{},a=Je(),r=dt(t.rangeStart)?t.rangeStart:null,o=dt(t.rangeEnd)?t.rangeEnd:null;return{view:t.view==="week"||t.view==="year"||t.view==="month"?t.view:a.view,cursor:dt(t.cursor)?`${t.cursor.slice(0,7)}-01`:a.cursor,selectedDate:dt(t.selectedDate)?t.selectedDate:null,rangeStart:r,rangeEnd:o,selectedTime:_n(t.selectedTime)?t.selectedTime:null,timeRange:Ln(t.timeRange,r,o)}}var n,g,xt;function Rr(e){if(e.disposal)return e.disposal;e.disposed=!0,e.off?.();let t=[...e.values.values()];e.values.clear();let a=e.retired;return e.disposal=(async()=>{let o=(await Promise.allSettled([...t.map(i=>i.dispose()),a])).find(i=>i.status==="rejected");if(o?.status==="rejected")throw o.reason})(),e.disposal}function Kr(e){let t=g!==e&&xt?Rr(xt):void 0;t?.catch(()=>{}),g=e,n=e.React;let a=e.runtime.getOrCreate("calendar.readOwners",()=>({disposed:!1,epoch:0,values:new Map})),r=++a.epoch;a.retired=t??a.disposal??a.retired,a.disposal=void 0,a.disposed=!1,a.off?.();let o=e.getState().vault?.path;return a.off=e.subscribeState(["vault"],()=>{let i=e.getState().vault?.path;if(i!==o){o=i;for(let d of a.values.values())d.invalidate?.()}}),xt=a,()=>a.epoch===r?Rr(a):Promise.resolve()}function Ge(e,t){if(!xt||xt.disposed)throw new Error("Calendar read owner is disposed.");let a=xt.values.get(e);return a||(a=t(g),xt.values.set(e,a)),a}function kt(){return g.runtime.getOrCreate("calendar.revealTarget",()=>{let e={value:null,listeners:new Set,get:()=>e.value,publish:t=>{e.value=t;for(let a of[...e.listeners])a()},subscribe:t=>(e.listeners.add(t),()=>e.listeners.delete(t))};return e})}var id=2400;function Gr(e,t){let a=g.runtime.getOrCreate("calendar.revealPulse",()=>({nonce:0,timer:null})),r=kt();if(g.workspace.patchTimeControl({...e.view?{view:e.view}:{},cursor:`${e.date.slice(0,7)}-01`,selectedDate:e.date,selectedTime:e.startTime??null,timeRange:Ln({start:e.startTime,end:e.endTime}),rangeStart:null,rangeEnd:null}),a.timer&&clearTimeout(a.timer),r.publish(null),e.itemId){let o={surface:t,sourceId:e.sourceId??"",itemId:e.itemId,date:e.date,nonce:++a.nonce};r.publish(o),a.timer=setTimeout(()=>{r.get()?.nonce===o.nonce&&r.publish(null),a.timer=null},id)}}function Ma(e){Gr(e,"main"),g.workspace.openMainTab()}function jr(e){Gr(e,"agenda"),g.workspace.revealOwnPanel("left_sidebar")}var Vr=`
...
`;var qr=`/* \u2500\u2500 Agenda panel header actions \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500 */
...
`;var Wr=`/* \u2500\u2500 Header filters (groups / sources) \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500 */
...
`,Yr=`.calendar-filter-inline-rows {
  flex: 0 0 auto;
  display: flex;
  flex-direction: column;
  gap: 1px;
...
`;var Xr=`/* Calendar's integration page starts with a bordered plugin card rather than a
...
`,Zr=`/* \u2500\u2500 Note-date source editor (Settings \u2192 Calendar \u2192 Note dates) \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500 */
.notedate-source-row {
  display: flex;
  flex-direction: column;
  gap: 12px;
...
range: next-30
filter-tag: #focus
limit: 10`}]};var gl=/^([A-Za-z][\w./-]*)\s*[:=]\s*(.*)$/,hl=/^-\s+(.*)$/,yl=/^[A-Za-z][\w+.-]*:\/\//;function Ti(e){let t={bare:null,values:{},lists:{}},a=null;for(let r of e.split(`
`)){let o=r.trim();if(!o||o.startsWith("#"))continue;let i=o.match(hl);if(i){a?t.lists[a].push(i[1].trim()):t.bare===null&&(t.bare=i[1].trim());continue}let d=yl.test(o)?null:o.match(gl);if(d){let s=d[1].trim().toLowerCase(),c=d[2].trim();c===""?(a=s,t.lists[s]=t.lists[s]??[]):(a=null,t.values[s]=c);continue}a=null,t.bare===null&&(t.bare=o)}return t}function Ni(e,t,a=500){let r=e.values[t];if(r===void 0)return null;let o=Number.parseInt(r,10);return!Number.isFinite(o)||o<1?null:Math.min(o,a)}var ir="notes-calendar-fence-styles";function bl(){if(document.getElementById(ir))return;let e=document.createElement("style");e.id=ir,e.textContent=`
...
`,document.head.appendChild(e)}var Pi=e=>String(e).padStart(2,"0"),ba=e=>`${e.getFullYear()}-${Pi(e.getMonth()+1)}-${Pi(e.getDate())}`,or=e=>{let t=new Date;return t.setDate(t.getDate()+e),ba(t)};function vl(e){let t=e["start-date"]??e.start,a=e["end-date"]??e.end;if(t||a)return{start:t??ba(new Date),end:a??t??or(7)};let r=(e.range??"this-week").toLowerCase(),o=ba(new Date);if(r==="today")return{start:o,end:o};if(r==="next-30")return{start:o,end:or(30)};if(r==="this-week"){let i=new Date,d=(i.getDay()+6)%7,s=new Date(i);s.setDate(i.getDate()-d);let c=new Date(s);return c.setDate(s.getDate()+6),{start:ba(s),end:ba(c)}}return{start:o,end:or(7)}}function wl(e,t,a,r,o){let i=a?a.replace(/^#/,"").toLowerCase():null,d=r?.toLowerCase()??null;return e.filter(s=>!(s.date<t.start||s.date>t.end||i&&!s.tags.some(c=>c.replace(/^#/,"").toLowerCase()===i)||d&&(s.category??"").toLowerCase()!==d)).sort((s,c)=>s.date.localeCompare(c.date)||(s.startTime??"").localeCompare(c.startTime??"")).slice(0,o)}var xl=e=>{let[t,a,r]=e.split("-").map(Number);return new Date(t,(a??1)-1,r??1).toLocaleDateString(g.ui.language(),{weekday:"short",day:"numeric",month:"short"})},kl=({code:e})=>{let[t,a]=n.useState(null);n.useEffect(()=>{let m=!0,y=()=>{Me().then(I=>{m&&a(I)})};y();let S=at(y);return()=>{m=!1,S()}},[]);let r=Ti(e),o=vl(r.values),i=(r.values["view-mode"]??r.values.view??"agenda").toLowerCase().startsWith("week"),d=Ni(r,"limit",200)??20;if(!t)return n.createElement("div",{className:"calendar-fence-empty"},l("auto.33ce417454bf"));let s=wl(t,o,r.values["filter-tag"]??r.values.tag??null,r.values.category??null,d),c=()=>g.workspace.openMainTab(),u=m=>m.allDay||!m.startTime?l("auto.1ac1ff7616a6"):`${m.startTime}${m.endTime?`\u2013${m.endTime}`:""}`,h=(m,y)=>n.createElement("div",{key:m.id,className:"calendar-fence-row",onClick:c,title:m.note||m.title},n.createElement("span",{className:"dot",style:m.color?{background:me(m.color)}:void 0}),n.createElement("span",{className:"time"},y?`${m.date.slice(5)} ${u(m)}`:u(m)),n.createElement("span",{className:"t"},m.title),m.category&&n.createElement("span",{className:"cat"},m.category)),p;if(s.length===0)p=n.createElement("div",{className:"calendar-fence-empty"},l("auto.a2590d497e7c"));else if(i){let m=new Map;for(let y of s){let S=m.get(y.date)??[];S.push(y),m.set(y.date,S)}p=n.createElement(n.Fragment,null,[...m.entries()].map(([y,S])=>n.createElement(n.Fragment,{key:y},n.createElement("div",{className:"calendar-fence-day"},xl(y)),S.map(I=>h(I,!1)))))}else p=n.createElement(n.Fragment,null,s.map(m=>h(m,!0)));return n.createElement(n.Fragment,null,n.createElement("div",{className:"calendar-fence-head",onClick:c,title:l("auto.7a3a9094b18c")},n.createElement("span",{className:"t"},l("auto.adab5090ac6a")),n.createElement("span",{className:"c"},o.start," \u2192 ",o.end," \xB7 ",s.length)),p)};function Mi(){let e=g.markdown.registerCodeBlockRenderer("calendar",(t,a)=>(bl(),a.classList.add("calendar-fence"),g.ui.renderReact(a,n.createElement(kl,{code:t}))),{examples:Ai.calendar});return()=>{e(),document.getElementById(ir)?.remove()}}function sr(e){return{v:1,...e}}function va(e){return e.v!==1||e.view!=="month"&&e.view!=="week"&&e.view!=="year"||!dt(e.cursor)?null:$r(e)}function on(){let[e,t]=n.useState(Je);n.useEffect(()=>{let r=!1,o=!1;g.workspace.getTimeControl().then(d=>{!r&&!o&&t(d)});let i=g.workspace.onTimeControlChanged(d=>{o=!0,t(d)});return()=>{r=!0,i()}},[]);let a=n.useCallback(r=>{t(g.workspace.patchTimeControl(r))},[]);return[e,a]}function Oi(e,t){let a=new Date(`${e}T00:00:00`),r=new Date(`${t}T00:00:00`),o=a<=r?a:r,i=a<=r?r:a,d=[];for(let s=new Date(o);s<=i;s.setDate(s.getDate()+1)){let c=String(s.getMonth()+1).padStart(2,"0"),u=String(s.getDate()).padStart(2,"0");d.push(`${s.getFullYear()}-${c}-${u}`)}return d}function Sl(e){let t=["title","kind","excluded","frontmatter"];if(!e)return{kinds:["note"],fields:t};if(!e.length)return{kinds:[],fields:[]};let a=[...new Set(e.flatMap(r=>[r.matchKey,r.dateField,r.startTimeField,r.endTimeField,r.labelField,...r.showFields]).filter(r=>!!r))].sort();return{kinds:["note"],fields:t,...a.length<=64&&a.every(r=>r.length<=1024&&!["__proto__","constructor","prototype"].includes(r))?{frontmatterKeys:a}:{}}}function El(){return Ge("noteIndex",e=>{let t=new Map,a=new Set,r=!1,o=d=>{let s=d.dispose();a.add(s),s.then(()=>a.delete(s),()=>{})};function i(d,s){let c,u,h={status:"loading",version:null,entries:[]},p=[],m=new Set,y=()=>{u?.(),u=void 0,c&&o(c),c=void 0},S=()=>{if(r||c)return;let M=Nn(e,d);c=M;let L=()=>{if(c===M){h=M.getSnapshot(),h.status==="ready"&&(p=h.entries.filter(R=>typeof R.title=="string"&&R.kind==="note"));for(let R of m)R()}};u=M.subscribe(L),L()},I={get:()=>{if(h.status==="error")throw new Error(h.error??"Calendar note index is unavailable.");return p},subscribe(M){return t.has(s)||t.set(s,I),m.add(M),S(),()=>{m.delete(M),m.size||(y(),p=[],t.get(s)===I&&t.delete(s))}},invalidate:()=>{y(),p=[],h={status:"loading",version:null,entries:p},m.size&&S()},dispose:()=>{y(),m.clear()}};return I}return{get(d){let s=t.get(d);return s||(s=i(JSON.parse(d),d),t.set(d,s)),s},invalidate:()=>{for(let d of t.values())d.invalidate()},dispose:async()=>{r=!0;for(let c of t.values())c.dispose();t.clear();let s=(await Promise.allSettled([...a])).find(c=>c.status==="rejected");if(s?.status==="rejected")throw s.reason}}})}function ia(e){let t=El().get(JSON.stringify(Sl(e)));return n.useSyncExternalStore(t.subscribe,t.get,t.get)}var Cl=["exact","day-month","day"],sn=100;function dn(e){return e==null?"":Array.isArray(e)?e.map(dn).filter(Boolean).join(", "):typeof e=="object"?"":String(e)}function Il(e){if(Array.isArray(e)){let t=e.find(a=>typeof a=="string"&&a.trim());return typeof t=="string"?t.trim():""}return X(e).trim()}function Dl(e){return e.split(/[\n,]+/).map(t=>t.trim()).filter(Boolean)}var _i=0;function ln(){return _i+=1,{id:`notedate-${Date.now().toString(36)}-${_i}`,title:"",matchKey:"type",matchValue:"",dateField:"date",match:"exact",showCount:!0,labelMode:"filename",showFields:[],visible:!0,hidden:!1}}var lr=[{id:"birthdays",labelKey:"calendar.noteDatePreset.birthdays",label:"Birthdays",patch:{title:"Birthdays",matchKey:"type",matchValue:"contact",dateField:"birthdate",match:"day-month",showCount:!0,icon:"cake"}},{id:"anniversaries",labelKey:"calendar.noteDatePreset.anniversaries",label:"Anniversaries",patch:{title:"Anniversaries",matchKey:"type",matchValue:"anniversary",dateField:"date",match:"day-month",showCount:!0,icon:"heart"}},{id:"deadlines",labelKey:"calendar.noteDatePreset.deadlines",label:"Deadlines",patch:{title:"Deadlines",matchKey:"type",matchValue:"project",dateField:"due",match:"exact",showCount:!1,icon:"flag"}}];function Li(e,t){let a=ln(),r=lr.find(i=>i.id===e);if(!r)return a;let o=t.map(i=>i.color).filter(i=>!!i);return{...a,...r.patch,color:Va(o)}}function Al(e){if(!(typeof e!="number"||!Number.isFinite(e)))return Math.max(0,Math.min(sn,Math.floor(e)))}function Tl(e,t){let a=X(e).trim();return Cl.includes(a)?a:t}function zi(e){let t=ln(),a=e.showFields??e.hoverFields;return{id:X(e.id,t.id),title:X(e.title).trim(),matchKey:X(e.matchKey,t.matchKey).trim(),matchValue:X(e.matchValue).trim(),folder:X(e.folder).trim()||void 0,dateField:X(e.dateField,t.dateField).trim()||t.dateField,dateFormat:X(e.dateFormat).trim()||void 0,startTimeField:X(e.startTimeField).trim()||void 0,endTimeField:X(e.endTimeField).trim()||void 0,match:Tl(e.match,t.match),recurrenceLimitYears:Al(e.recurrenceLimitYears),showCount:lo(e.showCount,t.showCount),labelMode:e.labelMode==="property"||e.labelMode==null&&X(e.labelField).trim()?"property":"filename",labelField:X(e.labelField).trim()||void 0,showFields:Array.isArray(a)?a.map(r=>X(r).trim()).filter(Boolean):Dl(X(a)),color:X(e.color).trim()||void 0,borderColor:X(e.borderColor).trim()||void 0,icon:X(e.icon).trim()||void 0,visible:e.visible!==!1,hidden:e.hidden===!0}}function Nl(e,t){return t?e===t||e.startsWith(t.replace(/\/+$/,"")+"/"):!0}function cr(e){return!!(e.matchKey&&e.matchValue&&e.dateField)}function ur(e,t){if(!cr(t))return[];let a=t.matchKey,r=t.matchValue.trim().toLowerCase(),o=[];for(let i of e){if(i.excluded||i.kind!=="note"||!Nl(i.relPath,t.folder))continue;let d=i.frontmatter?.[a];String(d??"").trim().toLowerCase()===r&&o.push(i)}return o}function cn(e,t){let a=ur(e,t),r=0;for(let o of a){let i=pr(o.frontmatter?.[t.dateField],t.dateFormat);i&&(t.match!=="exact"||i.year!=null)&&(r+=1)}return{matched:a.length,dated:r}}var Pl=/^(\d{4})-(\d{1,2})-(\d{1,2})(?:[T ].*)?$/,Ml=/^(?:--)?(\d{1,2})-(\d{1,2})$/;function pr(e,t){if(e instanceof Date)return Number.isNaN(e.getTime())?null:{year:e.getFullYear(),month:e.getMonth()+1,day:e.getDate()};let a=Il(e);if(!a)return null;if(t){let i=Fr(a,t);if(i)return i}let r=Pl.exec(a);if(r){let[,i,d,s]=r,c={year:Number(i),month:Number(d),day:Number(s)};return Vt(c.year,c.month,c.day)?c:null}let o=Ml.exec(a);if(o){let[,i,d]=o,s={month:Number(i),day:Number(d)};return Vt(2e3,s.month,s.day)?s:null}return null}function dr(e,t){return Fi(t,e.month,e.day)}function Fi(e,t,a){let r=Math.min(a,zr(e,t));return`${e}-${String(t).padStart(2,"0")}-${String(r).padStart(2,"0")}`}function Ol(e,t,a){if(t==="exact")return e.year==null?[]:[dr(e,e.year)];if(t==="day-month")return a.map(o=>dr(e,o));let r=[];for(let o of a)for(let i=1;i<=12;i+=1)r.push(Fi(o,i,e.day));return r}function _l(e,t){if(e.year==null)return null;let a=t-e.year;return a<0?null:a}function $i(e,t){let a=new Set,r=e.getFullYear();for(let o of[r-1,r,r+1,r+2])a.add(o);if(t!=null&&Number.isFinite(t))for(let o of[t-1,t,t+1,t+2])a.add(o);return[...a].sort((o,i)=>o-i)}function Ll(e,t){let a=[];for(let r of t.showFields){let o=dn(e?.[r]);o&&a.push({key:r,value:o})}return a}function Ri(e,t){if(t.labelMode==="property"&&t.labelField){let a=dn(e.frontmatter?.[t.labelField]);if(a)return a}return e.title}function zl(e,t,a,r){if(t.hidden||!t.visible)return[];let o=[];for(let i of ur(e,t)){let d=i.frontmatter,s=pr(d?.[t.dateField],t.dateFormat);if(!s)continue;let c=s.year==null?void 0:dr(s,s.year),u=t.recurrenceLimitYears==null?void 0:r+t.recurrenceLimitYears,h=Ol(s,t.match,a).filter(I=>{if(t.match==="exact")return!0;let M=Number(I.slice(0,4));return(u==null||M<=u)&&(c==null||I>=c)});if(!h.length)continue;let p=t.startTimeField?lt(d?.[t.startTimeField]):void 0,m=t.endTimeField?lt(d?.[t.endTimeField]):void 0,y=Ri(i,t),S=Ll(d,t);for(let I of h){let M=_l(s,Number(I.slice(0,4))),L=t.match==="day-month"&&t.showCount&&M!=null;o.push({id:`notedate:${t.id}:${i.relPath}:${I}`,sourceId:t.id,relPath:i.relPath,date:I,startTime:p,endTime:m,title:L?`${y} (${M})`:y,count:M,color:t.color,borderColor:t.borderColor,icon:t.icon,fields:S})}}return o}function Ki(e,t,a,r){return t.flatMap(o=>zl(e,o,a,r))}function Gi(e,t){let a=[];for(let r of t){a.push(JSON.stringify(r));for(let o of ur(e,r)){let i=o.frontmatter;a.push(o.relPath,pr(i?.[r.dateField],r.dateFormat),r.startTimeField?lt(i?.[r.startTimeField]):null,r.endTimeField?lt(i?.[r.endTimeField]):null,Ri(o,r));for(let d of r.showFields)a.push(dn(i?.[d]))}}return JSON.stringify(a)}var mr="calendar.note_date_sources",ji=()=>g.data.dataset(mr);async function Vi(e=ji(),t=()=>{}){let a=[],r;do{t();let o=await e.query({orderBy:[{field:"position",direction:"asc"}],limit:1e3,cursor:r});t(),a.push(...o.rows),r=o.cursor}while(r);return a}function wa(){return Ui().read("sources")}function Ui(){return Ge("noteDateSources",e=>{let t=qt(async(r,o)=>(await Vi(e.data.dataset(mr),o)).map(d=>zi(d.definition&&typeof d.definition=="object"&&!Array.isArray(d.definition)?d.definition:{})),1),a=za(e,[mr],t.invalidate);return{...t,dispose:()=>{a(),t.dispose()}}})}async function un(e){let t=ji(),a=await Vi(t),r=new Set(e.map(s=>s.id)),o=new Map(a.map(s=>[s.id,s])),i=e.map((s,c)=>{let u={};for(let[h,p]of Object.entries(s))p!==void 0&&(u[h]=p);return{id:s.id,position:c,definition:u}}).filter(s=>o.get(s.id)?.position!==s.position||JSON.stringify(o.get(s.id)?.definition)!==JSON.stringify(s.definition)),d=a.filter(s=>!r.has(String(s.id))).map(s=>({operation:"delete",key:{id:String(s.id)}}));if(i.length&&d.push({operation:"upsert",values:i}),d.length>1e3)throw new Error(l("calendar.error.atomicLimit"));d.length&&await t.batch(d)}function pn(){let[e,t]=n.useState([]);return n.useEffect(()=>{let a=Ht(wa,t,o=>console.error("[calendar] note-date sources reload failed",o)),r=Ui().subscribe(()=>{a.reload()});return a.reload(),()=>{a.dispose(),r()}},[]),e}function Hi(e,t,a,r){return Ge("noteDateProjection",()=>{let i,d,s="",c=new Map,u=()=>{i=void 0,d=void 0,s="",c.clear()};return{project:(h,p,m,y)=>{if(h!==i||p!==d){let M=Gi(h,p);i=h,d=p,s!==M&&(s=M,c.clear())}let S=JSON.stringify([y,m]),I=c.get(S);return I||(I=Ki(h,p,m,y),c.size>=16&&c.delete(c.keys().next().value)),c.delete(S),c.set(S,I),I},invalidate:u,dispose:u}}).project(e,t,a,r)}function Fl(e){return e.kind==="event"?Dt:e.kind==="noteDate"?At:e.sourceOwner?qa(e.sourceOwner):""}function $l(e,t){if(e.groupId){let r=t.find(o=>o.id===e.groupId);if(r)return r}if(!e.group)return;let a=Ve(e.group);return t.find(r=>Ve(r.name)===a)}function qi(e,t,a,r){if(a.length===0&&r.length===0)return e;let o=new Set(a),i=new Set(r);return e.filter(d=>{if(i.has(Fl(d)))return!1;if(o.size===0)return!0;let s=$l(d,t);return!s||!o.has(s.id)})}function xa({label:e,options:t,hidden:a,settingsKey:r,emptyText:o,onOpenSettings:i,saveHidden:d,embedded:s=!1}){let[c,u]=n.useState(()=>[...a]),[h,p]=n.useState(!1),[m,y]=n.useState(!1);n.useEffect(()=>u([...a]),[a]);let S=t.filter(b=>!c.includes(b.id)).length,I=t.map(b=>!c.includes(b.id)),M=(b,w)=>b?` active${I[w-1]?"":" selection-run-start"}${I[w+1]?"":" selection-run-end"}`:"",L=b=>{if(m)return;u(b),y(!0),(d?d(b):r?g.settings.set(r,b).then(P=>P.ok):Promise.resolve(!1)).then(P=>{P?p(!1):(u([...a]),p(!0))}).catch(()=>{u([...a]),p(!0)}).finally(()=>y(!1))},R=b=>L(c.includes(b)?c.filter(w=>w!==b):[...c,b]),N=()=>{let b=new Set(t.map(w=>w.id));L(S===t.length?[...new Set([...c,...b])]:c.filter(w=>!b.has(w)))};return s?n.createElement("div",{className:"props-info"},n.createElement("div",{className:"props-info-actions"},i&&n.createElement("button",{type:"button",onClick:i},l("calendar.properties.manageGroups")),t.length>0&&n.createElement("button",{type:"button",disabled:m,onClick:N},l(S===t.length?"calendar.filter.deselectAll":"calendar.filter.selectAll"))),n.createElement("dl",{className:"props-info-table calendar-filter-properties"},t.map(b=>n.createElement("div",{className:"props-info-row calendar-filter-property-row",key:b.id},n.createElement("dt",{className:"props-info-key"},b.icon&&n.createElement("span",{className:"calendar-filter-property-glyph",style:b.color?{color:me(b.color)}:void 0},b.icon),!b.icon&&b.color&&n.createElement("span",{className:"props-info-dot",style:{background:me(b.color)}}),b.label),n.createElement("dd",{className:"props-info-value calendar-filter-property-value"},b.count!==void 0&&n.createElement("span",{className:"calendar-filter-option-count"},b.count),n.createElement(g.ui.settings.Toggle,{label:b.label,checked:!c.includes(b.id),disabled:m,onChange:()=>R(b.id)}))))),t.length===0&&n.createElement("p",{className:"props-info-hint"},o),h&&n.createElement("p",{className:"props-info-hint",role:"alert"},g.ui.t("error.commandFailed"))):n.createElement("div",{className:"calendar-filter-popover-body"},n.createElement("div",{className:"calendar-filter-popover-head"},i?n.createElement("button",{type:"button",className:"calendar-filter-popover-title actionable",onClick:i},e):n.createElement("span",{className:"calendar-filter-popover-title"},e),t.length>0&&n.createElement("button",{type:"button",className:"calendar-filter-popover-all",onClick:N},l(S===t.length?"calendar.filter.deselectAll":"calendar.filter.selectAll"))),t.length===0?n.createElement("div",{className:"calendar-filter-empty"},o):n.createElement("div",{className:"calendar-filter-list"},t.map((b,w)=>{let P=!c.includes(b.id),_=I[w];return n.createElement("button",{key:b.id,type:"button",className:`calendar-filter-option${M(_,w)}`,"aria-pressed":P,onClick:()=>R(b.id)},n.createElement("span",{className:"calendar-filter-check","aria-hidden":"true"},P?"\u2713":""),b.icon?n.createElement("span",{className:"calendar-filter-option-glyph",style:b.color?{color:me(b.color)}:void 0},b.icon):n.createElement("span",{className:"calendar-legend-dot",style:{background:b.color?me(b.color):"var(--text-tertiary)"}}),n.createElement("span",{className:"calendar-filter-option-label"},b.label),b.count!==void 0&&n.createElement("span",{className:"calendar-filter-option-count"},b.count))})))}function mn({label:e,icon:t,options:a,hidden:r,settingsKey:o,emptyText:i,onOpenSettings:d,saveHidden:s}){let c=a.some(u=>r.includes(u.id));return n.createElement("button",{type:"button",className:`calendar-filter-btn${c?" active":""}`,"aria-label":e,"aria-haspopup":"dialog",title:e,onClick:u=>{let h=u.currentTarget;g.ui.openPopover(({close:p})=>n.createElement(xa,{label:e,options:a,hidden:r,settingsKey:o,emptyText:i,onOpenSettings:d?()=>{p(),d()}:void 0,saveHidden:s}),{anchor:h,align:"end"},{className:"calendar-filter-popover",ariaLabel:e})}},n.createElement("span",{className:"calendar-filter-icon"},t))}function Bi(){let e=pn(),t=ia(e),a=n.useMemo(()=>e.filter(d=>!d.hidden),[e]),r=n.useMemo(()=>a.map(d=>({id:d.id,label:d.title||l("calendar.noteDatePreset.blank"),color:d.color,icon:n.createElement(Le,{id:d.icon||"pin"}),count:cn(t,d).dated})),[t,a]),o=n.useMemo(()=>a.filter(d=>!d.visible).map(d=>d.id),[a]),i=n.useCallback(async d=>{let s=new Set(d);try{return await un(e.map(c=>c.hidden?c:{...c,visible:!s.has(c.id)})),!0}catch{return!1}},[e]);return{options:r,hidden:o,saveHidden:i}}function Wi({embedded:e=!1}){let t=Bi();return n.createElement(xa,{embedded:e,label:l("calendar.filter.noteDates"),options:t.options,hidden:t.hidden,saveHidden:t.saveHidden,emptyText:l("calendar.filter.noSources")})}function Yi(){let e=Bi();return n.createElement(mn,{label:l("calendar.filter.noteDates"),icon:n.createElement(si,null),options:e.options,hidden:e.hidden,saveHidden:e.saveHidden,emptyText:l("calendar.filter.noSources")})}function Ee(){return g.runtime.getOrCreate("calendar.surfaces",()=>({time:Je(),selected:new Map,navigation:new Map,listeners:new Set}))}function sa(){for(let e of Ee().listeners)e()}function Xe(e,t){e?Ee().selected.set(t,e):Ee().selected.delete(t),sa()}function fn(e,t,a){n.useEffect(()=>{Ee().time=t,a&&Ee().navigation.set(e,a),sa()},[e,t,a])}function Rl(e){return{...sr(Ee().time),itemId:e.id,kind:e.kind,date:e.date,sourceId:e.sourceId??"",filePath:e.filePath??""}}async function fr(e){if(typeof e.itemId!="string")return null;if(e.kind==="event"||e.kind==="sourced")return He({id:e.itemId,sourceId:e.kind==="sourced"&&typeof e.sourceId=="string"?e.sourceId:void 0});if(e.kind==="noteDate"&&typeof e.filePath=="string"&&await g.documents.resolve(e.filePath))return{kind:"noteDate",id:e.itemId,title:e.filePath.split("/").pop()??e.filePath,date:String(e.date??""),filePath:e.filePath,readOnly:!0};throw new Error("The bookmarked calendar item is unavailable.")}function Kl(e){let t=Ee().selected.get(e);return{title:l("manifest.name"),view:sr(Ee().time),navigation:Ee().navigation.get(e),...t?{item:{id:Ue(t),title:t.title,state:Rl(t)}}:{}}}function gr(e){let t=Ee().listeners;return t.add(e),()=>{t.delete(e)}}function Xi(e){let t=e?{...Je(),...va(e)}:Ee().time,a=Ut(ge(t.selectedDate??J(new Date)),pa[g.getState().weekStart]??1);return Object.entries({plugin:"calendar",view:t.view,selectedDate:t.selectedDate,month:t.cursor.slice(0,7),week:{number:St(a),start:J(a),end:We(J(a),6)},year:Number(t.cursor.slice(0,4)),...t.rangeStart&&t.rangeEnd?{range:[t.rangeStart,t.rangeEnd].sort()}:{},...t.selectedTime?{selectedTime:t.selectedTime}:{}}).map(([r,o])=>({id:r,label:l(`calendar.overview.${r}`),value:o,readOnly:!0}))}async function Zi(){let e=ve(),[t,a]=await Promise.all([Be(g).listAccounts(),(async()=>{let o=[],i;do{let d=await g.data.dataset("calendar.calendars").query({limit:100,cursor:i});o.push(...d.rows),i=d.cursor}while(i);return o})()]);if(!t.ok||!t.data)throw new Error(l("calendar.overview.unavailable"));let r=[{id:Dt,name:l("calendar.filter.events")},{id:At,name:l("calendar.filter.noteDates")},...ct().map(o=>({id:o.sourceKey,name:o.integration?.localized?.[g.ui.language()]?.name??o.integration?.name??o.owner}))].filter(o=>!e.hiddenSources.includes(o.id));return[{id:"sources",label:l("calendar.overview.sources"),value:r,readOnly:!0},{id:"calendars",label:l("calendar.overview.calendars"),value:a.map(o=>({id:String(o.id),name:String(o.name),accountId:o.accountId??null,provider:o.provider??null,timezone:o.timezone??null,readOnly:o.readOnly===!0})),readOnly:!0},{id:"accounts",label:l("calendar.overview.accounts"),value:t.data.accounts.filter(o=>o.capabilities.includes("calendar")).map(o=>({id:o.id,name:o.displayName||o.address,address:o.address,provider:o.provider,enabled:!e.disabledCalendarAccounts.includes(o.id)})),readOnly:!0}]}function Gl(e){if(e.id==="plugin")return l("auto.adab5090ac6a");if(e.id==="view")return l(e.value==="week"?"auto.f82be68a7fb4":e.value==="year"?"auto.879e32326c52":"auto.082bc378cd60");if(e.id==="month"){let t=ge(`${e.value}-01`);return`${tt(t.getMonth(),g.ui.language())} ${t.getFullYear()}`}return e.id==="week"&&e.value&&typeof e.value=="object"&&!Array.isArray(e.value)?`${e.value.number} \xB7 ${e.value.start} \u2013 ${e.value.end}`:Array.isArray(e.value)?e.value.length?e.value.map((t,a)=>{if(!t||typeof t!="object"||Array.isArray(t))return n.createElement("div",{key:a},String(t));let r=[t.address!==t.name?t.address:null,t.provider,t.timezone,t.enabled===!1?l("calendar.overview.disabled"):null].filter(Boolean).join(" \xB7 ");return n.createElement("div",{key:String(t.id)},String(t.name),r?n.createElement("small",null,r):null)}):l("calendar.overview.none"):e.value===null?l("calendar.overview.none"):String(e.value)}function Qi({view:e,sources:t=!1}){let[,a]=n.useReducer(u=>u+1,0),[r,o]=n.useState([]),[i,d]=n.useState(!1),s=_e(),c=Xt();return n.useEffect(()=>{if(!t)return gr(a);let u=0,h=()=>{let m=++u;a(),Zi().then(y=>{m===u&&(o(y),d(!1))}).catch(()=>{m===u&&d(!0)})},p=[gr(a),It("vault",h),g.settings.subscribe(h),g.data.dataset("calendar.calendars").subscribe(h),g.interop.services.subscribe(vt,h)];return h(),()=>{u++,p.forEach(m=>m())}},[t]),n.createElement("div",{className:"right-panel-body props-info"},t&&n.createElement(xa,{embedded:!0,label:l("calendar.filter.sources"),options:[{id:Dt,label:l("calendar.filter.events")},{id:At,label:l("calendar.filter.noteDates")},...c.map(u=>({id:u.sourceKey,label:u.integration?.localized?.[g.ui.language()]?.name??u.integration?.name??u.owner}))],hidden:s.hiddenSources,settingsKey:Yt,emptyText:l("calendar.overview.none")}),n.createElement("dl",{className:"props-info-table"},(t?r.filter(u=>u.id!=="sources"):Xi(e)).map(u=>n.createElement("div",{className:"props-info-row",key:u.id},n.createElement("dt",{className:"props-info-key"},u.label),n.createElement("dd",{className:"props-info-value"},Gl(u))))),i&&n.createElement("p",{role:"alert"},l("calendar.overview.unavailable")))}function jl(){let e=_e();return n.createElement("div",{className:"right-panel-body props-info"},n.createElement(xa,{embedded:!0,label:l("calendar.filter.groups"),options:e.groups.map(t=>({id:t.id,label:t.name,color:t.color})),hidden:e.hiddenGroups,settingsKey:Ha,emptyText:l("calendar.overview.none"),onOpenSettings:()=>g.workspace.openSettings("groups")}))}function Vl({item:e,view:t}){let[a,r]=n.useState(null),[o,i]=n.useState("");return n.useEffect(()=>{let d=!1,s=()=>{if(!e){r(null),i("");return}fr(e).then(u=>{d||(r(u),i(""))}).catch(u=>{d||(r(null),i(u instanceof Error?u.message:String(u)))})};s();let c=at(s);return()=>{d=!0,c()}},[e]),o?n.createElement("div",{className:"right-panel-body",role:"alert"},o):e?a?n.createElement("div",{className:"right-panel-body props-info"},n.createElement("dl",{className:"props-info-table"},["title","date","endDate","startTime","endTime","group","note","filePath"].filter(d=>a[d]).map(d=>n.createElement("div",{className:"props-info-row",key:d},n.createElement("dt",{className:"props-info-key"},l(`calendar.field.${d}`)),n.createElement("dd",{className:"props-info-value"},a[d]))))):n.createElement("div",{className:"right-panel-body"},l("calendar.overview.loading")):n.createElement(Qi,{view:t})}function Ji(e){let t=!1;e.workspace.getTimeControl().then(s=>{t||(Ee().time=s,sa())});let a=e.workspace.onTimeControlChanged(s=>{Ee().time=s,sa()}),o=["main_workspace","left_sidebar","right_sidebar"].map(s=>e.interop.extensions.provide(An,{id:`calendar.${s}`,surface:s,getSnapshot:()=>Kl(s),subscribe:gr,restore:async c=>{let u=va(c);if(!u)throw new Error("Unsupported Calendar bookmark.");let h=await fr(c);e.workspace.patchTimeControl(u),Xe(h,s)}}));o.push(e.interop.extensions.provide(Kt,{id:"calendar.properties",label:"Calendar",labelKey:"manifest.name",icon:"calendar",pluginSurfaces:["main_workspace"],inspect:async({subject:s})=>{let c=s?.item?await fr(s.item.state):null,u=c?.kind==="event"?["title","date","endDate","startTime","endTime","groupId","note","filePath","tags","urls","attachments","location"]:["title","date","startTime","endTime","group","note","filePath","priority","completed","tags","urls","attachments","location"];return c?u.map(h=>({id:h,label:l(`calendar.field.${h}`),value:c[h]??null,readOnly:!0})):Xi(s?.view)},render:({subject:s})=>n.createElement(Vl,{item:s?.item?.state,view:s?.view})})),o.push(e.interop.extensions.provide(Kt,{id:"calendar.groups",label:"Groups",labelKey:"calendar.filter.groups",icon:"group",pluginSurfaces:["main_workspace"],inspect:()=>{let s=ve();return s.groups.map(c=>({id:c.id,label:c.name,value:!s.hiddenGroups.includes(c.id),type:"boolean"}))},render:()=>n.createElement(jl,null)})),o.push(e.interop.extensions.provide(Kt,{id:"calendar.sources",label:"Sources",labelKey:"calendar.filter.sources",icon:"layers",pluginSurfaces:["main_workspace"],inspect:Zi,render:()=>n.createElement(Qi,{sources:!0})})),o.push(e.interop.extensions.provide(Kt,{id:"calendar.noteDates",label:"Note dates",labelKey:"calendar.filter.noteDates",icon:"push-pin",pluginSurfaces:["main_workspace"],inspect:async()=>(await wa()).filter(s=>!s.hidden).map(s=>({id:s.id,label:s.title||l("calendar.noteDatePreset.blank"),value:s.visible,type:"boolean"})),render:()=>n.createElement("div",{className:"right-panel-body"},n.createElement(Wi,{embedded:!0}))}));let i=0,d=()=>{let s=++i;for(let[c,u]of Ee().selected)u.kind!=="noteDate"&&He({id:u.id,sourceId:u.sourceId}).then(h=>{t||s!==i||Ee().selected.get(c)?.id!==u.id||(Ee().selected.set(c,h),sa())}).catch(()=>{t||sa()})};return o.push(at(d)),()=>{t=!0,a(),o.forEach(s=>s())}}function hr(e,t){let[a,r]=n.useState([]),{items:o,errors:i,reload:d}=Ro(e,t),s=Tt(),c=n.useSyncExternalStore(s.subscribe,s.getEvents),u=n.useRef(null),h=n.useCallback(()=>{d(),u.current?.reload()},[d]);n.useEffect(()=>{let m=Ht(()=>Me(e,t),r,S=>console.error("[calendar] events reload failed",S));u.current=m,m.reload();let y=at(()=>{m.reload()});return()=>{m.dispose(),u.current===m&&(u.current=null),y()}},[t,h,e]);let p=n.useMemo(()=>[...a,...c],[a,c]);return{sourced:o,events:p,sourceErrors:i,reload:h}}var es={high:De("red"),medium:De("amber"),low:De("green"),normal:De("gray")},ts={active:De("primary-blue"),paused:De("amber"),suspended:De("violet"),completed:De("green"),open:De("gray")},Ul=De("gray");function as(e){return e.priority&&es[e.priority]?es[e.priority]:e.status&&ts[e.status]?ts[e.status]:Ul}function Hl(e,t){if(e.color)return e.color;if(e.groupId){let a=t.find(r=>r.id===e.groupId);if(a)return a.color}return as({priority:e.priority,status:e.status})}function ql(e,t,a){return e.endDate?Wo(e.date<t?t:e.date,e.endDate>a?a:e.endDate).map(r=>({...e,date:r,occurrenceKey:`${e.id}@${r}`})):[e]}function ns(e){return e.filePath?[e.filePath,e.date,e.endDate??e.date,e.startTime??"",e.endTime??""].join("\0"):null}function Bl(e){let t=new Set(e.filter(a=>a.kind==="sourced").map(ns).filter(a=>a!==null));return e.filter(a=>{if(a.kind!=="event"||a.event?.source||a.event?.endDate)return!0;let r=ns(a);return r===null||!t.has(r)})}function gn(e={}){let{focusYear:t}=e,a=Oo(),{groups:r,hiddenGroups:o,hiddenSources:i}=_e(),d=Xt(),s=pn(),c=ia(s),u=n.useMemo(()=>$i(new Date(a,0,1),t),[a,t]),{sourced:h,events:p,sourceErrors:m}=hr(`${u[0]}-01-01`,`${u.at(-1)}-12-31`),y=n.useMemo(()=>Hi(c,s,u,t??a),[a,t,c,s,u]),S=n.useMemo(()=>[...h.map(ta),...p.map(Ye),...y.map(xi)],[h,p,y]),I=n.useMemo(()=>{let b=[];for(let w of S)b.push(...w.kind==="event"||w.kind==="sourced"?ql(w,`${u[0]}-01-01`,`${u.at(-1)}-12-31`):[w]);return Bl(qi(b,r,o,i))},[S,r,o,i,u]),M=n.useMemo(()=>{let b=[{id:Dt,label:l("calendar.filter.events"),count:p.length},{id:At,label:l("calendar.filter.noteDates"),count:y.length}],w=new Set;for(let P of d){if(w.has(P.sourceKey))continue;w.add(P.sourceKey);let _=P.integration?.localized?.[g.ui.language()];b.push({id:P.sourceKey,label:_?.name??P.integration?.name??P.owner,count:h.filter(k=>k.sourceOwner===P.owner).length})}return b},[p.length,y.length,d,h]),L=n.useMemo(()=>{let b=Object.fromEntries(r.map(w=>[w.id,0]));for(let w of S){let P=w.groupId?r.find(_=>_.id===w.groupId):No(r,w.group);P&&(b[P.id]=(b[P.id]??0)+1)}return b},[S,r]),R=n.useCallback(b=>Hl(b,r),[r]),N=n.useMemo(()=>{let b=new Map;for(let w of I){let P=b.get(w.date)??[];P.push(w),b.set(w.date,P)}for(let w of b.values())w.sort((P,_)=>(P.startTime??"99:99").localeCompare(_.startTime??"99:99"));return b},[I]);return{sourced:h,events:p,sourceErrors:m,items:I,itemsByDay:N,noteDates:y,sourceOptions:M,groupCounts:L,colorFor:R}}var Wl=["normal","low","medium","high"],Yl={normal:"calendar.priority.none",low:"calendar.priority.low",medium:"calendar.priority.medium",high:"calendar.priority.high"};function hn(e){let t=g.runtime.getOrCreate("calendar.eventDrafts",()=>new Map),a=t.get(e);return a||(a={fields:new Map,listeners:new Set},t.set(e,a)),a}function we(e,t,a){let r=hn(e),o=n.useRef(a);o.current=a;let i=n.useCallback(()=>{if(!r.fields.has(t)){let c=o.current;r.fields.set(t,typeof c=="function"?c():c)}return r.fields.get(t)},[r,t]),d=n.useSyncExternalStore(n.useCallback(c=>(r.listeners.add(c),()=>{r.listeners.delete(c)}),[r]),i,i),s=n.useCallback(c=>{r.fields.set(t,typeof c=="function"?c(i()):c);for(let u of r.listeners)u()},[r,t,i]);return[d,s]}function yr({title:e,children:t}){return n.createElement("div",{className:"calendar-quickadd-section"},n.createElement("span",{className:"calendar-quickadd-section-label"},e),t)}function Ot({glyph:e,children:t}){return n.createElement("div",{className:"calendar-quickadd-row"},n.createElement("span",{className:"calendar-quickadd-row-glyph","aria-hidden":"true"},e),n.createElement("div",{className:"calendar-quickadd-row-body"},t))}function yn(e){let t=e.state.editItem,a=t?.kind==="sourced",r=a?t.sourceId??"":"",o=a?t.id:"",i=n.useRef(e.onClose);return i.current=e.onClose,n.useEffect(()=>{a&&Zt(r,o).then(()=>i.current())},[a,r,o]),a?null:n.createElement(Xl,{...e})}function Xl({state:e,groups:t,onClose:a,onAdded:r}){let o=e.editItem,i=o?`${o.sourceId??o.kind}:${o.id}`:`new:${e.kind??""}:${e.date}:${e.startTime??""}`,[d]=n.useState(()=>Go()),s=e.kind??d[0]?.id??"event",[c,u]=we(i,"kind",o?.kind==="sourced"?o.sourceId??s:o?.kind==="event"?"event":s),[h,p]=we(i,"title",o?.title??""),[m,y]=we(i,"date",o?.date??e.date),[S,I]=we(i,"endDate",o?.event?.endDate??""),[M,L]=we(i,"start",o?.startTime??e.startTime??""),[R,N]=we(i,"end",o?.endTime??e.endTime??""),[b,w]=we(i,"groupId",()=>{let A=o?.event?.groupId??o?.sourced?.group??"";return t.find(oe=>oe.id===A)?.id??t.find(oe=>oe.name===A)?.id??""}),[P,_]=we(i,"location",o?.event?.location??o?.sourced?.location),[k,q]=we(i,"note",o?.event?.note??o?.sourced?.note??""),[z,U]=we(i,"urls",o?.event?.urls??o?.sourced?.urls??[]),[B,ye]=we(i,"attachments",o?.event?.attachments??o?.sourced?.attachments??[]),[de,le]=n.useState(!1),[v,D]=n.useState(""),[F,j]=n.useState(!1),[E,W]=n.useState(""),[Z,re]=we(i,"priority",o?.sourced?.priority??"normal"),[ze,ee]=we(i,"tags",o?.sourced?.tags??o?.event?.tags??[]),[Fe,Te]=we(i,"filePath",o?.sourced?.filePath??o?.event?.filePath??""),[Ce,$e]=we(i,"busy",!1),[Ze,mt]=we(i,"error",""),Ne=A=>{let oe=Kn(A);oe&&!z.includes(oe)&&U([...z,oe]),W(""),j(!1)},x=!M&&!R,O=A=>{A?(L(""),N("")):(L(e.startTime??"09:00"),N(e.endTime??"10:00"))},[Q]=we(i,"expectedUpdatedAt",o?.event?.updatedAt),[$,C]=we(i,"documentRevision",void 0),ne=o?.kind==="event"&&!o.readOnly?{pluginId:"calendar",sourceId:"events",itemId:o.id}:void 0,te=async()=>{if(!Ce)try{ne&&await g.documents.drafts.clear(ne),hn(i).fields.clear(),a()}catch(A){mt(A instanceof Error?A.message:String(A))}},he=async()=>{let A=h.trim();if(!(!A||hn(i).fields.get("busy")||o?.readOnly)){$e(!0),mt("");try{let oe=new Date().toISOString(),Ke=m||e.date,xn=t.find(Qe=>Qe.id===b)?.name,ka={location:P,urls:z.length>0?z:void 0,attachments:B.length>0?B:void 0,filePath:Fe.trim()||void 0,note:k},st={...ka,groupId:b||void 0,tags:ze},Sa={...ka,group:xn,tags:ze,priority:Z};if(o){if(o.kind==="event"&&o.event){if(!$)throw new Error(l("calendar.error.save"));let Qe=(await Me()).find(Ea=>Ea.id===o.id);if(!Qe)throw new Error(l("calendar.error.missing"));if(Qe.updatedAt!==Q)throw new Error(l("calendar.error.changed"));if(!await Ka(o.id,{...Qe,allDay:!M&&!R,title:A,date:Ke,endDate:S||void 0,startTime:M||void 0,endTime:R||void 0,...st,updatedAt:oe},Q,$))throw new Error(l("calendar.error.save"))}}else if(c==="event"){if(!await Eo(Ga(A,Ke,{endDate:S||void 0,startTime:M||void 0,endTime:R||void 0,...st})))throw new Error(l("calendar.error.save"))}else if(!await Za(c,Ke,{title:A,startTime:M||void 0,endTime:R||void 0,...Sa,completed:!1}))throw new Error(l("calendar.error.save"));ne&&await g.documents.drafts.clear(ne),hn(i).fields.clear(),r(),a()}catch(oe){mt(oe instanceof Error?oe.message:String(oe))}finally{$e(!1)}}},fe=c==="event",Re=A=>A==="event"?l("auto.ad8919ace091"):g.ui.t(d.find(oe=>oe.id===A)?.labelKey??A),{SelectField:ft,DateField:Lt,TimeField:gt,Segmented:ot,Toggle:it}=g.ui.settings;return n.createElement(g.ui.Modal,{title:o?l("calendar.quickadd.editTitle",{kind:Re(c)}):l("auto.61cc55aa0453"),bodyClassName:"calendar-quickadd",onClose:()=>{te()},footer:n.createElement(n.Fragment,null,n.createElement("button",{className:"calendar-quickadd-cancel",type:"button",disabled:Ce,onClick:()=>{te()}},l("auto.77dfd2135f4d")),!o?.readOnly&&n.createElement("button",{className:"calendar-quickadd-save",type:"button",onClick:()=>{he()},disabled:!h.trim()||Ce||!!ne&&!$},o?l("auto.efc007a393f6"):l("auto.61cc55aa0453")))},!o&&n.createElement("div",{className:"calendar-quickadd-head"},n.createElement(ot,{value:c,onChange:u,ariaLabel:l("calendar.quickadd.kind"),options:[{value:"event",label:l("auto.ad8919ace091")},...d.map(A=>({value:A.id,label:g.ui.t(A.labelKey)}))]})),n.createElement("div",{className:"calendar-quickadd-body hidescrollbar"},n.createElement("fieldset",{disabled:!!o?.readOnly,style:{display:"contents"}},n.createElement("input",{"data-modal-initial-focus":"true","aria-label":l("auto.768e0c1c6957"),className:"calendar-quickadd-title",value:h,onChange:A=>p(A.target.value),onKeyDown:A=>{A.key==="Enter"&&he()},placeholder:fe?l("auto.0cd372226ee9"):l("auto.33a5a701e541")}),n.createElement(yr,{title:l("calendar.quickadd.when")},n.createElement(Ot,{glyph:n.createElement(pt,null)},n.createElement("div",{className:"calendar-quickadd-dates"},n.createElement(Lt,{className:"calendar-quickadd-date",value:m,onChange:y,clearable:!1,ariaLabel:fe?l("calendar.quickadd.startDate"):l("calendar.quickadd.dueDate")}),fe&&n.createElement(n.Fragment,null,n.createElement("span",{className:"calendar-quickadd-dash","aria-hidden":"true"},"\u2192"),n.createElement(Lt,{className:"calendar-quickadd-date",value:S,onChange:I,min:m,placeholder:l("calendar.quickadd.endDate"),ariaLabel:l("calendar.quickadd.endDate")})))),n.createElement(Ot,{glyph:n.createElement(ga,null)},n.createElement("div",{className:"calendar-quickadd-times"},n.createElement(gt,{value:M,disabled:x,onChange:L,ariaLabel:l("auto.88d8206d586a")}),n.createElement("span",{"aria-hidden":"true"},"\u2013"),n.createElement(gt,{value:R,disabled:x,onChange:N,ariaLabel:l("auto.cd7800da7f4f")}),n.createElement("span",{className:"calendar-quickadd-allday"},l("calendar.quickadd.allDay"),n.createElement(it,{checked:x,onChange:O,label:l("calendar.quickadd.allDay")}))))),n.createElement(yr,{title:l("calendar.quickadd.details")},t.length>0&&n.createElement(Ot,{glyph:n.createElement(ti,null)},n.createElement(ft,{className:"calendar-quickadd-select",value:b,onChange:w,ariaLabel:l("auto.dbed7864623f"),options:[{value:"",label:l("auto.f6b2246c64fa")},...t.map(A=>({value:A.id,label:A.name,color:A.color}))]})),n.createElement(Ot,{glyph:n.createElement(Jt,null)},n.createElement(vi,{value:P,onChange:_})),n.createElement(Ot,{glyph:n.createElement(ea,null)},n.createElement(Zn,{value:Fe,onChange:Te})),n.createElement(Ot,{glyph:n.createElement(ri,null)},n.createElement(g.ui.TagInput,{value:ze,onChange:ee,readOnly:!!o?.readOnly})),!fe&&n.createElement(Ot,{glyph:n.createElement(oi,null)},n.createElement(ot,{value:Z,onChange:A=>re(A),ariaLabel:l("calendar.quickadd.priority"),options:Wl.map(A=>({value:A,label:l(Yl[A])}))}))),n.createElement(yr,{title:l("calendar.attachments")},B.map(A=>n.createElement(gi,{key:A,relPath:A,onRemove:()=>ye(B.filter(oe=>oe!==A))})),z.map(A=>n.createElement("div",{className:"calendar-quickadd-url-row",key:A},n.createElement("button",{className:"calendar-quickadd-url",type:"button",onClick:oe=>{let Ke=Oa(A);Ke?g.workspace.openFile(Ke,void 0,{newTab:g.ui.hasModKey(oe)}):g.files.openExternalUrl(A)}},A),n.createElement("button",{className:"calendar-field-btn",type:"button",title:l("calendar.removeUrl"),"aria-label":l("calendar.removeUrlOf",{p0:A}),onClick:()=>U(z.filter(oe=>oe!==A))},n.createElement(nt,null)))),de?n.createElement(Zn,{value:v,placeholder:l("calendar.attachmentPlaceholder"),ariaLabel:l("calendar.attachmentPath"),onChange:A=>{D(A),A&&(B.includes(A)||ye([...B,A]),D(""),le(!1))}}):null,F?n.createElement("input",{className:"calendar-quickadd-input",value:E,autoFocus:!0,placeholder:l("calendar.urlPlaceholder"),"aria-label":l("calendar.url"),onChange:A=>W(A.target.value),onBlur:A=>Ne(A.target.value),onKeyDown:A=>{A.key==="Enter"&&(A.preventDefault(),Ne(A.currentTarget.value)),A.key==="Escape"&&(W(""),j(!1))}}):null,n.createElement("div",{className:"calendar-quickadd-adders"},!de&&n.createElement("button",{className:"calendar-quickadd-add",type:"button",onClick:()=>le(!0)},n.createElement(ut,null)," ",l("calendar.addAttachment")),!F&&n.createElement("button",{className:"calendar-quickadd-add",type:"button",onClick:()=>j(!0)},n.createElement(Pt,null)," ",l("calendar.addUrl"))),n.createElement(g.ui.NoteInput,{onRevisionChange:A=>C(oe=>!oe||A.expectedRevision<oe.expectedRevision?A:oe),className:"calendar-quickadd-note",value:k,onChange:q,context:{sourcePath:Fe||void 0,ref:ne},tags:ze,onTagsChange:ee,onSave:()=>{he()},onCancel:()=>{te()},placeholder:l("auto.1a29d1bf66f5"),minHeight:100,maxHeight:340,readOnly:!!o?.readOnly}))),Ze&&n.createElement("div",{role:"alert"},Ze)))}function Zl(e,t){return e.getFullYear()===t.getFullYear()&&e.getMonth()===t.getMonth()&&e.getDate()===t.getDate()}function Ql(e){let t=e.getFullYear(),a=String(e.getMonth()+1).padStart(2,"0"),r=String(e.getDate()).padStart(2,"0");return`${t}-${a}-${r}`}function rs(){let e=new Date,t=Ql(e),[a,r]=on();fn("left_sidebar",a);let{items:o,sourceOptions:i,groupCounts:d,colorFor:s,sourceErrors:c}=gn(),{groups:u,hiddenGroups:h,hiddenSources:p}=_e(),m=n.useRef(null),y=kt(),S=n.useSyncExternalStore(n.useCallback(v=>y.subscribe(v),[y]),n.useCallback(()=>{let v=y.get();return v?.surface==="agenda"?v:null},[y]),n.useCallback(()=>{let v=y.get();return v?.surface==="agenda"?v:null},[y])),I=n.useRef(new Map),M=n.useRef(!1),L=n.useRef(null),[R,N]=n.useState(!0),[b,w]=n.useState(""),[P,_]=n.useState(null),k=n.useRef(null),q=n.useCallback(v=>{Xe(v,"left_sidebar"),k.current&&clearTimeout(k.current),k.current=setTimeout(()=>{k.current=null,L.current=v.date,wi(v)},220)},[]),z=n.useCallback(v=>{if(k.current&&(clearTimeout(k.current),k.current=null),Xe(v,"left_sidebar"),!v.readOnly){if(v.kind==="sourced"){Zt(v.sourceId??"",v.id);return}_({date:v.date,editItem:v})}},[]);n.useEffect(()=>()=>{k.current&&clearTimeout(k.current)},[]);let U=n.useMemo(()=>{let v=b.trim().toLowerCase();return v?o.filter(D=>[D.title,D.note,D.group,D.status,D.location?.name,...D.tags??[],...(D.fields??[]).flatMap(F=>[F.key,F.value])].some(F=>F?.toLowerCase().includes(v))):o},[o,b]),{days:B,byDay:ye}=n.useMemo(()=>{let v=new Map;for(let F of U){let j=v.get(F.date)??[];j.push(F),v.set(F.date,j)}for(let F of v.values())F.sort((j,E)=>(j.startTime??"99:99").localeCompare(E.startTime??"99:99"));return!b.trim()&&a.selectedDate&&!v.has(a.selectedDate)&&v.set(a.selectedDate,[]),{days:[...v.keys()].sort((F,j)=>j.localeCompare(F)),byDay:v}},[b,a.selectedDate,U]);n.useEffect(()=>{if(M.current||B.length===0)return;let v=B.includes(t)?t:[...B].reverse().find(F=>F>=t);if(!v){M.current=!0;return}let D=I.current.get(v);D&&typeof D.scrollIntoView=="function"&&(D.scrollIntoView({block:"start"}),M.current=!0)},[B,t]),n.useEffect(()=>{if(!a.selectedDate)return;if(L.current===a.selectedDate){L.current=null;return}let v=I.current.get(a.selectedDate);v&&typeof v.scrollIntoView=="function"&&v.scrollIntoView({behavior:"smooth",block:"start"})},[a.selectedDate]),n.useEffect(()=>{if(!S)return;let v=requestAnimationFrame(()=>{[...m.current?.querySelectorAll("[data-calendar-item-id]")??[]].find(j=>j.dataset.calendarItemId===S.itemId&&(j.dataset.calendarSourceId??"")===S.sourceId)?.scrollIntoView({behavior:"smooth",block:"center"})});return()=>cancelAnimationFrame(v)},[S]),n.useEffect(()=>{let v=m.current;if(!v)return;let D=()=>{let F=I.current.get(t);if(!F){N(!1);return}let j=v.getBoundingClientRect(),E=F.getBoundingClientRect();N(E.bottom>j.top&&E.top<j.bottom)};return v.addEventListener("scroll",D,{passive:!0}),D(),()=>v.removeEventListener("scroll",D)},[t,B]);function de(){let v=I.current.get(t);v&&v.scrollIntoView({behavior:"smooth",block:"start"})}let le=async(v,D)=>{D.preventDefault(),D.stopPropagation(),Xe(v,"left_sidebar");let F=await an(v,{onEdit:()=>z(v)}),j=nn(v),E=rn(v),W=[...F,...E],Z=W.length>0?[]:na(v),re=[...W,...W.length>0&&(Z.length>0||j.length>0)?[{type:"separator"}]:[],...Z,...j];re.length!==0&&await g.ui.openMenu(re,{x:D.clientX,y:D.clientY})};return n.createElement("div",{className:"panel calendar-agenda-panel"},c.map(v=>n.createElement("div",{key:v.owner,className:"agenda-day-empty",role:"status"},v.message)),n.createElement("div",{className:"panel-header"},n.createElement("span",{className:"panel-title"},l("auto.891e9d6d47f1")),n.createElement("div",{className:"agenda-header-actions"},n.createElement(mn,{label:l("calendar.filter.sources"),icon:n.createElement(Jo,null),options:i.map(v=>({...v,color:"palette:primary-blue"})),hidden:p,settingsKey:Yt,emptyText:l("calendar.filter.noSources")}),n.createElement(mn,{label:l("calendar.filter.groups"),icon:n.createElement(ei,null),options:u.map(v=>({id:v.id,label:v.name,color:v.color,count:d[v.id]??0})),hidden:h,settingsKey:Ha,emptyText:l("calendar.filter.noGroups"),onOpenSettings:()=>g.workspace.openSettings("groups")}),n.createElement(Yi,null),!R&&n.createElement("button",{className:"agenda-today-btn",onClick:de},l("auto.24345a14377f")),n.createElement("button",{className:"plugin-open-page",onClick:()=>g.workspace.openMainTab(),"aria-label":l("auto.9ee309dcedc9"),title:l("auto.9ee309dcedc9")}))),n.createElement("div",{className:"agenda-search search-field"},n.createElement(Qo,{className:"search-field-icon"}),n.createElement("input",{className:"search-field-input",value:b,onChange:v=>w(v.target.value),onKeyDown:v=>{v.key==="Escape"&&w("")},placeholder:l("calendar.agenda.searchPlaceholder"),"aria-label":l("calendar.agenda.searchLabel")}),b&&n.createElement("button",{className:"search-field-action",type:"button",onClick:()=>w(""),"aria-label":l("calendar.agenda.clearSearch")},n.createElement(nt,null))),n.createElement("div",{className:"panel-body agenda-body hidescrollbar",ref:m},B.length===0?n.createElement("div",{className:"tree-empty"},l("auto.418713defbf7")):B.map((v,D)=>{let F=ge(v),j=ye.get(v)??[],E=Zl(F,e),W=a.selectedDate===v,Z=F.getFullYear(),re=D>0?ge(B[D-1]).getFullYear():null;return n.createElement("div",{key:v,className:"agenda-section",ref:ee=>{ee?I.current.set(v,ee):I.current.delete(v)}},re!==null&&Z!==re&&n.createElement("div",{className:"agenda-year-sep"},Z),n.createElement("button",{type:"button",className:`agenda-day-header${E?" today":""}${W?" selected":""}`,onClick:()=>r({selectedDate:W?null:v,rangeStart:null,rangeEnd:null})},n.createElement("span",{className:"agenda-day-dow"},et(F.getDay(),g.ui.language())),n.createElement("span",{className:"agenda-day-num"},F.getDate()),n.createElement("span",{className:"agenda-day-month"},tt(F.getMonth(),g.ui.language()))),j.length===0?n.createElement("div",{className:"agenda-day-empty"},l("auto.f4e12416c6b8")):j.map(ee=>{let Fe=S?.itemId===ee.id&&S.sourceId===(ee.sourceId??"");return n.createElement(tn,{key:`${ee.occurrenceKey??ee.id}:${Fe?S?.nonce:0}`,item:ee,sourceId:ee.sourceId??"",color:s(ee),revealNonce:Fe?S?.nonce:void 0,onClick:()=>q(ee),onDoubleClick:()=>z(ee),onContextMenu:Te=>{le(ee,Te)}})}))})),P&&n.createElement(yn,{key:`${P.editItem?.sourceId??P.editItem?.kind}:${P.editItem?.id}`,state:P,groups:u,onClose:()=>_(null),onAdded:()=>_(null)}))}var Jl=60,ec=5,tc=.22;function ac(e){let t=[];return e.forEach((a,r)=>{if(!a.startTime)return;let o=Ae(a.startTime),i=a.endTime?Ae(a.endTime):o+Jl;t.push({id:a.id,start:o,end:Math.max(i,o+ec),order:r})}),t.sort((a,r)=>a.start-r.start||r.end-a.end||a.order-r.order)}function nc(e,t){return e.start<t.end&&t.start<e.end}function rc(e,t,a,r){return!e.some(o=>o.id!==r.id&&t.get(o.id)===a&&nc(o,r))}function oc(e,t){let a=[],r=new Map;for(let d of e){let s=a.findIndex(c=>c<=d.start);s===-1&&(s=a.length),a[s]=d.end,r.set(d.id,s)}let o=a.length;if(o===1){for(let d of e)t.set(d.id,{left:0,width:1,z:1});return}let i=1/o;for(let d of e){let s=r.get(d.id)??0,c=1;for(;s+c<o&&rc(e,r,s+c,d);)c++;let u=s>0?tc*i:0;t.set(d.id,{left:s*i-u,width:c*i+u,z:s+1})}}function os(e){let t=new Map,a=[],r=-1,o=()=>{a.length>0&&oc(a,t),a=[],r=-1};for(let i of ac(e))a.length>0&&i.start>=r&&o(),a.push(i),r=Math.max(r,i.end);return o(),t}var ke=44,rt=15,br=24;function ic(e,t,a){let r=Math.max(0,Math.min(t,br-1)),o=Math.min(br,Math.max(a,r+1));for(let i of e){if(!i.startTime)continue;let d=Ae(i.startTime),s=i.endTime?Ae(i.endTime):d;r=Math.min(r,Math.max(0,Math.floor(d/60))),o=Math.max(o,Math.min(br,Math.ceil(s/60)))}return{startHour:r,endHour:o}}function ss({days:e,items:t,dayStartHour:a,dayEndHour:r,colorFor:o,selectedItemKey:i,onSelectItem:d,onEditItem:s,onCommit:c,onCreate:u,onContextMenu:h,onItemAction:p,compact:m,weekDays:y,selectedDay:S,selectedTime:I,itemsByDay:M,onPickDay:L,revealTarget:R}){let N=new Date,b=n.useRef(null),[w,P]=n.useState(0),[_,k]=n.useState(null),q=n.useRef(null);q.current=_;let z=n.useRef(!1),[U,B]=n.useState(()=>new Date);n.useEffect(()=>{let x=setInterval(()=>B(new Date),6e4);return()=>clearInterval(x)},[]);let ye=e.length;n.useEffect(()=>{let x=b.current,O=x?.ownerDocument.defaultView?.ResizeObserver??globalThis.ResizeObserver;if(!x||!O)return;let Q=new O(()=>{P(Math.max(0,(x.clientWidth-48)/ye))});return Q.observe(x),()=>Q.disconnect()},[ye]);let de=e.map(J),{startHour:le,endHour:v}=n.useMemo(()=>ic(t,a,r),[t,a,r]),D=le*60,F=v*60,j=Array.from({length:v-le},(x,O)=>le+O);n.useEffect(()=>{let x=b.current;if(!x||!I)return;let O=Math.max(0,(Ae(I)-D)/60*ke-ke);typeof x.scrollTo=="function"?x.scrollTo({top:O,behavior:"smooth"}):x.scrollTop=O},[I,D]);let E=t.filter(x=>x.startTime),W=e,Z=t.filter(x=>!x.startTime),re=n.useMemo(()=>{let x=new Map;for(let Q of t){if(!Q.startTime)continue;let $=x.get(Q.date)??[];$.push(Q),x.set(Q.date,$)}let O=new Map;for(let[Q,$]of x)for(let[C,ne]of os($))O.set(`${Q}:${C}`,ne);return O},[t]),ze=U.getHours()*60+U.getMinutes(),ee=e.findIndex(x=>je(x,U)),Fe=ee>=0&&ze>=D&&ze<=F,Te=(ze-D)/60*ke,Ce=(x,O,Q)=>{if(x.preventDefault(),x.stopPropagation(),O.readOnly)return;let $=de.indexOf(O.date);if($===-1)return;z.current=!1;let C=O.startTime?Ae(O.startTime):D,ne=O.endTime?Ae(O.endTime):C+60;k({id:O.id,mode:Q,startX:x.clientX,startY:x.clientY,origDateIndex:$,origStartMin:C,origEndMin:ne,dateIndex:$,startMin:C,endMin:ne}),x.target.setPointerCapture?.(x.pointerId)},$e=x=>{let O=q.current;if(!O)return;(Math.abs(x.clientX-O.startX)>3||Math.abs(x.clientY-O.startY)>3)&&(z.current=!0);let Q=x.clientY-O.startY,$=Math.round(Q/ke*60/rt)*rt;if(O.mode==="create"){let C=O.origStartMin+$,ne=Math.max(D,Math.min(O.origStartMin,C)),te=Math.min(F,Math.max(O.origStartMin,C));k({...O,startMin:ne,endMin:te>ne?te:ne+rt})}else if(O.mode==="move"){let C=x.clientX-O.startX,ne=w?Math.round(C/w):0,te=O.origEndMin-O.origStartMin,he=Math.max(0,Math.min(ye-1,O.origDateIndex+ne)),fe=Math.max(D,Math.min(F-te,O.origStartMin+$));k({...O,dateIndex:he,startMin:fe,endMin:fe+te})}else{let C=Math.max(O.origStartMin+rt,Math.min(F,O.origEndMin+$));k({...O,endMin:C})}},Ze=()=>{let x=q.current;if(!x)return;if(k(null),x.mode==="create"){let $=de[x.dateIndex];u($,Oe(x.startMin),Oe(x.endMin));return}let O=E.find($=>$.id===x.id);if(!O)return;(x.dateIndex!==x.origDateIndex||x.startMin!==x.origStartMin||x.endMin!==x.origEndMin)&&c(O,de[x.dateIndex],Oe(x.startMin),Oe(x.endMin))},mt=(x,O)=>{if(q.current)return;x.preventDefault();let Q=x.currentTarget.getBoundingClientRect(),$=x.clientY-Q.top,C=D+$/ke*60,ne=Math.round(C/rt)*rt,te=Math.max(D,Math.min(F-rt,ne));z.current=!1,k({id:"__create__",mode:"create",startX:x.clientX,startY:x.clientY,origDateIndex:O,origStartMin:te,origEndMin:te+60,dateIndex:O,startMin:te,endMin:te+60}),x.target.setPointerCapture?.(x.pointerId)},Ne=(x,O)=>{let Q=O.getBoundingClientRect(),$=x.clientY-Q.top,C=D+$/ke*60;return Oe(Math.round(C/rt)*rt)};return n.createElement("div",{className:"calendar-weekgrid",style:{"--week-cols":ye}},m&&y&&L?n.createElement("div",{className:"calendar-weekgrid-daypicker"},y.map(x=>{let O=S?je(x,S):!1,Q=je(x,N),$=(M?.get(J(x))?.length??0)>0;return n.createElement("button",{key:J(x),type:"button",className:`calendar-daypick${O?" selected":""}${Q?" today":""}`,onClick:()=>L(x)},n.createElement("span",{className:"calendar-daypick-dow"},et(x.getDay(),g.ui.language())),n.createElement("span",{className:"calendar-daypick-num"},x.getDate()),n.createElement("span",{className:`calendar-daypick-dot${$?" on":""}`}))})):n.createElement("div",{className:"calendar-weekgrid-head"},n.createElement("div",{className:"calendar-weekgrid-gutter calendar-weekgrid-headgutter"}),e.map(x=>{let O=S?je(x,S):!1;return n.createElement("button",{key:J(x),type:"button",className:`calendar-weekgrid-dayhead${je(x,N)?" today":""}${O?" selected":""}`,onClick:()=>L?.(x)},n.createElement("span",{className:"calendar-weekgrid-dow"},et(x.getDay(),g.ui.language())),n.createElement("span",{className:"calendar-weekgrid-dom"},x.getDate()))})),Z.length>0&&n.createElement("div",{className:`calendar-weekgrid-allday${m?" calendar-weekgrid-allday--compact":""}`},n.createElement("div",{className:"calendar-weekgrid-gutter"},l("auto.1ac1ff7616a6")),W.map(x=>{let O=J(x),Q=Z.filter($=>$.date===O);return n.createElement("div",{key:O,className:"calendar-weekgrid-alldaycol"},Q.map($=>{let C=is($,R),ne=Ue($)===i;return n.createElement("button",{key:`${$.occurrenceKey??$.id}:${C?R?.nonce:0}`,className:`calendar-chip${$.borderColor?" outlined":""}${ne?" selected":""}${C?" calendar-reveal-target":""}`,"aria-pressed":ne,"data-calendar-source-id":$.sourceId,"data-calendar-item-id":$.id,style:{"--chip-color":me(o($)),...$.borderColor?{"--chip-border":me($.borderColor)}:{}},title:aa($),onClick:te=>{te.stopPropagation(),d($)},onDoubleClick:te=>{te.stopPropagation(),s($)},onContextMenu:te=>{te.preventDefault(),te.stopPropagation(),p?.($,te)}},$.icon&&n.createElement(Le,{id:$.icon,className:"calendar-chip-glyph"}),n.createElement("span",{className:"calendar-chip-title"},$.title),n.createElement(Mt,{badges:$.badges}))}))})),n.createElement("div",{className:"calendar-weekgrid-body",ref:b,onPointerMove:$e,onPointerUp:Ze,onPointerCancel:Ze},n.createElement("div",{className:"calendar-weekgrid-gutter calendar-weekgrid-hours"},j.map(x=>n.createElement("div",{key:x,className:"calendar-weekgrid-hour",style:{height:ke}},String(x).padStart(2,"0"),":00"))),e.map((x,O)=>{let Q=J(x),$=E.filter(C=>C.date===Q);return n.createElement("div",{key:Q,className:"calendar-weekgrid-col",style:{height:j.length*ke},onPointerDown:C=>mt(C,O),onContextMenu:C=>{C.preventDefault(),C.stopPropagation(),h?.(C,Q,Ne(C,C.currentTarget))}},j.map(C=>n.createElement("div",{key:C,className:"calendar-weekgrid-cell",style:{height:ke}})),$.map(C=>{let ne=is(C,R),te=Ue(C)===i,he=_?.id===C.id,fe=he?_.startMin:Ae(C.startTime),Re=he?_.endMin:C.endTime?Ae(C.endTime):fe+60,ft=(fe-D)/60*ke,Lt=Math.max(18,(Re-fe)/60*ke),gt=_?.mode==="move"&&_.id===C.id&&_.dateIndex===O,ot=_?.mode==="move"&&_.id===C.id&&_.dateIndex!==O,it=he?void 0:re.get(`${Q}:${C.id}`);return n.createElement("div",{key:`${C.occurrenceKey??C.id}:${ne?R?.nonce:0}`,className:`calendar-weekgrid-block${C.borderColor?" outlined":""}${C.completed?" completed":""}${te?" selected":""}${he&&_.mode!=="move"||gt?" dragging":""}${ot?" drag-ghost":""}${ne?" calendar-reveal-target":""}`,"aria-selected":te,"data-calendar-source-id":C.sourceId,"data-calendar-item-id":C.id,style:{top:ot?C.startTime?(Ae(C.startTime)-D)/60*ke:0:ft,height:ot?Math.max(18,((C.endTime?Ae(C.endTime):(C.startTime?Ae(C.startTime):0)+60)-(C.startTime?Ae(C.startTime):0))/60*ke):Lt,"--chip-color":me(o(C)),...C.borderColor?{"--chip-border":me(C.borderColor)}:{},zIndex:he&&_.mode!=="move"||gt?9:te?7:it?.z,...it?{"--block-left":`${it.left*100}%`,"--block-width":`${it.width*100}%`}:{}},onPointerDown:A=>Ce(A,C,"move"),onClick:A=>{A.stopPropagation(),z.current||d(C)},onDoubleClick:A=>{A.stopPropagation(),z.current||s(C)},onContextMenu:A=>{A.preventDefault(),A.stopPropagation(),p?.(C,A)},title:`${aa(C)} \xB7 ${Oe(fe)}\u2013${Oe(Re)}`},n.createElement("span",{className:"calendar-weekgrid-block-time"},Oe(fe)),n.createElement("span",{className:"calendar-weekgrid-block-title"},C.icon&&n.createElement(Le,{id:C.icon,className:"calendar-chip-glyph"}),n.createElement("span",{className:"calendar-weekgrid-block-name"},C.title),n.createElement(Mt,{badges:C.badges})),!C.readOnly&&n.createElement("div",{className:"calendar-weekgrid-resize",onPointerDown:A=>Ce(A,C,"resize")}))}),_?.mode==="create"&&_.dateIndex===O&&n.createElement("div",{className:"calendar-weekgrid-block calendar-weekgrid-block--create",style:{top:(_.startMin-D)/60*ke,height:Math.max(18,(_.endMin-_.startMin)/60*ke),"--chip-color":"var(--accent-color)"}},n.createElement("span",{className:"calendar-weekgrid-block-time"},Oe(_.startMin)),n.createElement("span",{className:"calendar-weekgrid-block-title"},Oe(_.startMin),"\u2013",Oe(_.endMin))),_?.mode==="move"&&_.dateIndex===O&&_.id!=="__create__"&&(()=>{let C=E.find(fe=>fe.id===_.id);if(!C||de.indexOf(C.date)===O)return null;let ne=(_.startMin-D)/60*ke,te=_.endMin-_.startMin,he=Math.max(18,te/60*ke);return n.createElement("div",{className:"calendar-weekgrid-block calendar-weekgrid-block--ghost",style:{top:ne,height:he,"--chip-color":me(o(C))}},n.createElement("span",{className:"calendar-weekgrid-block-time"},Oe(_.startMin)),n.createElement("span",{className:"calendar-weekgrid-block-title"},C.title))})())}),Fe&&n.createElement("div",{className:"calendar-weekgrid-now",style:{top:Te}},n.createElement("span",{className:"calendar-weekgrid-now-time"},Oe(ze)),n.createElement("span",{className:"calendar-weekgrid-now-line"}),n.createElement("span",{className:"calendar-weekgrid-now-line calendar-weekgrid-now-line--today",style:{left:48+ee*w,width:w}}),n.createElement("span",{className:"calendar-weekgrid-now-dot",style:{left:48+ee*w}}))))}function is(e,t){return!!t&&(e.sourceId??"")===t.sourceId&&e.id===t.itemId}function sc({items:e,colorFor:t,selectedItemKey:a,onSelectItem:r,onEditItem:o,onItemAction:i,revealTarget:d}){if(e.length===0)return null;let s=e.slice(0,3),c=e.length-s.length;return n.createElement("div",{className:"calendar-chips"},s.map(u=>{let h=bn(u,d),p=Ue(u)===a;return n.createElement("button",{key:`${u.occurrenceKey??u.id}:${h?d?.nonce:0}`,className:`calendar-chip${u.completed?" completed":""}${u.borderColor?" outlined":""}${p?" selected":""}${h?" calendar-reveal-target":""}`,"aria-pressed":p,"data-calendar-source-id":u.sourceId,"data-calendar-item-id":u.id,style:{"--chip-color":me(t(u)),...u.borderColor?{"--chip-border":me(u.borderColor)}:{}},title:aa(u),onClick:m=>{m.stopPropagation(),r(u)},onDoubleClick:m=>{m.stopPropagation(),o(u)},onContextMenu:m=>{m.preventDefault(),m.stopPropagation(),i(u,m)}},u.icon&&n.createElement(Le,{id:u.icon,className:"calendar-chip-glyph"}),u.startTime&&n.createElement("span",{className:"calendar-chip-time"},u.startTime),n.createElement("span",{className:"calendar-chip-title"},u.title),n.createElement(Mt,{badges:u.badges}))}),c>0&&n.createElement("span",{className:"calendar-chip-more"},"+",c))}function ds({year:e,month:t,today:a,selected:r,weekStart:o,compact:i,itemsByDay:d,colorFor:s,onPick:c,onPickWeek:u,selectedItemKey:h,onSelectItem:p,onEditItem:m,onItemAction:y,inRange:S,onRangeStart:I,onRangeOver:M,onRangeEnd:L,onContextMenu:R,revealTarget:N}){let b=_a(e,t,o);return n.createElement("div",{className:"calendar-grid",onMouseUp:L},n.createElement("div",{className:"calendar-week-heading"},"W"),La(o).map(w=>n.createElement("div",{className:"calendar-day-heading",key:w},et(w,g.ui.language()))),Array.from({length:6},(w,P)=>n.createElement(n.Fragment,{key:P},n.createElement("button",{type:"button",className:"calendar-week-number",onClick:()=>u(b[P*7]),title:l("auto.4869ac12717f")},St(b[P*7])),b.slice(P*7,P*7+7).map(_=>{let k=d.get(J(_))??[],q=k.some(z=>bn(z,N));return n.createElement(dc,{key:`${_.toISOString()}:${q?N?.nonce:0}`,date:_,outside:_.getMonth()!==t,today:a,selected:r,compact:i,items:k,colorFor:s,inRange:S(_),onPick:c,selectedItemKey:h,onSelectItem:p,onEditItem:m,onItemAction:y,onRangeStart:I,onRangeOver:M,onContextMenu:R,revealTarget:N})}))))}function ls({year:e,today:t,weekStart:a,onPickMonth:r,revealTarget:o}){let i=La(a);return n.createElement("div",{className:"calendar-year"},Array.from({length:12},(d,s)=>{let c=_a(e,s,a),u=tt(s,g.ui.language());return n.createElement("button",{className:"calendar-mini",key:s,onClick:()=>r(s)},n.createElement("div",{className:"calendar-mini-name"},u),n.createElement("div",{className:"calendar-mini-grid"},i.map(h=>n.createElement("div",{className:"calendar-mini-heading",key:h},et(h,g.ui.language(),"narrow"))),c.map(h=>{let p=h.getMonth()!==s,m=je(h,t),y=!p&&J(h)===o?.date;return n.createElement("div",{key:`${h.toISOString()}:${y?o?.nonce:0}`,className:`calendar-mini-day ${p?"outside":""} ${m?"today":""}${y?" calendar-reveal-target":""}`},h.getDate())})))}))}function dc({date:e,outside:t,today:a,selected:r,compact:o,items:i,colorFor:d,inRange:s,onPick:c,selectedItemKey:u,onSelectItem:h,onEditItem:p,onItemAction:m,onRangeStart:y,onRangeOver:S,onContextMenu:I,revealTarget:M}){let L=je(e,a),R=je(e,r),N=i.findIndex(w=>bn(w,M)),b=N>=0&&(o||N>=3);return n.createElement("div",{className:`calendar-day-cell ${t?"outside":""} ${L?"today":""} ${R?"selected":""} ${s?"in-range":""}${b?" calendar-reveal-target calendar-reveal-day":""}`,onMouseDown:()=>y(e),onMouseEnter:()=>S(e),onContextMenu:w=>I(w,e),onClick:w=>{w.target.closest(".calendar-chip")||c(e,w)}},n.createElement("div",{className:"calendar-day-cell-head"},n.createElement("span",{className:"calendar-day-num"},e.getDate())),!o&&n.createElement(sc,{items:i,colorFor:d,selectedItemKey:u,onSelectItem:h,onEditItem:p,onItemAction:m,revealTarget:M}),o&&i.length>0&&n.createElement("div",{className:"calendar-day-dots"},i.slice(0,4).map(w=>n.createElement("span",{key:w.occurrenceKey??w.id,className:`calendar-day-dot${bn(w,M)?" calendar-reveal-dot":""}`,style:{background:me(d(w))}}))))}function bn(e,t){return!!t&&(e.sourceId??"")===t.sourceId&&e.id===t.itemId}function _t(){return{acc:0,fired:!1,peak:0,lastAbsX:0,decayFrames:0,coasting:!1,reswipeAcc:0,reswipeLastAbsX:0}}function vr(e,t,a){if(Math.abs(t)<=Math.abs(a))return{gesture:e,step:0};let r=Math.abs(t);if(e.fired){if(e.reswipeAcc!==0&&Math.sign(e.reswipeAcc)===Math.sign(t)&&r>=e.reswipeLastAbsX+3){let m=e.reswipeAcc+t;return Math.abs(m)>=60?{gesture:{..._t(),fired:!0,peak:r,lastAbsX:r},step:m>0?1:-1}:{gesture:{..._t(),acc:m,peak:r,lastAbsX:r},step:0}}let d=Math.max(e.peak,r),s=r<e.lastAbsX?e.decayFrames+1:0,c=e.coasting||s>=3&&r<d*.5,u=c&&r>=e.lastAbsX+6;return{gesture:{...e,peak:d,lastAbsX:r,decayFrames:s,coasting:c,reswipeAcc:u?t:0,reswipeLastAbsX:u?r:0},step:0}}let i=(Math.sign(e.acc)===Math.sign(t)?e.acc:0)+t;return Math.abs(i)<60?{gesture:{...e,acc:i,peak:Math.max(e.peak,r),lastAbsX:r},step:0}:{gesture:{..._t(),fired:!0,peak:r,lastAbsX:r},step:i>0?1:-1}}var cc=20;function uc(e,t){return!!(e&&e.view===t.view&&e.cursor===t.cursor&&e.selectedDate===t.selectedDate&&e.rangeStart===t.rangeStart&&e.rangeEnd===t.rangeEnd)}function pc(e){if(e.rangeStart&&e.rangeEnd){let[t,a]=e.rangeStart<=e.rangeEnd?[e.rangeStart,e.rangeEnd]:[e.rangeEnd,e.rangeStart];return{selectedDate:e.selectedDate,rangeStart:t,rangeEnd:a}}return e.selectedDate?{selectedDate:e.selectedDate,rangeStart:null,rangeEnd:null}:null}function mc(){let e=kt(),t=n.useCallback(r=>e.subscribe(r),[e]),a=n.useCallback(()=>{let r=e.get();return r?.surface==="main"?r:null},[e]);return n.useSyncExternalStore(t,a,a)}function vn({variant:e="main",navigation:t}){let a=new Date,r=Mo("weekStart"),{groups:o,dayStartHour:i,dayEndHour:d,itemClickTarget:s}=_e(),c=pa[r]??1,[u,h]=on(),p=mc(),m=n.useMemo(()=>Je(),[]),[y,S]=n.useState(u.view??m.view),[I,M]=n.useState(u.cursor??m.cursor),[L,R]=n.useState(()=>({entries:[{view:u.view??m.view,cursor:u.cursor??m.cursor,selectedDate:u.selectedDate??null,rangeStart:u.rangeStart??null,rangeEnd:u.rangeEnd??null}],index:0})),N=n.useCallback(f=>{R(T=>{if(uc(T.entries[T.index],f))return T;let be=[...T.entries.slice(0,T.index+1),f].slice(-cc);return{entries:be,index:be.length-1}})},[]),b=n.useCallback((f,T={})=>{let H={view:f.view??y,cursor:f.cursor??I,selectedDate:f.selectedDate===void 0?u.selectedDate??null:f.selectedDate,rangeStart:f.rangeStart===void 0?u.rangeStart??null:f.rangeStart,rangeEnd:f.rangeEnd===void 0?u.rangeEnd??null:f.rangeEnd};T.pushHistory!==!1&&N(H),f.view!==void 0&&S(f.view),f.cursor!==void 0&&M(f.cursor),Object.keys(f).length>0&&h(f)},[I,h,N,u.rangeEnd,u.rangeStart,u.selectedDate,y]),w=n.useCallback(f=>{let T=L.index+f;if(T<0||T>=L.entries.length)return;let H=L.entries[T];R({...L,index:T}),b(H,{pushHistory:!1})},[L,b]),P=e==="main"?"main_workspace":"right_sidebar";fn(P,u,n.useMemo(()=>({canGoBack:L.index>0,canGoForward:L.index<L.entries.length-1,goBack:()=>w(-1),goForward:()=>w(1)}),[w,L.entries.length,L.index])),n.useEffect(()=>{if(!(e!=="main"||!t))return t.setController({canGoBack:L.index>0,canGoForward:L.index<L.entries.length-1,goBack:()=>w(-1),goForward:()=>w(1)}),()=>t.setController(null)},[w,L.entries.length,L.index,t,e]),n.useEffect(()=>{S(u.view??m.view),M(u.cursor??m.cursor)},[m.cursor,m.view,u.view,u.cursor]),n.useEffect(()=>{if(e==="right")return()=>g.interop.state.publish(wt,null)},[e]),n.useEffect(()=>{e==="right"&&g.interop.state.publish(wt,pc({view:y,cursor:I,selectedDate:u.selectedDate,rangeStart:u.rangeStart,rangeEnd:u.rangeEnd}))},[I,u.rangeEnd,u.rangeStart,u.selectedDate,e,y]);let _=ge(I),k=u.selectedDate?ge(u.selectedDate):a,[q,z]=n.useState(!1),U=e!=="main"||q,[B,ye]=n.useState(1),de=n.useRef({..._t(),idleTimer:null}),[le,v]=n.useState(null),[D,F]=n.useState(null),j=n.useRef(null),E=n.useRef(0),{items:W,itemsByDay:Z,colorFor:re,sourceErrors:ze}=gn({focusYear:Number(I.slice(0,4))}),ee=n.useRef(null),Fe=n.useCallback(f=>{F(Ue(f)),Xe(f,P),ee.current&&clearTimeout(ee.current),ee.current=setTimeout(()=>{if(ee.current=null,s==="owner"&&f.kind==="sourced"&&f.sourceId){Ko(f.sourceId,f.id).then(T=>{T||ar(f)});return}ar(f)},220)},[s,P]),Te=n.useCallback(f=>{if(ee.current&&(clearTimeout(ee.current),ee.current=null),F(Ue(f)),Xe(f,P),!f.readOnly){if(f.kind==="sourced"){Zt(f.sourceId??"",f.id);return}v({date:f.date,editItem:f})}},[P]),Ce=er(),$e=n.useSyncExternalStore(n.useCallback(f=>Ce.subscribe(f),[Ce]),n.useCallback(()=>Ce.get(),[Ce]),n.useCallback(()=>Ce.get(),[Ce]));n.useEffect(()=>{e!=="main"||!$e||($e.item.readOnly?v({date:$e.item.date,editItem:$e.item}):Te($e.item),Ce.publish(null))},[Te,$e,Ce,e]),n.useEffect(()=>()=>{ee.current&&clearTimeout(ee.current)},[]),n.useEffect(()=>{let f=j.current,T=f?.ownerDocument.defaultView?.ResizeObserver??globalThis.ResizeObserver;if(!f||!T)return;let H=new T(be=>{let qe=be[0]?.contentRect.width??f.clientWidth;z(ht=>ht?qe<=380:qe<340)});return H.observe(f),()=>H.disconnect()},[]),n.useEffect(()=>()=>{de.current.idleTimer&&clearTimeout(de.current.idleTimer)},[]);let Ze=n.useCallback(async(f,T)=>{T.stopPropagation(),T.preventDefault(),F(Ue(f)),Xe(f,P),v(null);let H=++E.current,be={x:T.clientX,y:T.clientY},qe=await an(f,{onEdit:()=>Te(f)});if(H!==E.current)return;let ht=f.kind==="event"?rn(f):f.kind==="sourced"&&qe.length===0?na(f):[],yt=f.readOnly?[{label:l("auto.1cb00f4b1daf"),description:f.title,enabled:!1},...nn(f),...qe.length>0||ht.length>0?[]:na(f)]:[...f.kind==="sourced"&&qe.some(Ca=>Ca.id==="edit")?[]:[{label:l("auto.5301648dcf6b"),icon:n.createElement(en,null),onSelect:()=>Te(f)}],{label:l("auto.f6fdbe48dc54"),icon:n.createElement(Ja,null),danger:!0,onSelect:()=>g.ui.openMenu([{label:l("auto.7c1496f9a7dc",{p0:f.title}),enabled:!1},{label:l("auto.77dfd2135f4d")},{label:l("auto.ae8a5b196587"),danger:!0,onSelect:()=>mt(f)}],be)}],zt=[...qe,...ht],Ft=zt.length>0&&yt.length>0?[...zt,{type:"separator"},...yt]:[...zt,...yt];g.ui.openMenu(Ft,be)},[Te,P]),mt=async f=>{f.kind!=="noteDate"&&(f.kind==="event"?await Co(f.id):f.sourced&&f.sourceId&&await Xa(f.sourceId,f.sourced.id))},Ne=_.getFullYear(),x=_.getMonth(),O=f=>b({view:f}),Q=()=>{let f=new Date;b({selectedDate:J(f),rangeStart:null,rangeEnd:null,cursor:`${f.getFullYear()}-${String(f.getMonth()+1).padStart(2,"0")}-01`})},$=f=>b({view:"week",selectedDate:J(f),rangeStart:null,rangeEnd:null,cursor:`${f.getFullYear()}-${String(f.getMonth()+1).padStart(2,"0")}-01`}),C=f=>{if(ye(f),y==="year")b({cursor:`${Ne+f}-${String(x+1).padStart(2,"0")}-01`});else if(y==="week"){let T=Ut(k,c),H=new Date(T.getFullYear(),T.getMonth(),T.getDate()+f*7);b({selectedDate:J(H),rangeStart:null,rangeEnd:null,cursor:`${H.getFullYear()}-${String(H.getMonth()+1).padStart(2,"0")}-01`})}else{let T=new Date(Ne,x+f,1);b({cursor:`${T.getFullYear()}-${String(T.getMonth()+1).padStart(2,"0")}-01`})}},ne=()=>{de.current.idleTimer&&clearTimeout(de.current.idleTimer),de.current.idleTimer=setTimeout(()=>{Object.assign(de.current,_t()),de.current.idleTimer=null},80)},te=f=>{if(ne(),Math.abs(f.deltaX)<=Math.abs(f.deltaY))return;f.preventDefault();let T=vr(de.current,f.deltaX,f.deltaY);Object.assign(de.current,T.gesture),T.step!==0&&C(T.step)},he=n.useRef(null),fe=n.useRef(!1),Re=n.useRef(0),ft=n.useRef(I);ft.current=I,n.useEffect(()=>{let f=()=>{he.current=null,Re.current=0},T=j.current?.ownerDocument.defaultView;return T?.addEventListener("mouseup",f),()=>T?.removeEventListener("mouseup",f)},[]);let Lt=f=>{if(!he.current||y!=="month")return;let T=j.current?.querySelector(".calendar-grid");if(!T)return;let H=T.getBoundingClientRect(),be=f.clientY<H.top+44,qe=f.clientY>H.bottom-44;if(!be&&!qe){Re.current=0;return}let ht=Date.now();if(ht-Re.current<450)return;Re.current=ht;let yt=qe?1:-1;ye(yt);let zt=ge(ft.current),Ft=new Date(zt.getFullYear(),zt.getMonth()+yt,1),Ca=`${Ft.getFullYear()}-${String(Ft.getMonth()+1).padStart(2,"0")}-01`,xs=yt===1?Ca:J(new Date(Ft.getFullYear(),Ft.getMonth()+1,0));fe.current=!0,b({cursor:Ca,rangeStart:he.current.anchor,rangeEnd:xs})},gt=(f,T)=>{if(fe.current){fe.current=!1;return}F(null),Xe(null,P);let H=J(f);if(T?.shiftKey&&u.selectedDate){b({rangeStart:u.selectedDate,rangeEnd:H});return}b({selectedDate:u.selectedDate===H?null:H,rangeStart:null,rangeEnd:null,cursor:`${f.getFullYear()}-${String(f.getMonth()+1).padStart(2,"0")}-01`})},ot=f=>{he.current={anchor:J(f)},fe.current=!1},it=f=>{let T=he.current;if(!T)return;let H=ge(ft.current);if(f.getFullYear()!==H.getFullYear()||f.getMonth()!==H.getMonth())return;let be=J(f);be!==T.anchor&&(fe.current=!0,b({rangeStart:T.anchor,rangeEnd:be}))},A=()=>{he.current=null,Re.current=0},oe=f=>{if(!u.rangeStart||!u.rangeEnd)return!1;let T=J(f);return Oi(u.rangeStart,u.rangeEnd).includes(T)},Ke=(f,T,H,be)=>{v({date:J(f),startTime:T,endTime:H,kind:be})},xn=(f,T)=>{if(f.preventDefault(),f.stopPropagation(),le)return;let H=J(T);g.ui.openMenu([{label:l("auto.ec42f1f55523"),icon:n.createElement(ut,null),onSelect:()=>Ke(T,void 0,void 0,"todo")},{label:l("auto.7f8a6fad8b7c"),icon:n.createElement(pt,null),onSelect:()=>Ke(T,void 0,void 0,"event")},{type:"separator"},{label:l("auto.22819a02167d"),icon:n.createElement(ga,null),onSelect:Q},{label:l("auto.4869ac12717f"),icon:n.createElement(Nt,null),onSelect:()=>$(ge(H))}],{x:f.clientX,y:f.clientY})},ka=(f,T,H)=>{le||(f.preventDefault(),f.stopPropagation(),g.ui.openMenu([{label:l("auto.ec42f1f55523"),icon:n.createElement(ut,null),onSelect:()=>Ke(ge(T),H,void 0,"todo")},{label:l("auto.7f8a6fad8b7c"),icon:n.createElement(pt,null),onSelect:()=>Ke(ge(T),H,void 0,"event")},{type:"separator"},{label:l("auto.22819a02167d"),icon:n.createElement(ga,null),onSelect:Q},{label:l("auto.4869ac12717f"),icon:n.createElement(Nt,null),onSelect:()=>$(ge(T))}],{x:f.clientX,y:f.clientY}))},st=Ut(k,c),Sa=Array.from({length:7},(f,T)=>{let H=new Date(st);return H.setDate(st.getDate()+T),H}),Qe=y==="year"?`y-${Ne}`:y==="week"?`w-${J(st)}`:`m-${Ne}-${x}`,xr=y==="year"?n.createElement("h2",null,n.createElement("span",null,Ne)):y==="week"?n.createElement("h2",null,"W",St(st)," ",n.createElement("span",null,st.getFullYear())):n.createElement("h2",null,tt(x,g.ui.language())," ",n.createElement("span",null,Ne)),Ea=u.selectedDate?W.filter(f=>f.date.slice(0,10)===u.selectedDate).sort((f,T)=>(f.startTime??"99:99").localeCompare(T.startTime??"99:99")):[],kr=U&&y==="week"?[k]:Sa,bs=f=>b({selectedDate:J(f),rangeStart:null,rangeEnd:null,cursor:`${f.getFullYear()}-${String(f.getMonth()+1).padStart(2,"0")}-01`}),vs=["week","month","year"].map(f=>n.createElement("button",{key:f,role:"tab","aria-selected":y===f,className:`calendar-switcher-btn ${y===f?"active":""}`,onClick:()=>O(f)},f==="month"?l("auto.082bc378cd60"):f==="week"?l("auto.f82be68a7fb4"):l("auto.879e32326c52"))),ws=n.createElement("div",{className:"calendar-actions"},n.createElement("button",{"aria-label":l("auto.50f94286ba30"),onClick:()=>C(-1)},"\u2039"),n.createElement("button",{"aria-label":l("auto.24345a14377f"),onClick:Q},l("auto.7a46866bc719")),n.createElement("button",{"aria-label":l("auto.bc981983e7f5"),onClick:()=>C(1)},"\u203A"));return n.createElement("div",{ref:j,className:`calendar-view ${e==="main"?"calendar-view-main":"calendar-view-sidebar"}${U?" calendar-view-compact":""}`},n.createElement("div",{className:"calendar-topbar"},n.createElement("div",{className:"calendar-topbar-leading"},xr),n.createElement("div",{className:"calendar-topbar-actions"},n.createElement("div",{className:"calendar-switcher calendar-switcher-inline",role:"tablist"},vs),ws)),ze.map(f=>n.createElement("div",{key:f.owner,className:"agenda-day-empty",role:"status"},f.message)),n.createElement("div",{className:"calendar-view-body"},n.createElement("div",{className:"calendar-scroll-area","data-view":y},n.createElement("div",{className:"calendar-stage",onWheel:te,onMouseMove:Lt,onMouseLeave:()=>{Re.current=0}},n.createElement("div",{className:"calendar-grid-wrap",key:Qe,"data-dir":B},y==="month"&&n.createElement(ds,{year:Ne,month:x,today:a,selected:k,weekStart:c,compact:U,itemsByDay:Z,colorFor:re,onPick:gt,onPickWeek:$,selectedItemKey:D,onSelectItem:Fe,onEditItem:Te,onItemAction:Ze,inRange:oe,onRangeStart:ot,onRangeOver:it,onRangeEnd:A,onContextMenu:xn,revealTarget:p}),y==="week"&&n.createElement(ss,{days:kr,items:W.filter(f=>kr.some(T=>J(T)===f.date)),dayStartHour:i,dayEndHour:d,colorFor:re,selectedItemKey:D,onSelectItem:Fe,onEditItem:Te,onCommit:(f,T,H,be)=>{ki(f,T,H,be)},onCreate:(f,T,H)=>v({date:f,startTime:T,endTime:H}),onContextMenu:ka,onItemAction:Ze,compact:U,weekDays:Sa,selectedDay:k,selectedTime:u.selectedTime,itemsByDay:Z,onPickDay:bs,revealTarget:p}),y==="year"&&n.createElement(ls,{year:Ne,today:a,weekStart:c,revealTarget:p,onPickMonth:f=>b({view:"month",cursor:`${Ne}-${String(f+1).padStart(2,"0")}-01`})}))),U&&y==="month"&&u.selectedDate&&n.createElement("div",{className:"calendar-todos"},Ea.length===0?n.createElement("div",{className:"agenda-day-empty"},l("auto.d669db3f6b34")):Ea.map(f=>{let T=f.sourceId??f.kind,H=T===p?.sourceId&&f.id===p.itemId?p.nonce:void 0;return n.createElement(tn,{key:`${T}:${f.id}:${f.occurrenceKey??f.date}:${H??0}`,item:f,sourceId:T,color:re(f),revealNonce:H,onClick:()=>Fe(f),onDoubleClick:()=>Te(f),onContextMenu:be=>{Ze(f,be)}})})))),le&&n.createElement(yn,{key:le.editItem?.id??`new:${le.kind??""}:${le.date}:${le.startTime??""}`,state:le,groups:o,onClose:()=>v(null),onAdded:()=>{}}))}function cs(){return n.createElement(vn,{variant:"right"})}function us({navigation:e}){return n.createElement(vn,{variant:"main",navigation:e})}var wn=e=>n.createElement(g.ui.settings.Button,e),fc=({onDelete:e,label:t})=>{let[a,r]=n.useState(!1),o=n.useRef(null),i=n.useCallback(()=>{o.current!==null&&window.clearTimeout(o.current),o.current=null,r(!1)},[]);return n.useEffect(()=>i,[i]),n.createElement(wn,{className:"notedate-source-toggle",variant:a?"danger":"ghost",size:"small",onClick:()=>{if(a){i(),e();return}r(!0),o.current!==null&&window.clearTimeout(o.current),o.current=window.setTimeout(()=>r(!1),3500)},onBlur:i,title:a?l("auto.d75a293ea22a"):l("auto.c845e23963ef",{p0:t})},n.createElement(Ja,null)," ",a?l("auto.04a212215ef9"):l("auto.f6fdbe48dc54"))},gc=({value:e,onCommit:t})=>{let[a,r]=n.useState(e.length?e:[""]),o=i=>i.map(d=>d.trim()).filter(Boolean);return n.createElement("div",{className:"notedate-source-show"},a.map((i,d)=>n.createElement("div",{className:"notedate-source-show-row",key:d},n.createElement("input",{className:"settings-path-input",value:i,"aria-label":l("auto.ef5ea5a743b3"),placeholder:"phone",onChange:s=>r(a.map((c,u)=>u===d?s.target.value:c)),onBlur:()=>t(o(a))}),n.createElement("button",{type:"button",className:"notedate-source-show-remove","aria-label":l("auto.4fda04775bdc"),onClick:()=>{let s=a.filter((c,u)=>u!==d);r(s.length?s:[""]),t(o(s))}},"\xD7"))),n.createElement(wn,{variant:"ghost",size:"small",className:"notedate-add-field",onClick:()=>r([...a,""])},n.createElement(ut,null)," ",l("calendar.noteDate.addField")))},ps=({variant:e,value:t,label:a,onChange:r})=>{let{ColorField:o}=g.ui.settings;return n.createElement("span",{className:"notedate-color-wrap"},n.createElement(o,{variant:e,unset:!t,value:t??De("primary-blue"),ariaLabel:a,onChange:r}),t&&n.createElement("button",{type:"button",className:"notedate-color-clear","aria-label":l("auto.f4a0d0857b02",{p0:a}),onClick:()=>r(void 0)},n.createElement(nt,null)))},hc=({icon:e,color:t,borderColor:a,onChange:r})=>{let[o,i]=n.useState(!1),d=n.useRef(null);return n.useEffect(()=>{if(!o)return;let s=u=>{d.current&&!d.current.contains(u.target)&&i(!1)},c=d.current?.ownerDocument;return c?.addEventListener("mousedown",s,!0),()=>c?.removeEventListener("mousedown",s,!0)},[o]),n.createElement("div",{className:"notedate-glyph-picker",ref:d},n.createElement("button",{type:"button",className:e?"notedate-source-swatch":"notedate-source-swatch unset",style:{...t?{"--swatch-fill":me(t),"--swatch-on":To(t)}:void 0,...a?{"--swatch-ring":me(a)}:void 0},"aria-label":l("auto.92bcda7f379e"),title:l("auto.7bf74c2d99d6"),onClick:()=>i(s=>!s)},e?n.createElement(Le,{id:e}):n.createElement("span",{className:"notedate-swatch-none"},"\u2014")),o&&n.createElement("div",{className:"notedate-glyph-grid"},n.createElement("button",{type:"button",className:e?"notedate-glyph-opt":"notedate-glyph-opt active","aria-label":l("auto.95553ba8a405"),title:l("auto.95553ba8a405"),onClick:()=>{r(void 0),i(!1)}},"\u2014"),fi().map(s=>n.createElement("button",{key:s.id,type:"button",className:s.id===e?"notedate-glyph-opt active":"notedate-glyph-opt","aria-label":s.label,title:s.label,onClick:()=>{r(s.id),i(!1)}},n.createElement(Le,{id:s.id})))))},yc=({source:e,entries:t})=>{let a=n.useMemo(()=>cn(t,e),[t,e.matchKey,e.matchValue,e.folder,e.dateField,e.dateFormat,e.match]);return cr(e)?a.matched===0?n.createElement("div",{className:"notedate-source-stats warn"},l("auto.257ff123e390",{p0:e.matchKey,p1:e.matchValue})):a.dated===0?n.createElement("div",{className:"notedate-source-stats warn"},l("auto.e6ffec68b5ae",{p0:a.matched,p1:e.dateField})):n.createElement("div",{className:"notedate-source-stats"},l("auto.d4ea5b59b68b",{p0:a.matched,p1:a.dated})):null},bc=({source:e,entries:t,onChange:a,onDelete:r})=>{let{VaultFolderField:o,SelectField:i,Toggle:d}=g.ui.settings,[s,c]=n.useState(!!e.folder),u=!e.dateFormat||On(e.dateFormat)!==null,h=(p,m,y=!1)=>n.createElement("div",{className:y?"notedate-source-field wide":"notedate-source-field"},n.createElement("label",null,p),m);return n.createElement("div",{className:"notedate-source-row"},n.createElement("div",{className:"notedate-source-head"},n.createElement(hc,{icon:e.icon,color:e.color,borderColor:e.borderColor,onChange:p=>a({icon:p})}),n.createElement("input",{className:"settings-path-input notedate-source-title",defaultValue:e.title,placeholder:l("auto.35b023ecbb81"),"aria-label":l("auto.475b6ce898d4"),title:l("auto.4da8c4eff514"),onBlur:p=>a({title:p.target.value.trim()})}),n.createElement("div",{className:"notedate-source-color"},n.createElement(ps,{variant:"fill",value:e.color,label:l("auto.9fa90b203761"),onChange:p=>a({color:p})}),n.createElement(ps,{variant:"ring",value:e.borderColor,label:l("auto.981f473aa731"),onChange:p=>a({borderColor:p})})),n.createElement("div",{className:"notedate-source-actions"},n.createElement(wn,{className:"notedate-source-toggle",variant:"ghost",size:"small",onClick:()=>a({hidden:!e.hidden}),title:e.hidden?l("auto.408a0d16a8ba"):l("auto.736a07e01797")},e.hidden?n.createElement(ai,null):n.createElement(ni,null)," ",e.hidden?l("auto.d97d1ee339e4"):l("auto.34d8b60fe253")),n.createElement(fc,{label:e.title||"source",onDelete:r}))),n.createElement(yc,{source:e,entries:t}),n.createElement("div",{className:"notedate-source-grid"},h(l("auto.b82220d034e7"),n.createElement("input",{className:"settings-path-input",defaultValue:e.matchKey,placeholder:"type","aria-label":l("auto.b82220d034e7"),onBlur:p=>a({matchKey:p.target.value.trim()})})),h(l("auto.2bc9464d49e9"),n.createElement("input",{className:"settings-path-input",defaultValue:e.matchValue,placeholder:"contact","aria-label":l("auto.a3fa4c4a4715"),onBlur:p=>a({matchValue:p.target.value.trim()})})),h(l("auto.691b674766e5"),n.createElement("input",{className:"settings-path-input",defaultValue:e.dateField,placeholder:"birthdate","aria-label":l("auto.691b674766e5"),title:l("auto.7bf039eeb194"),onBlur:p=>a({dateField:p.target.value.trim()||"date"})})),h(l("auto.94ee88690828"),n.createElement("input",{className:u?"settings-path-input":"settings-path-input invalid",defaultValue:e.dateFormat??"",placeholder:"dd-mm-yyyy","aria-label":l("auto.94ee88690828"),title:l("auto.8bbc96d44546"),onBlur:p=>a({dateFormat:p.target.value.trim()||void 0})})),h(l("auto.e10282ef1972"),n.createElement("div",{className:"notedate-source-inline"},n.createElement(i,{value:e.match,onChange:p=>a({match:p==="day-month"||p==="day"?p:"exact"}),options:[{value:"exact",label:l("auto.fd303c72a405")},{value:"day-month",label:l("auto.dd4b99ddaf61")},{value:"day",label:l("auto.b6f727f0c520")}],ariaLabel:l("auto.e10282ef1972")}),e.match==="day-month"&&n.createElement("label",{className:"notedate-source-inline-toggle",title:l("auto.5210c5c047ea")},n.createElement(d,{checked:e.showCount,onChange:p=>a({showCount:p}),label:l("auto.9ddab8990070")}),n.createElement("span",null,l("auto.9ddab8990070"))))),e.match!=="exact"&&h(l("auto.24bdcf2d51f8"),n.createElement("input",{type:"number",min:0,max:sn,className:"settings-path-input notedate-source-limit",defaultValue:e.recurrenceLimitYears??"",placeholder:l("auto.48a7b8889e15"),"aria-label":l("auto.1389fda4dae3"),title:l("auto.6d07b3164ac0"),onBlur:p=>{let m=p.target.value.trim();if(!m){p.currentTarget.value="",a({recurrenceLimitYears:void 0});return}let y=Math.max(0,Math.min(sn,Math.floor(Number(m))));p.currentTarget.value=String(y),a({recurrenceLimitYears:y})}})),h(l("auto.611f3791dc68"),n.createElement("input",{className:"settings-path-input",defaultValue:e.startTimeField??"",placeholder:l("auto.48a7b8889e15"),"aria-label":l("auto.611f3791dc68"),title:l("auto.519b42369442"),onBlur:p=>a({startTimeField:p.target.value.trim()||void 0})})),h(l("auto.aee875c4edbf"),n.createElement("input",{className:"settings-path-input",defaultValue:e.endTimeField??"",placeholder:l("auto.48a7b8889e15"),"aria-label":l("auto.aee875c4edbf"),onBlur:p=>a({endTimeField:p.target.value.trim()||void 0})})),h(l("auto.768e0c1c6957"),n.createElement("div",{className:"notedate-source-inline"},n.createElement(i,{value:e.labelMode,onChange:p=>a({labelMode:p==="property"?"property":"filename"}),options:[{value:"filename",label:l("auto.a3cbb98ddf5e")},{value:"property",label:l("auto.9ae33a7d0ecb")}],ariaLabel:l("auto.768e0c1c6957")}),e.labelMode==="property"&&n.createElement("input",{className:"settings-path-input",defaultValue:e.labelField??"",placeholder:"firstName","aria-label":l("auto.55f1c767a3b1"),onBlur:p=>a({labelField:p.target.value.trim()||void 0})})),!0),h(l("auto.d97d1ee339e4"),n.createElement(gc,{value:e.showFields,onCommit:p=>a({showFields:p})}),!0)),n.createElement("button",{type:"button",className:"notedate-source-advanced-toggle","aria-expanded":s,onClick:()=>c(p=>!p)},n.createElement("span",{className:"notedate-caret","data-open":s},"\u25B8")," ",l("auto.4d064726954a")),s&&n.createElement("div",{className:"notedate-source-grid"},h(l("auto.0623bfa38c8f"),n.createElement(o,{value:e.folder??"",onChange:p=>a({folder:p.trim()||void 0}),onCommit:p=>a({folder:p.trim()||void 0}),placeholder:l("auto.ad980036b394"),ariaLabel:l("auto.0623bfa38c8f")}),!0)))},ms=()=>{let{Row:e}=g.ui.settings,t=ia(),[a,r]=n.useState(null);if(n.useEffect(()=>{let s=!0;return wa().then(c=>{s&&r(c)}),()=>{s=!1}},[]),!a)return n.createElement("div",{className:"notedate-settings"});let o=s=>{r(s),un(s)},i=(s,c)=>o(a.map(u=>u.id===s?{...u,...c}:u)),d=s=>{g.ui.openMenu([...lr.map(c=>({id:c.id,label:l(c.labelKey)||c.label,icon:n.createElement(Le,{id:c.patch.icon}),onSelect:()=>o([...a,Li(c.id,a)])})),{type:"separator"},{id:"blank",label:l("calendar.noteDatePreset.blank"),onSelect:()=>o([...a,ln()])}],{anchor:s,align:"start"})};return n.createElement("div",{className:"notedate-settings"},n.createElement(e,{title:l("auto.958788fc103f"),description:"Each source puts a read-only calendar entry on every note whose frontmatter matches (e.g. type: contact), reading the date from the property you name \u2014 birthdays, deadlines, anniversaries. Match decides how much of the date has to line up: the exact date lands once, day + month comes round every year, day alone every month. Set a date format when the property is not written as 1990-05-04. Icon and colours are optional; an unset colour uses the normal calendar fallback."}),a.length===0&&n.createElement(e,{title:l("auto.1780c4a5f967"),description:l("auto.65c01f7ba330")}),a.map(s=>n.createElement(bc,{key:s.id,source:s,entries:t,onChange:c=>i(s.id,c),onDelete:()=>o(a.filter(c=>c.id!==s.id))})),n.createElement(wn,{variant:"secondary",className:"notedate-add-source","aria-haspopup":"menu",onClick:s=>d(s.currentTarget)},n.createElement(ut,null)," ",l("calendar.noteDate.addSource")))};function vc(){let e=_e(),[t,a]=n.useState({accounts:[],providers:[]}),[r,o]=n.useState(null),[i,d]=n.useState(!0),[s,c]=n.useState(null),[u,h]=n.useState(!1),p=Tt(),m=n.useSyncExternalStore(p.subscribe,p.getStatus),{Button:y,Row:S,Toggle:I,SelectField:M}=g.ui.settings,L=n.useCallback(async()=>{d(!0),c(null);try{let E=await Be(g).listCalendarConnections();if(!E.ok||!E.data)throw new Error(E.error||l("calendar.sync.accountsError"));a(E.data)}catch(E){c(E instanceof Error?E.message:l("calendar.sync.accountsError"))}finally{d(!1)}},[]);n.useEffect(()=>{L()},[L]);let R=async(E,W)=>{h(!0),c(null);try{let Z=await g.settings.set(E,W);if(!Z.ok)throw new Error(Z.error||l("calendar.sync.saveError"))}catch(Z){c(Z instanceof Error?Z.message:l("calendar.sync.saveError"))}finally{h(!1)}},N=(E,W,Z)=>{let re=ve().remoteCalendars;R("remoteCalendars",{...re,[E]:{...re[E],[W]:{...re[E]?.[W],...Z}}})},b=(E,W)=>{let Z=new Set(ve().disabledCalendarAccounts);W?Z.delete(E):Z.add(E),R("disabledCalendarAccounts",[...Z])},w=t.accounts.find(E=>E.id===r),P=t.providers.find(E=>E.id===(w?.oauthSetupId||w?.provider||r)),_=w?.displayName||w?.address||P?.label||P?.name||"",k=w?.capabilities.includes("calendar")&&(!w.secretState||w.secretState==="ok"),q=!!w&&!e.disabledCalendarAccounts.includes(w.id),z=w?m.accounts[w.id]:void 0,[U,B]=n.useState({}),[ye,de]=n.useState(!1);n.useEffect(()=>{if(!w||!k)return;let E=!1;return de(!0),Be(g).listCalendars(w.id).then(W=>{E||(W.ok&&W.data?B(Z=>({...Z,[w.id]:W.data.calendars})):c(W.error||l("calendar.sync.calendarsError")))}).catch(W=>{E||c(W instanceof Error?W.message:l("calendar.sync.calendarsError"))}).finally(()=>{E||de(!1)}),()=>{E=!0}},[w,k]);let le=w?m.calendars[w.id]??U[w.id]:void 0,v=()=>g.workspace.openSettings("accounts"),D=E=>E.secretState&&E.secretState!=="ok"?l("calendar.sync.reconnect"):E.capabilities.includes("calendar")?l(e.disabledCalendarAccounts.includes(E.id)?"calendar.overview.disabled":"calendar.sync.connected"):l("calendar.sync.permission"),F=(E,W,Z,re)=>n.createElement("button",{key:E,type:"button",className:"settings-list-row calendar-account-row",onClick:()=>{o(E),c(null)}},n.createElement("span",{className:"settings-list-glyph"},n.createElement(pt,null)),n.createElement("span",{className:"settings-list-meta"},n.createElement("span",{className:"settings-list-name"},W),Z&&n.createElement("span",{className:"settings-list-sub"},Z),n.createElement("span",{className:"settings-list-sub"},re)),n.createElement(Nt,null)),j=t.providers.filter(E=>!t.accounts.some(W=>(W.oauthSetupId||W.provider)===E.id));return n.createElement("div",{className:"calendar-sync-settings settings-listpage"},r&&(w||P)?n.createElement(n.Fragment,null,n.createElement("div",{className:"settings-listpage-crumbs"},n.createElement(y,{onClick:()=>{o(null),c(null)}},l("calendar.sync.back")),n.createElement("span",{className:"settings-crumb-current"},_)),n.createElement("div",{className:"calendar-account-identity"},n.createElement("span",{className:"settings-list-glyph"},n.createElement(pt,null)),n.createElement("span",{className:"settings-list-meta"},n.createElement("span",{className:"settings-list-name"},_),(w?.address||P?.email)&&n.createElement("span",{className:"settings-list-sub"},w?.address||P?.email)),n.createElement(y,{onClick:v},l("calendar.sync.manage"))),k?w&&n.createElement(n.Fragment,null,n.createElement(S,{title:l("calendar.sync.account"),description:l("calendar.sync.readOnly")},n.createElement(I,{checked:q,disabled:u,onChange:E=>b(w.id,E),label:l("calendar.sync.account")})),ye&&!le&&n.createElement("p",{role:"status"},l("calendar.sync.loadingCalendars")),le?.length===0&&n.createElement("p",{className:"settings-empty-text"},l("calendar.sync.noCalendars")),le?.map(E=>{let W=e.remoteCalendars[w.id]?.[E.id],Z=W?.enabled??E.primary;return n.createElement("div",{key:E.id,className:"calendar-sync-calendar"},n.createElement(S,{title:E.name,description:E.primary?l("calendar.sync.primary"):void 0},n.createElement(I,{checked:Z,disabled:u||!q,onChange:re=>N(w.id,E.id,{enabled:re}),label:l("calendar.sync.select",{name:E.name})})),Z&&n.createElement(S,{title:l("calendar.field.groupId")},n.createElement(M,{value:W?.groupId??"",disabled:u||!q,onChange:re=>N(w.id,E.id,{groupId:re}),options:[{value:"",label:l("calendar.sync.noGroup")},...e.groups.map(re=>({value:re.id,label:re.name,color:re.color}))],ariaLabel:l("calendar.sync.group",{name:E.name})})))}),z?.lastSyncAt&&n.createElement("p",{className:"settings-empty-text",role:"status"},l("calendar.sync.last",{time:new Date(z.lastSyncAt).toLocaleString(g.ui.language()),count:z.eventCount})),n.createElement(y,{disabled:m.syncing||u||!q,onClick:()=>{p.sync()}},l(m.syncing?"auto.221ca63005ea":"auto.2b7d938e6787"))):n.createElement("p",{className:"settings-empty-text"},w?D(w):l(P?.configured?"calendar.sync.saved":"calendar.sync.setup"))):n.createElement(n.Fragment,null,n.createElement("div",{className:"settings-listpage-header"},n.createElement("h4",{className:"settings-label"},l("calendar.overview.accounts")),n.createElement(y,{onClick:v},l("calendar.sync.manage"))),n.createElement("p",{className:"settings-empty-text"},l("calendar.sync.description")),i?n.createElement("p",{role:"status"},l("calendar.sync.loadingAccounts")):n.createElement("div",{className:"settings-list"},t.accounts.map(E=>F(E.id,E.displayName||E.address,E.displayName?E.address:void 0,D(E))),j.map(E=>F(E.id,E.label||E.name,E.email,l(E.configured?"calendar.sync.savedShort":"calendar.sync.setupShort"))),!t.accounts.length&&!j.length&&n.createElement("p",{className:"settings-empty-text"},l("auto.7eacb0e385b4"))),n.createElement("div",{className:"settings-row-actions"},n.createElement(y,{disabled:i||m.syncing,onClick:()=>{L(),p.sync()}},l("calendar.sync.refresh")))),(s||z?.error||m.error)&&n.createElement("p",{className:"settings-path-error",role:"alert"},s||z?.error||m.error))}function wc({dayStartHour:e,dayEndHour:t}){let{NumberField:a,Row:r}=g.ui.settings;return n.createElement(n.Fragment,null,n.createElement(r,{title:l("auto.46fbb53a9be2"),description:l("auto.f07b365f8502")},n.createElement(a,{min:0,max:23,value:e,onChange:()=>{},onCommit:o=>{o!=null&&g.settings.set("dayStartHour",o)},ariaLabel:l("auto.46fbb53a9be2")})),n.createElement(r,{title:l("calendar.dayEndHour"),description:l("calendar.dayEndHourDesc")},n.createElement(a,{min:1,max:24,value:t,onChange:()=>{},onCommit:o=>{o!=null&&g.settings.set("dayEndHour",o)},ariaLabel:l("calendar.dayEndHour")})),n.createElement("span",{className:"settings-empty-text"},l("auto.808d7dca8a74")," ",Hn,":00\u2013",qn,":00."," ",l("calendar.dayWindowGrows")))}function xc(){let{Button:e,Row:t,Section:a}=g.ui.settings;return n.createElement(a,{title:l("calendar.settings.groups")},n.createElement(t,{title:l("calendar.settings.groups"),description:l("calendar.settings.groupsDesc")},n.createElement(e,{onClick:()=>g.workspace.openSettings("groups")},l("calendar.settings.groups"))))}function kc(){let{dayStartHour:e,dayEndHour:t,itemClickTarget:a}=_e(),{Row:r,Section:o,SelectField:i}=g.ui.settings;return n.createElement(n.Fragment,null,n.createElement(o,null,n.createElement(r,{title:l("calendar.settings.openItemsIn"),description:l("calendar.settings.openItemsInDesc")},n.createElement(i,{value:a,onChange:d=>{g.settings.set(zo,d)},options:[{value:"owner",label:l("calendar.settings.openItemsOwner")},{value:"agenda",label:l("calendar.settings.openItemsAgenda")}],ariaLabel:l("calendar.settings.openItemsIn")})),n.createElement(wc,{dayStartHour:e,dayEndHour:t})),n.createElement(xc,null))}function Sc(){let{Section:e}=g.ui.settings;return n.createElement(e,null,n.createElement(vc,null))}function Ec(){let e=Xt(),{hiddenSources:t}=_e(),{PluginCard:a,Section:r}=g.ui.settings,o=new Set(t),i=(d,s)=>{let c=new Set(o);s?c.delete(d):c.add(d),g.settings.set(Yt,[...c])};return n.createElement(r,{className:"calendar-plugins-settings"},e.length===0?n.createElement("span",{className:"settings-empty-text"},l("calendar.plugins.empty")):n.createElement("div",{className:"settings-plugin-list"},e.map(d=>{let s=d.integration,c=s?.localized?.[g.ui.language()],u=c?.name??s?.name??d.owner,h=!o.has(d.sourceKey);return n.createElement(a,{key:d.sourceId,name:u,version:s?.version??d.version,versionLabel:l("calendar.plugins.version"),author:s?.author,authorLabel:l("calendar.plugins.by"),description:c?.description??s?.description,enabled:h,onChange:p=>i(d.sourceKey,p),toggleLabel:l(h?"calendar.plugins.disable":"calendar.plugins.enable",{p0:u}),onConfigure:d.methods.includes("configure")?()=>{jo(d.sourceId)}:void 0,configureLabel:l("calendar.plugins.configure",{p0:u})})})))}function fs({section:e}){return e==="dates"?n.createElement(ms,null):e==="sync"?n.createElement(Sc,null):e==="plugins"?n.createElement(Ec,null):n.createElement(kc,null)}var gs=(e,t=[])=>({type:"object",properties:e,required:t,additionalProperties:!1}),wr=e=>({type:"string",description:e});async function hs(e,t,a,r){let o=await e.commands.executeOwn(t,a,{...r,autonomous:!0});if(!o.ok)throw new Error(o.error.message);return o.value}function ys(e){return Sn([{name:"list_events",description:"List Calendar events, optionally filtered by a day or month.",parameters:gs({on:wr("Optional YYYY-MM-DD day or YYYY-MM month")}),sideEffect:"read",commandId:"list",run:async(t,a)=>{let r=String(t.on??"").trim(),o=/^\d{4}-\d{2}-\d{2}$/.test(r)?{from:r,to:r}:/^\d{4}-\d{2}$/.test(r)?{from:`${r}-01`,to:`${r}-31`}:{from:"",to:""},i=await hs(e,"list",o,a);return i.length?i.slice(0,40).map(d=>`- ${d.date??""}: ${d.title??""}`).join(`
`):"No events."}},{name:"add_event",description:"Add an event to the Calendar plugin.",parameters:gs({title:wr("Event title"),date:wr("Date YYYY-MM-DD")},["title","date"]),sideEffect:"write",commandId:"add",run:async(t,a)=>{let r={title:String(t.title??""),date:String(t.date??"")},o=await hs(e,"add",r,a);return`Added event "${o.title||r.title}" on ${o.date||r.date}.`}}])}function Cc(e){so(e);let t=Kr(e),a=Qr(),r=e.workspace.onOpenOwnLink(m=>{let y=va(m);y&&e.workspace.patchTimeControl(y)});e.registerView("calendar.agenda",rs),e.registerView("calendar.panel",cs),e.registerView("calendar.page",us),e.registerView("calendar.settings",fs);let o=_o(),i=Di(e),d=Ji(e),s=e.interop.services.provide(Dn,ys(e)),c=Mi(),u=kt(),h={id:"calendar",labelKey:"manifest.name",openDate:m=>Ma(m)},p=e.interop.services.provide(En,h);return e.interop.state.publish(wt,null),u.publish(null),async()=>{try{i(),d(),s(),c(),p(),o(),r(),a(),e.interop.state.publish(wt,null),u.publish(null)}finally{await t()}}}var Ic={register:Cc},sy=Ic;export{sy as default,Cc as register};
