var na="valley";var $s=`.${na}`,Fs=`app.${na}`;function Vi(e){return e.trim().replace(/\\/g,"/").replace(/\/{2,}/g,"/").replace(/^\.?\/+/,"").replace(/\/+$/,"")}var Hi=/^[a-zA-Z]:/;function mn(e){if(typeof e!="string")return"";let t=Vi(e);return!t||t==="."||Hi.test(t)||t.split("/").some(n=>n==="..")?"":t}function ha(e){if(typeof e=="string")return mn(e)||void 0}var Le=`.${na}`,Ui="plugins",ya=`${Le}/${Ui}`,qi="external",Gs=`${ya}/${qi}`,js=`${ya}/data`;var Vs=`${ya}/plugin.json`,Hs=`${ya}/config.json`,Us=`${Le}/state`,Lt=`${Le}/settings`,Ot=`${Le}/app`,ba=`${Le}/accounts`,qs=`${ba}/providers`,Bs=`${ba}/providers.lock.json`,Ws=`${Le}/trash`,fn=`${Le}/cache`,Ys=`${fn}/accounts`,Bi=`${fn}/search`,Xs=`${fn}/providers`;var Zs=`${Ot}/logs`,Qs=`${Ot}/whats-new`,Js=`${Ot}/setup.json`,ec=`${Bi}/index.jsonl`,tc=`${Ot}/recovery/drafts`,ac=`${Ot}/recovery/transactions`;var ga="design";var nc={app:`${Ot}/app.json`,appearance:`${Le}/${ga}/appearance.json`,pallette:`${Le}/${ga}/pallette.json`,group:`${Le}/${ga}/group.json`,metadata:`${Lt}/metadata.json`,notification:`${Lt}/notification.json`,preferences:`${Lt}/preferences.json`,markdown:`${Lt}/markdown.json`,files:`${Lt}/files.json`,search:`${Lt}/search.json`,design:`${Le}/${ga}/appearance.json`,accounts:`${ba}/accounts.json`},rc=`${ba}/secrets.json`;var nr=na,rr="open";var or=["http:","https:","mailto:","obsidian:"];var dc=[Le,`${Le}/**/secrets.json`,".git","node_modules","**/.env","**/.env.*"];var Yi=new Map;function pe(e,t,n,r,o,i,s,l,c="owner"){let u=Object.freeze({id:e,kind:t,version:n,cardinality:r,validate:o,identities:i,identityScope:c,serviceCalls:s,serviceMetadata:l});return Yi.set(`${t}:${e}@${n}`,u),u}var va="edit";function lr(e){let t=new Map(e.map(n=>[n.name,n]));return{tools:e.map(({run:n,...r})=>Object.freeze({...r})),execute:async(n,r,o)=>{let i=t.get(n);if(!i)throw new Error(`Unknown provider-owned agent tool: ${n}`);return i.run(r,o)}}}var F=e=>!!e&&typeof e=="object"&&!Array.isArray(e),le=(e,t)=>typeof e[t]=="function",ht=e=>e===void 0,_t=e=>typeof e=="boolean",$=e=>typeof e=="string",Ae=e=>e===void 0||$(e),Xi=e=>e===void 0||typeof e=="number",Zi=e=>e===void 0||typeof e=="boolean",ee=(e,t)=>e.length===t.length&&t.every((n,r)=>n(e[r])),xe=e=>F(e)&&typeof e.ok=="boolean"&&(e.error===void 0||typeof e.error=="string"),ir=e=>F(e),Qi=e=>F(e)&&$(e.id)&&$(e.title)&&$(e.date)&&(e.documentRef===void 0||F(e.documentRef)&&$(e.documentRef.pluginId)&&$(e.documentRef.sourceId)&&$(e.documentRef.itemId)),Ji=e=>F(e)&&$(e.date)&&Ae(e.startTime)&&Ae(e.endTime)&&Ae(e.sourceId)&&Ae(e.itemId),ed=e=>F(e)&&$(e.url)&&Ae(e.title)&&Zi(e.newTab),td=e=>F(e)&&$(e.query),sr=e=>F(e)&&$(e.name)&&Ae(e.context)&&Number.isFinite(e.lng)&&Number.isFinite(e.lat),ad=e=>Array.isArray(e)&&e.every(sr),nd=e=>e===null||sr(e),rd=e=>e===void 0||F(e)&&Ae(e.approvalToken)&&(e.cancellation===void 0||F(e.cancellation)),od=e=>typeof e=="string"||F(e)&&typeof e.text=="string",id=e=>F(e)&&typeof e.name=="string"&&e.name.trim().length>0&&typeof e.description=="string"&&F(e.parameters)&&(e.sideEffect==="read"||e.sideEffect==="write")&&Ae(e.commandId)&&(e.commandDispatch===void 0||e.commandDispatch==="dynamic")&&(e.timeoutMs===void 0||Number.isSafeInteger(e.timeoutMs)&&Number(e.timeoutMs)>0&&Number(e.timeoutMs)<=3e5),cr=e=>F(e)&&$(e.id)&&$(e.label)&&Ae(e.labelKey)&&Ae(e.description)&&(e.danger===void 0||typeof e.danger=="boolean")&&(e.enabled===void 0||typeof e.enabled=="boolean")&&(e.submenu===void 0||Array.isArray(e.submenu)&&e.submenu.every(cr)),dd={list:{args:e=>e.length===0,result:e=>Array.isArray(e)&&e.every(Qi)},create:{args:e=>ee(e,[$,ir]),result:_t},update:{args:e=>ee(e,[$,ir]),result:_t},remove:{args:e=>ee(e,[$]),result:_t},open:{args:e=>ee(e,[$]),result:ht},configure:{args:e=>e.length===0,result:ht},actions:{args:e=>ee(e,[$]),result:e=>Array.isArray(e)&&e.every(cr)},runAction:{args:e=>ee(e,[$,$]),result:_t}},ld=e=>F(e)&&$(e.name)&&$(e.version)&&Ae(e.description)&&Ae(e.author)&&(e.localized===void 0||F(e.localized)&&Object.values(e.localized).every(t=>F(t)&&$(t.name)&&Ae(t.description))),zt=pe("calendar.itemSource","service","1.3.0","many",e=>F(e)&&le(e,"list")&&(e.integration===void 0||ld(e.integration)),void 0,dd,e=>e.integration),ur=pe("calendar.itemSourceRevision","state","1.0.0","many",e=>typeof e=="number"&&Number.isSafeInteger(e)&&e>=0),pr=pe("calendar.navigator","service","1.0.0","one",e=>F(e)&&le(e,"openDate"),void 0,{openDate:{args:e=>ee(e,[Ji]),result:ht}}),$t=pe("calendar.panelSelection","state","1.0.0","one",e=>F(e)&&(e.selectedDate===null||typeof e.selectedDate=="string")&&(e.rangeStart===null||typeof e.rangeStart=="string")&&(e.rangeEnd===null||typeof e.rangeEnd=="string")),kc=pe("web.activeContext","state","1.0.0","one",e=>F(e)&&typeof e.instanceId=="string"&&typeof e.url=="string"&&typeof e.title=="string");function dr(e){return F(e)&&typeof e.id=="string"&&typeof e.displayName=="string"&&(e.avatarUrl===void 0||typeof e.avatarUrl=="string")&&Array.isArray(e.emails)&&e.emails.every(t=>F(t)&&typeof t.address=="string"&&(t.label===void 0||typeof t.label=="string"))}var Cc=pe("contacts.directory","service","1.0.0","one",e=>F(e)&&["search","resolveEmails","open"].every(t=>le(e,t)),void 0,{search:{args:e=>e.length===2&&typeof e[0]=="string"&&e[0].length<=1e3&&Number.isInteger(e[1])&&Number(e[1])>0&&Number(e[1])<=50,result:e=>Array.isArray(e)&&e.length<=50&&e.every(dr)},resolveEmails:{args:e=>e.length===1&&Array.isArray(e[0])&&e[0].length<=200&&e[0].every(t=>typeof t=="string"&&t.length<=1e3),result:e=>Array.isArray(e)&&e.every(t=>F(t)&&typeof t.address=="string"&&Array.isArray(t.contacts)&&t.contacts.every(dr))},open:{args:e=>e.length>=1&&e.length<=2&&typeof e[0]=="string"&&(e[1]===void 0||F(e[1])&&(e[1].newTab===void 0||typeof e[1].newTab=="boolean")),result:ht}}),Sc=pe("contacts.directoryRevision","state","1.0.0","one",e=>Number.isSafeInteger(e)&&Number(e)>=0),mr=pe("web.navigator","service","1.0.0","one",e=>F(e)&&le(e,"open"),void 0,{open:{args:e=>ee(e,[ed]),result:ht}}),Ec=pe("selection.textAction","extension","1.0.0","many",e=>F(e)&&typeof e.id=="string"&&typeof e.labelKey=="string"&&typeof e.label=="string"&&Array.isArray(e.surfaces)&&le(e,"run"),e=>[e.id]),fr=pe("geo.navigator","service","1.0.0","one",e=>F(e)&&le(e,"open"),void 0,{open:{args:e=>ee(e,[td]),result:ht}}),Ic=pe("geo.search","service","1.0.0","one",e=>F(e)&&le(e,"search")&&le(e,"reverse"),void 0,{search:{args:e=>ee(e,[$]),result:ad},reverse:{args:e=>ee(e,[t=>Number.isFinite(t),t=>Number.isFinite(t)]),result:nd}}),gr=pe("agent.toolProvider","service","1.0.0","many",e=>F(e)&&Array.isArray(e.tools)&&e.tools.every(id)&&le(e,"execute"),e=>e.tools.map(t=>t.name),{execute:{args:e=>ee(e,[$,F,rd]),result:od}},e=>({tools:e.tools}),"global"),Dc=pe("guard.runtime","service","1.0.0","one",e=>F(e)&&["resolve","requestApproval","consumeToken","audit"].every(t=>le(e,t)),void 0,{resolve:{args:e=>ee(e,[F]),result:F},requestApproval:{args:e=>ee(e,[F]),result:_t},consumeToken:{args:e=>e.length>=1&&e.length<=2&&$(e[0])&&Ae(e[1]),result:_t},audit:{args:e=>ee(e,[F]),result:ht}}),Ac=pe("browser.automation","service","1.0.0","one",e=>F(e)&&["list","open","switch","close","snapshot","readText","readHtml","screenshot","navigate","back","forward","reload","click","type","select","scroll","pressKey"].every(t=>le(e,t)),void 0,{list:{args:e=>e.length===0,result:xe},open:{args:e=>ee(e,[$]),result:xe},switch:{args:e=>ee(e,[$]),result:xe},close:{args:e=>ee(e,[$]),result:xe},snapshot:{args:e=>ee(e,[$]),result:xe},readText:{args:e=>e.length>=1&&e.length<=2&&$(e[0])&&Xi(e[1]),result:xe},readHtml:{args:e=>ee(e,[$]),result:xe},screenshot:{args:e=>ee(e,[$]),result:xe},click:{args:e=>ee(e,[$,t=>typeof t=="number"]),result:xe},type:{args:e=>e.length>=3&&e.length<=4&&$(e[0])&&typeof e[1]=="number"&&$(e[2])&&(e[3]===void 0||typeof e[3]=="boolean"),result:xe},select:{args:e=>ee(e,[$,t=>typeof t=="number",$]),result:xe},scroll:{args:e=>ee(e,[$,t=>typeof t=="number",t=>typeof t=="number"]),result:xe},pressKey:{args:e=>ee(e,[$,$]),result:xe},navigate:{args:e=>ee(e,[$,$]),result:xe},back:{args:e=>ee(e,[$]),result:xe},forward:{args:e=>ee(e,[$]),result:xe},reload:{args:e=>ee(e,[$]),result:xe}}),Tc=pe("fileTree.contextItem","extension","1.0.0","many",e=>F(e)&&typeof e.id=="string"&&typeof e.label=="string"&&Ae(e.labelKey)&&le(e,"run"),e=>[e.id]),Nc=pe("newTab.entry","extension","1.0.0","many",e=>F(e)&&typeof e.id=="string"&&typeof e.labelKey=="string"&&le(e,"run"),e=>[e.id]),Pc=pe("search.resultCard","extension","1.0.0","many",e=>F(e)&&typeof e.cardKind=="string"&&le(e,"render")&&le(e,"open"),e=>[e.cardKind]),ra=pe("metadataPanel.segment","extension","1.0.0","many",e=>F(e)&&typeof e.id=="string"&&typeof e.labelKey=="string"&&le(e,"render"),e=>[e.id]),hr=pe("workspace.surface","extension","1.0.0","many",e=>F(e)&&typeof e.id=="string"&&["left_sidebar","right_sidebar","main_workspace","footer"].includes(String(e.surface))&&le(e,"getSnapshot")&&le(e,"subscribe")&&le(e,"restore"),e=>[e.id]),Mc=pe("metadata.plugin","extension","1.0.0","many",e=>F(e)&&typeof e.id=="string"&&typeof e.labelKey=="string"&&le(e,"facts"),e=>[e.id]),Lc=pe("workspace.viewState","extension","1.0.0","many",e=>F(e)&&typeof e.id=="string"&&["left_sidebar","right_sidebar","main_workspace"].includes(String(e.surface))&&le(e,"capture")&&le(e,"restore")&&le(e,"subscribe"),e=>[e.id]);function yr(e,t){return new Date(e,t,0).getDate()}function Ft(e,t,n){if(t<1||t>12||n<1||n>31)return!1;let r=new Date(e,t-1,n);return r.getFullYear()===e&&r.getMonth()===t-1&&r.getDate()===n}var sd=/^(dd|mm|yyyy)([^a-z])(dd|mm|yyyy)(?:([^a-z])(dd|mm|yyyy))?$/;function gn(e){let t=sd.exec(e.trim().toLowerCase());if(!t)return null;let n=[t[1],t[3],t[5]].filter(Boolean),r=[t[2],t[4]].filter(o=>o!==void 0);return new Set(n).size!==n.length||!n.includes("dd")||!n.includes("mm")?null:{tokens:n,separators:r}}var cd={dd:"(\\d{1,2})",mm:"(\\d{1,2})",yyyy:"(\\d{4})"};function ud(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function br(e,t){let n=gn(t);if(!n)return null;let{tokens:r,separators:o}=n,i=r.map((h,g)=>cd[h]+(g<o.length?ud(o[g]):"")).join(""),s=new RegExp(`^${i}$`).exec(e.trim());if(!s)return null;let l={};r.forEach((h,g)=>{l[h]=Number(s[g+1])});let c=l.dd,u=l.mm,f=l.yyyy;return Ft(f??2e3,u,c)?f==null?{month:u,day:c}:{year:f,month:u,day:c}:null}function Qe(){let e=new Date;return{view:"month",cursor:`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}-01`,selectedDate:null,rangeStart:null,rangeEnd:null,selectedTime:null,timeRange:null}}function dt(e){if(typeof e!="string"||!/^\d{4}-\d{2}-\d{2}$/.test(e))return!1;let[t,n,r]=e.split("-").map(Number);return Ft(t,n,r)}var hn=e=>typeof e=="string"&&/^(?:[01]\d|2[0-3]):[0-5]\d$/.test(e);function yn(e,t,n){if(!e||typeof e!="object"||Array.isArray(e))return null;let{start:r,end:o}=e;return!hn(r)||!hn(o)?null:(dt(t)&&dt(n)?`${t}T${r}`<`${n}T${o}`:r<o)?{start:r,end:o}:null}function vr(e){let t=e&&typeof e=="object"?e:{},n=Qe(),r=dt(t.rangeStart)?t.rangeStart:null,o=dt(t.rangeEnd)?t.rangeEnd:null;return{view:t.view==="week"||t.view==="year"||t.view==="month"?t.view:n.view,cursor:dt(t.cursor)?`${t.cursor.slice(0,7)}-01`:n.cursor,selectedDate:dt(t.selectedDate)?t.selectedDate:null,rangeStart:r,rangeEnd:o,selectedTime:hn(t.selectedTime)?t.selectedTime:null,timeRange:yn(t.timeRange,r,o)}}var a,p;function wr(e){p=e,a=e.React}function yt(){return p.runtime.getOrCreate("calendar.revealTarget",()=>{let e={value:null,listeners:new Set,get:()=>e.value,publish:t=>{e.value=t;for(let n of[...e.listeners])n()},subscribe:t=>(e.listeners.add(t),()=>e.listeners.delete(t))};return e})}var pd=2400;function xr(e,t){let n=p.runtime.getOrCreate("calendar.revealPulse",()=>({nonce:0,timer:null})),r=yt();if(p.workspace.patchTimeControl({...e.view?{view:e.view}:{},cursor:`${e.date.slice(0,7)}-01`,selectedDate:e.date,selectedTime:e.startTime??null,timeRange:yn({start:e.startTime,end:e.endTime}),rangeStart:null,rangeEnd:null}),n.timer&&clearTimeout(n.timer),r.publish(null),e.itemId){let o={surface:t,sourceId:e.sourceId??"",itemId:e.itemId,date:e.date,nonce:++n.nonce};r.publish(o),n.timer=setTimeout(()=>{r.get()?.nonce===o.nonce&&r.publish(null),n.timer=null},pd)}}function wa(e){xr(e,"main"),p.workspace.openMainTab()}function kr(e){xr(e,"agenda"),p.workspace.revealOwnPanel("left_sidebar")}var md=`
...
range: next-30
filter-tag: #focus
limit: 10`}]};var xl=/^([A-Za-z][\w./-]*)\s*[:=]\s*(.*)$/,kl=/^-\s+(.*)$/,Cl=/^[A-Za-z][\w+.-]*:\/\//;function Xo(e){let t={bare:null,values:{},lists:{}},n=null;for(let r of e.split(`
`)){let o=r.trim();if(!o||o.startsWith("#"))continue;let i=o.match(kl);if(i){n?t.lists[n].push(i[1].trim()):t.bare===null&&(t.bare=i[1].trim());continue}let s=Cl.test(o)?null:o.match(xl);if(s){let l=s[1].trim().toLowerCase(),c=s[2].trim();c===""?(n=l,t.lists[l]=t.lists[l]??[]):(n=null,t.values[l]=c);continue}n=null,t.bare===null&&(t.bare=o)}return t}function Zo(e,t,n=500){let r=e.values[t];if(r===void 0)return null;let o=Number.parseInt(r,10);return!Number.isFinite(o)||o<1?null:Math.min(o,n)}var Gn="notes-calendar-fence-styles";function Sl(){if(document.getElementById(Gn))return;let e=document.createElement("style");e.id=Gn,e.textContent=`
...
`,document.head.appendChild(e)}var Qo=e=>String(e).padStart(2,"0"),ca=e=>`${e.getFullYear()}-${Qo(e.getMonth()+1)}-${Qo(e.getDate())}`,Kn=e=>{let t=new Date;return t.setDate(t.getDate()+e),ca(t)};function El(e){let t=e["start-date"]??e.start,n=e["end-date"]??e.end;if(t||n)return{start:t??ca(new Date),end:n??t??Kn(7)};let r=(e.range??"this-week").toLowerCase(),o=ca(new Date);if(r==="today")return{start:o,end:o};if(r==="next-30")return{start:o,end:Kn(30)};if(r==="this-week"){let i=new Date,s=(i.getDay()+6)%7,l=new Date(i);l.setDate(i.getDate()-s);let c=new Date(l);return c.setDate(l.getDate()+6),{start:ca(l),end:ca(c)}}return{start:o,end:Kn(7)}}function Il(e,t,n,r,o){let i=n?n.replace(/^#/,"").toLowerCase():null,s=r?.toLowerCase()??null;return e.filter(l=>!(l.date<t.start||l.date>t.end||i&&!l.tags.some(c=>c.replace(/^#/,"").toLowerCase()===i)||s&&(l.category??"").toLowerCase()!==s)).sort((l,c)=>l.date.localeCompare(c.date)||(l.startTime??"").localeCompare(c.startTime??"")).slice(0,o)}var Dl=e=>{let[t,n,r]=e.split("-").map(Number);return new Date(t,(n??1)-1,r??1).toLocaleDateString(p.ui.language(),{weekday:"short",day:"numeric",month:"short"})},Al=({code:e})=>{let[t,n]=a.useState(null);a.useEffect(()=>{let g=!0,w=()=>{Oe().then(_=>{g&&n(_)})};w();let S=tt(w);return()=>{g=!1,S()}},[]);let r=Xo(e),o=El(r.values),i=(r.values["view-mode"]??r.values.view??"agenda").toLowerCase().startsWith("week"),s=Zo(r,"limit",200)??20;if(!t)return a.createElement("div",{className:"calendar-fence-empty"},d("auto.33ce417454bf"));let l=Il(t,o,r.values["filter-tag"]??r.values.tag??null,r.values.category??null,s),c=()=>p.workspace.openMainTab(),u=g=>g.allDay||!g.startTime?d("auto.1ac1ff7616a6"):`${g.startTime}${g.endTime?`\u2013${g.endTime}`:""}`,f=(g,w)=>a.createElement("div",{key:g.id,className:"calendar-fence-row",onClick:c,title:g.note||g.title},a.createElement("span",{className:"dot",style:g.color?{background:ce(g.color)}:void 0}),a.createElement("span",{className:"time"},w?`${g.date.slice(5)} ${u(g)}`:u(g)),a.createElement("span",{className:"t"},g.title),g.category&&a.createElement("span",{className:"cat"},g.category)),h;if(l.length===0)h=a.createElement("div",{className:"calendar-fence-empty"},d("auto.a2590d497e7c"));else if(i){let g=new Map;for(let w of l){let S=g.get(w.date)??[];S.push(w),g.set(w.date,S)}h=a.createElement(a.Fragment,null,[...g.entries()].map(([w,S])=>a.createElement(a.Fragment,{key:w},a.createElement("div",{className:"calendar-fence-day"},Dl(w)),S.map(_=>f(_,!1)))))}else h=a.createElement(a.Fragment,null,l.map(g=>f(g,!0)));return a.createElement(a.Fragment,null,a.createElement("div",{className:"calendar-fence-head",onClick:c,title:d("auto.7a3a9094b18c")},a.createElement("span",{className:"t"},d("auto.adab5090ac6a")),a.createElement("span",{className:"c"},o.start," \u2192 ",o.end," \xB7 ",l.length)),h)};function Jo(){let e=p.markdown.registerCodeBlockRenderer("calendar",(t,n)=>(Sl(),n.classList.add("calendar-fence"),p.ui.renderReact(n,a.createElement(Al,{code:t}))),{examples:Yo.calendar});return()=>{e(),document.getElementById(Gn)?.remove()}}function jn(e){return{v:1,...e}}function ua(e){return e.v!==1||e.view!=="month"&&e.view!=="week"&&e.view!=="year"||!dt(e.cursor)?null:vr(e)}function Ya(){let[e,t]=a.useState(Qe);a.useEffect(()=>{let r=!1,o=!1;p.workspace.getTimeControl().then(s=>{!r&&!o&&t(s)});let i=p.workspace.onTimeControlChanged(s=>{o=!0,t(s)});return()=>{r=!0,i()}},[]);let n=a.useCallback(r=>{t(p.workspace.patchTimeControl(r))},[]);return[e,n]}function ei(e,t){let n=new Date(`${e}T00:00:00`),r=new Date(`${t}T00:00:00`),o=n<=r?n:r,i=n<=r?r:n,s=[];for(let l=new Date(o);l<=i;l.setDate(l.getDate()+1)){let c=String(l.getMonth()+1).padStart(2,"0"),u=String(l.getDate()).padStart(2,"0");s.push(`${l.getFullYear()}-${c}-${u}`)}return s}function ut(){return a.useSyncExternalStore(p.subscribe,p.getState,p.getState)}var Tl=["exact","day-month","day"],Xa=100;function Dt(e){return e==null?"":Array.isArray(e)?e.map(Dt).filter(Boolean).join(", "):typeof e=="object"?"":String(e)}function Nl(e){if(Array.isArray(e)){let t=e.find(n=>typeof n=="string"&&n.trim());return typeof t=="string"?t.trim():""}return q(e).trim()}function Pl(e){return e.split(/[\n,]+/).map(t=>t.trim()).filter(Boolean)}var ti=0;function Za(){return ti+=1,{id:`notedate-${Date.now().toString(36)}-${ti}`,title:"",matchKey:"type",matchValue:"",dateField:"date",match:"exact",showCount:!0,labelMode:"filename",showFields:[],visible:!0,hidden:!1}}var Hn=[{id:"birthdays",labelKey:"calendar.noteDatePreset.birthdays",label:"Birthdays",patch:{title:"Birthdays",matchKey:"type",matchValue:"contact",dateField:"birthdate",match:"day-month",showCount:!0,icon:"cake"}},{id:"anniversaries",labelKey:"calendar.noteDatePreset.anniversaries",label:"Anniversaries",patch:{title:"Anniversaries",matchKey:"type",matchValue:"anniversary",dateField:"date",match:"day-month",showCount:!0,icon:"heart"}},{id:"deadlines",labelKey:"calendar.noteDatePreset.deadlines",label:"Deadlines",patch:{title:"Deadlines",matchKey:"type",matchValue:"project",dateField:"due",match:"exact",showCount:!1,icon:"flag"}}];function ai(e,t){let n=Za(),r=Hn.find(i=>i.id===e);if(!r)return n;let o=t.map(i=>i.color).filter(i=>!!i);return{...n,...r.patch,color:Na(o)}}function Ml(e){if(!(typeof e!="number"||!Number.isFinite(e)))return Math.max(0,Math.min(Xa,Math.floor(e)))}function Ll(e,t){let n=q(e).trim();return Tl.includes(n)?n:t}function ni(e){let t=Za(),n=e.showFields??e.hoverFields;return{id:q(e.id,t.id),title:q(e.title).trim(),matchKey:q(e.matchKey,t.matchKey).trim(),matchValue:q(e.matchValue).trim(),folder:q(e.folder).trim()||void 0,dateField:q(e.dateField,t.dateField).trim()||t.dateField,dateFormat:q(e.dateFormat).trim()||void 0,startTimeField:q(e.startTimeField).trim()||void 0,endTimeField:q(e.endTimeField).trim()||void 0,match:Ll(e.match,t.match),recurrenceLimitYears:Ml(e.recurrenceLimitYears),showCount:Lr(e.showCount,t.showCount),labelMode:e.labelMode==="property"||e.labelMode==null&&q(e.labelField).trim()?"property":"filename",labelField:q(e.labelField).trim()||void 0,showFields:Array.isArray(n)?n.map(r=>q(r).trim()).filter(Boolean):Pl(q(n)),color:q(e.color).trim()||void 0,borderColor:q(e.borderColor).trim()||void 0,icon:q(e.icon).trim()||void 0,visible:e.visible!==!1,hidden:e.hidden===!0}}function Ol(e,t){return t?e===t||e.startsWith(t.replace(/\/+$/,"")+"/"):!0}function Un(e){return!!(e.matchKey&&e.matchValue&&e.dateField)}function qn(e,t){if(!Un(t))return[];let n=t.matchKey,r=t.matchValue.trim().toLowerCase(),o=[];for(let i of e){if(i.excluded||i.kind!=="note"||!Ol(i.relPath,t.folder))continue;let s=i.frontmatter?.[n];String(s??"").trim().toLowerCase()===r&&o.push(i)}return o}function Qa(e,t){let n=qn(e,t),r=0;for(let o of n){let i=ri(o.frontmatter?.[t.dateField],t.dateFormat);i&&(t.match!=="exact"||i.year!=null)&&(r+=1)}return{matched:n.length,dated:r}}var _l=/^(\d{4})-(\d{1,2})-(\d{1,2})(?:[T ].*)?$/,zl=/^(?:--)?(\d{1,2})-(\d{1,2})$/;function ri(e,t){if(e instanceof Date)return Number.isNaN(e.getTime())?null:{year:e.getFullYear(),month:e.getMonth()+1,day:e.getDate()};let n=Nl(e);if(!n)return null;if(t){let i=br(n,t);if(i)return i}let r=_l.exec(n);if(r){let[,i,s,l]=r,c={year:Number(i),month:Number(s),day:Number(l)};return Ft(c.year,c.month,c.day)?c:null}let o=zl.exec(n);if(o){let[,i,s]=o,l={month:Number(i),day:Number(s)};return Ft(2e3,l.month,l.day)?l:null}return null}function Vn(e,t){return oi(t,e.month,e.day)}function oi(e,t,n){let r=Math.min(n,yr(e,t));return`${e}-${String(t).padStart(2,"0")}-${String(r).padStart(2,"0")}`}function $l(e,t,n){if(t==="exact")return e.year==null?[]:[Vn(e,e.year)];if(t==="day-month")return n.map(o=>Vn(e,o));let r=[];for(let o of n)for(let i=1;i<=12;i+=1)r.push(oi(o,i,e.day));return r}function Fl(e,t){if(e.year==null)return null;let n=t-e.year;return n<0?null:n}function ii(e,t){let n=new Set,r=e.getFullYear();for(let o of[r-1,r,r+1,r+2])n.add(o);if(t!=null&&Number.isFinite(t))for(let o of[t-1,t,t+1,t+2])n.add(o);return[...n].sort((o,i)=>o-i)}function Rl(e,t){let n=[];for(let r of t.showFields){let o=Dt(e?.[r]);o&&n.push({key:r,value:o})}return n}function di(e,t){if(t.labelMode==="property"&&t.labelField){let n=Dt(e.frontmatter?.[t.labelField]);if(n)return n}return e.title}function Kl(e,t,n,r){if(t.hidden||!t.visible)return[];let o=[];for(let i of qn(e,t)){let s=i.frontmatter,l=ri(s?.[t.dateField],t.dateFormat);if(!l)continue;let c=l.year==null?void 0:Vn(l,l.year),u=t.recurrenceLimitYears==null?void 0:r+t.recurrenceLimitYears,f=$l(l,t.match,n).filter(_=>{if(t.match==="exact")return!0;let R=Number(_.slice(0,4));return(u==null||R<=u)&&(c==null||_>=c)});if(!f.length)continue;let h=t.startTimeField?Rt(s?.[t.startTimeField]):void 0,g=t.endTimeField?Rt(s?.[t.endTimeField]):void 0,w=di(i,t),S=Rl(s,t);for(let _ of f){let R=Fl(l,Number(_.slice(0,4))),V=t.match==="day-month"&&t.showCount&&R!=null;o.push({id:`notedate:${t.id}:${i.relPath}:${_}`,sourceId:t.id,relPath:i.relPath,date:_,startTime:h,endTime:g,title:V?`${w} (${R})`:w,count:R,color:t.color,borderColor:t.borderColor,icon:t.icon,fields:S})}}return o}function li(e,t,n,r){return t.flatMap(o=>Kl(e,o,n,r))}function si(e,t){let n=[];for(let r of t){n.push(`#${r.id}:${r.visible?1:0}:${r.hidden?1:0}:${r.color??""}:${r.borderColor??""}:${r.icon??""}:${r.matchKey}=${r.matchValue}:${r.folder??""}:${r.dateField}:${r.dateFormat??""}:${r.startTimeField??""}:${r.endTimeField??""}:${r.match}:${r.recurrenceLimitYears??""}:${r.showCount?1:0}:${r.labelMode}:${r.labelField??""}:${r.showFields.join(",")}`);for(let o of qn(e,r)){let i=o.frontmatter;n.push(o.relPath,Dt(i?.[r.dateField]),r.startTimeField?Dt(i?.[r.startTimeField]):"",r.endTimeField?Dt(i?.[r.endTimeField]):"",di(o,r));for(let s of r.showFields)n.push(Dt(i?.[s]))}}return n.join("")}var Gl="calendar.note_date_sources",Bn=()=>p.data.dataset(Gl);async function ci(){let e=Bn(),t=[],n;do{let r=await e.query({orderBy:[{field:"position",direction:"asc"}],limit:1e3,cursor:n});t.push(...r.rows),n=r.cursor}while(n);return t}async function pa(){return(await ci()).map(t=>ni(t.definition&&typeof t.definition=="object"&&!Array.isArray(t.definition)?t.definition:{}))}async function Ja(e){let t=Bn(),n=await ci(),r=new Set(e.map(l=>l.id)),o=new Map(n.map(l=>[l.id,l])),i=e.map((l,c)=>({id:l.id,position:c,definition:l})).filter(l=>o.get(l.id)?.position!==l.position||JSON.stringify(o.get(l.id)?.definition)!==JSON.stringify(l.definition)),s=n.filter(l=>!r.has(String(l.id))).map(l=>({operation:"delete",key:{id:String(l.id)}}));if(i.length&&s.push({operation:"upsert",values:i}),s.length>1e3)throw new Error(d("calendar.error.atomicLimit"));s.length&&await t.batch(s)}function en(){let[e,t]=a.useState([]);return a.useEffect(()=>{let n=!0,r=()=>{pa().then(i=>{n&&t(i)})};r();let o=Bn().subscribe(r);return()=>{n=!1,o()}},[]),e}function jl(e){return e.kind==="event"?xt:e.kind==="noteDate"?kt:e.sourceOwner?La(e.sourceOwner):""}function Vl(e,t){if(e.groupId){let r=t.find(o=>o.id===e.groupId);if(r)return r}if(!e.group)return;let n=Ge(e.group);return t.find(r=>Ge(r.name)===n)}function ui(e,t,n,r){if(n.length===0&&r.length===0)return e;let o=new Set(n),i=new Set(r);return e.filter(s=>{if(i.has(jl(s)))return!1;if(o.size===0)return!0;let l=Vl(s,t);return!l||!o.has(l.id)})}function ma({label:e,options:t,hidden:n,settingsKey:r,emptyText:o,onOpenSettings:i,saveHidden:s,embedded:l=!1}){let[c,u]=a.useState(()=>[...n]),[f,h]=a.useState(!1),[g,w]=a.useState(!1);a.useEffect(()=>u([...n]),[n]);let S=t.filter(v=>!c.includes(v.id)).length,_=t.map(v=>!c.includes(v.id)),R=(v,y)=>v?` active${_[y-1]?"":" selection-run-start"}${_[y+1]?"":" selection-run-end"}`:"",V=v=>{if(g)return;u(v),w(!0),(s?s(v):r?p.settings.set(r,v).then(O=>O.ok):Promise.resolve(!1)).then(O=>{O?h(!1):(u([...n]),h(!0))}).catch(()=>{u([...n]),h(!0)}).finally(()=>w(!1))},z=v=>V(c.includes(v)?c.filter(y=>y!==v):[...c,v]),E=()=>{let v=new Set(t.map(y=>y.id));V(S===t.length?[...new Set([...c,...v])]:c.filter(y=>!v.has(y)))};return l?a.createElement("div",{className:"props-info"},a.createElement("div",{className:"props-info-actions"},i&&a.createElement("button",{type:"button",onClick:i},d("calendar.properties.manageGroups")),t.length>0&&a.createElement("button",{type:"button",disabled:g,onClick:E},d(S===t.length?"calendar.filter.deselectAll":"calendar.filter.selectAll"))),a.createElement("dl",{className:"props-info-table calendar-filter-properties"},t.map(v=>a.createElement("div",{className:"props-info-row calendar-filter-property-row",key:v.id},a.createElement("dt",{className:"props-info-key"},v.icon&&a.createElement("span",{className:"calendar-filter-property-glyph",style:v.color?{color:ce(v.color)}:void 0},v.icon),!v.icon&&v.color&&a.createElement("span",{className:"props-info-dot",style:{background:ce(v.color)}}),v.label),a.createElement("dd",{className:"props-info-value calendar-filter-property-value"},v.count!==void 0&&a.createElement("span",{className:"calendar-filter-option-count"},v.count),a.createElement(p.ui.settings.Toggle,{label:v.label,checked:!c.includes(v.id),disabled:g,onChange:()=>z(v.id)}))))),t.length===0&&a.createElement("p",{className:"props-info-hint"},o),f&&a.createElement("p",{className:"props-info-hint",role:"alert"},p.ui.t("error.commandFailed"))):a.createElement("div",{className:"calendar-filter-popover-body"},a.createElement("div",{className:"calendar-filter-popover-head"},i?a.createElement("button",{type:"button",className:"calendar-filter-popover-title actionable",onClick:i},e):a.createElement("span",{className:"calendar-filter-popover-title"},e),t.length>0&&a.createElement("button",{type:"button",className:"calendar-filter-popover-all",onClick:E},d(S===t.length?"calendar.filter.deselectAll":"calendar.filter.selectAll"))),t.length===0?a.createElement("div",{className:"calendar-filter-empty"},o):a.createElement("div",{className:"calendar-filter-list"},t.map((v,y)=>{let O=!c.includes(v.id),D=_[y];return a.createElement("button",{key:v.id,type:"button",className:`calendar-filter-option${R(D,y)}`,"aria-pressed":O,onClick:()=>z(v.id)},a.createElement("span",{className:"calendar-filter-check","aria-hidden":"true"},O?"\u2713":""),v.icon?a.createElement("span",{className:"calendar-filter-option-glyph",style:v.color?{color:ce(v.color)}:void 0},v.icon):a.createElement("span",{className:"calendar-legend-dot",style:{background:v.color?ce(v.color):"var(--text-tertiary)"}}),a.createElement("span",{className:"calendar-filter-option-label"},v.label),v.count!==void 0&&a.createElement("span",{className:"calendar-filter-option-count"},v.count))})))}function tn({label:e,icon:t,options:n,hidden:r,settingsKey:o,emptyText:i,onOpenSettings:s,saveHidden:l}){let c=n.some(u=>r.includes(u.id));return a.createElement("button",{type:"button",className:`calendar-filter-btn${c?" active":""}`,"aria-label":e,"aria-haspopup":"dialog",title:e,onClick:u=>{let f=u.currentTarget;p.ui.openPopover(({close:h})=>a.createElement(ma,{label:e,options:n,hidden:r,settingsKey:o,emptyText:i,onOpenSettings:s?()=>{h(),s()}:void 0,saveHidden:l}),{anchor:f,align:"end"},{className:"calendar-filter-popover",ariaLabel:e})}},a.createElement("span",{className:"calendar-filter-icon"},t))}function pi(){let e=en(),{indexEntries:t}=ut(),n=a.useMemo(()=>e.filter(s=>!s.hidden),[e]),r=a.useMemo(()=>n.map(s=>({id:s.id,label:s.title||d("calendar.noteDatePreset.blank"),color:s.color,icon:a.createElement(Fe,{id:s.icon||"pin"}),count:Qa(t,s).dated})),[t,n]),o=a.useMemo(()=>n.filter(s=>!s.visible).map(s=>s.id),[n]),i=a.useCallback(async s=>{let l=new Set(s);try{return await Ja(e.map(c=>c.hidden?c:{...c,visible:!l.has(c.id)})),!0}catch{return!1}},[e]);return{options:r,hidden:o,saveHidden:i}}function mi({embedded:e=!1}){let t=pi();return a.createElement(ma,{embedded:e,label:d("calendar.filter.noteDates"),options:t.options,hidden:t.hidden,saveHidden:t.saveHidden,emptyText:d("calendar.filter.noSources")})}function fi(){let e=pi();return a.createElement(tn,{label:d("calendar.filter.noteDates"),icon:a.createElement(Ao,null),options:e.options,hidden:e.hidden,saveHidden:e.saveHidden,emptyText:d("calendar.filter.noSources")})}function Se(){return p.runtime.getOrCreate("calendar.surfaces",()=>({time:Qe(),selected:new Map,navigation:new Map,listeners:new Set}))}function ea(){for(let e of Se().listeners)e()}function We(e,t){e?Se().selected.set(t,e):Se().selected.delete(t),ea()}function an(e,t,n){a.useEffect(()=>{Se().time=t,n&&Se().navigation.set(e,n),ea()},[e,t,n])}function Hl(e){return{...jn(Se().time),itemId:e.id,kind:e.kind,date:e.date,sourceId:e.sourceId??"",filePath:e.filePath??""}}async function Wn(e){if(typeof e.itemId!="string")return null;if(e.kind==="event"||e.kind==="sourced")return Ve({id:e.itemId,sourceId:e.kind==="sourced"&&typeof e.sourceId=="string"?e.sourceId:void 0});if(e.kind==="noteDate"&&typeof e.filePath=="string"&&p.getState().indexEntries.some(t=>t.relPath===e.filePath))return{kind:"noteDate",id:e.itemId,title:e.filePath.split("/").pop()??e.filePath,date:String(e.date??""),filePath:e.filePath,readOnly:!0};throw new Error("The bookmarked calendar item is unavailable.")}function Ul(e){let t=Se().selected.get(e);return{title:d("manifest.name"),view:jn(Se().time),navigation:Se().navigation.get(e),...t?{item:{id:je(t),title:t.title,state:Hl(t)}}:{}}}function Yn(e){let t=Se().listeners;return t.add(e),()=>{t.delete(e)}}function gi(e){let t=e?{...Qe(),...ua(e)}:Se().time,n=Kt(me(t.selectedDate??Q(new Date)),oa[p.getState().weekStart]??1);return Object.entries({plugin:"calendar",view:t.view,selectedDate:t.selectedDate,month:t.cursor.slice(0,7),week:{number:bt(n),start:Q(n),end:qt(Q(n),6)},year:Number(t.cursor.slice(0,4)),...t.rangeStart&&t.rangeEnd?{range:[t.rangeStart,t.rangeEnd].sort()}:{},...t.selectedTime?{selectedTime:t.selectedTime}:{}}).map(([r,o])=>({id:r,label:d(`calendar.overview.${r}`),value:o,readOnly:!0}))}async function hi(){let e=be(),[t,n]=await Promise.all([qe(p).listAccounts(),(async()=>{let o=[],i;do{let s=await p.data.dataset("calendar.calendars").query({limit:100,cursor:i});o.push(...s.rows),i=s.cursor}while(i);return o})()]);if(!t.ok||!t.data)throw new Error(d("calendar.overview.unavailable"));let r=[{id:xt,name:d("calendar.filter.events")},{id:kt,name:d("calendar.filter.noteDates")},...lt().map(o=>({id:o.sourceKey,name:o.integration?.localized?.[p.ui.language()]?.name??o.integration?.name??o.owner}))].filter(o=>!e.hiddenSources.includes(o.id));return[{id:"sources",label:d("calendar.overview.sources"),value:r,readOnly:!0},{id:"calendars",label:d("calendar.overview.calendars"),value:n.map(o=>({id:String(o.id),name:String(o.name),accountId:o.accountId??null,provider:o.provider??null,timezone:o.timezone??null,readOnly:o.readOnly===!0})),readOnly:!0},{id:"accounts",label:d("calendar.overview.accounts"),value:t.data.accounts.filter(o=>o.capabilities.includes("calendar")).map(o=>({id:o.id,name:o.displayName||o.address,address:o.address,provider:o.provider,enabled:!e.disabledCalendarAccounts.includes(o.id)})),readOnly:!0}]}function ql(e){if(e.id==="plugin")return d("auto.adab5090ac6a");if(e.id==="view")return d(e.value==="week"?"auto.f82be68a7fb4":e.value==="year"?"auto.879e32326c52":"auto.082bc378cd60");if(e.id==="month"){let t=me(`${e.value}-01`);return`${et(t.getMonth(),p.ui.language())} ${t.getFullYear()}`}return e.id==="week"&&e.value&&typeof e.value=="object"&&!Array.isArray(e.value)?`${e.value.number} \xB7 ${e.value.start} \u2013 ${e.value.end}`:Array.isArray(e.value)?e.value.length?e.value.map((t,n)=>{if(!t||typeof t!="object"||Array.isArray(t))return a.createElement("div",{key:n},String(t));let r=[t.address!==t.name?t.address:null,t.provider,t.timezone,t.enabled===!1?d("calendar.overview.disabled"):null].filter(Boolean).join(" \xB7 ");return a.createElement("div",{key:String(t.id)},String(t.name),r?a.createElement("small",null,r):null)}):d("calendar.overview.none"):e.value===null?d("calendar.overview.none"):String(e.value)}function yi({view:e,sources:t=!1}){let[,n]=a.useReducer(u=>u+1,0),[r,o]=a.useState([]),[i,s]=a.useState(!1),l=$e(),c=Ht();return a.useEffect(()=>{if(!t)return Yn(n);let u=0,f=()=>{let g=++u;n(),hi().then(w=>{g===u&&(o(w),s(!1))}).catch(()=>{g===u&&s(!0)})},h=[Yn(n),p.subscribe(f),p.settings.subscribe(f),p.data.dataset("calendar.calendars").subscribe(f),p.interop.services.subscribe(zt,f)];return f(),()=>{u++,h.forEach(g=>g())}},[t]),a.createElement("div",{className:"right-panel-body props-info"},t&&a.createElement(ma,{embedded:!0,label:d("calendar.filter.sources"),options:[{id:xt,label:d("calendar.filter.events")},{id:kt,label:d("calendar.filter.noteDates")},...c.map(u=>({id:u.sourceKey,label:u.integration?.localized?.[p.ui.language()]?.name??u.integration?.name??u.owner}))],hidden:l.hiddenSources,settingsKey:Vt,emptyText:d("calendar.overview.none")}),a.createElement("dl",{className:"props-info-table"},(t?r.filter(u=>u.id!=="sources"):gi(e)).map(u=>a.createElement("div",{className:"props-info-row",key:u.id},a.createElement("dt",{className:"props-info-key"},u.label),a.createElement("dd",{className:"props-info-value"},ql(u))))),i&&a.createElement("p",{role:"alert"},d("calendar.overview.unavailable")))}function Bl(){let e=$e();return a.createElement("div",{className:"right-panel-body props-info"},a.createElement(ma,{embedded:!0,label:d("calendar.filter.groups"),options:e.groups.map(t=>({id:t.id,label:t.name,color:t.color})),hidden:e.hiddenGroups,settingsKey:Ma,emptyText:d("calendar.overview.none"),onOpenSettings:()=>p.workspace.openSettings("groups")}))}function Wl({item:e,view:t}){let[n,r]=a.useState(null),[o,i]=a.useState("");return a.useEffect(()=>{let s=!1,l=()=>{if(!e){r(null),i("");return}Wn(e).then(u=>{s||(r(u),i(""))}).catch(u=>{s||(r(null),i(u instanceof Error?u.message:String(u)))})};l();let c=tt(l);return()=>{s=!0,c()}},[e]),o?a.createElement("div",{className:"right-panel-body",role:"alert"},o):e?n?a.createElement("div",{className:"right-panel-body props-info"},a.createElement("dl",{className:"props-info-table"},["title","date","endDate","startTime","endTime","group","note","filePath"].filter(s=>n[s]).map(s=>a.createElement("div",{className:"props-info-row",key:s},a.createElement("dt",{className:"props-info-key"},d(`calendar.field.${s}`)),a.createElement("dd",{className:"props-info-value"},n[s]))))):a.createElement("div",{className:"right-panel-body"},d("calendar.overview.loading")):a.createElement(yi,{view:t})}function bi(e){let t=!1;e.workspace.getTimeControl().then(l=>{t||(Se().time=l,ea())});let n=e.workspace.onTimeControlChanged(l=>{Se().time=l,ea()}),o=["main_workspace","left_sidebar","right_sidebar"].map(l=>e.interop.extensions.provide(hr,{id:`calendar.${l}`,surface:l,getSnapshot:()=>Ul(l),subscribe:Yn,restore:async c=>{let u=ua(c);if(!u)throw new Error("Unsupported Calendar bookmark.");let f=await Wn(c);e.workspace.patchTimeControl(u),We(f,l)}}));o.push(e.interop.extensions.provide(ra,{id:"calendar.properties",label:"Calendar",labelKey:"manifest.name",icon:"calendar",pluginSurfaces:["main_workspace"],inspect:async({subject:l})=>{let c=l?.item?await Wn(l.item.state):null,u=c?.kind==="event"?["title","date","endDate","startTime","endTime","groupId","note","filePath","tags","urls","attachments","location"]:["title","date","startTime","endTime","group","note","filePath","priority","completed","tags","urls","attachments","location"];return c?u.map(f=>({id:f,label:d(`calendar.field.${f}`),value:c[f]??null,readOnly:!0})):gi(l?.view)},render:({subject:l})=>a.createElement(Wl,{item:l?.item?.state,view:l?.view})})),o.push(e.interop.extensions.provide(ra,{id:"calendar.groups",label:"Groups",labelKey:"calendar.filter.groups",icon:"group",pluginSurfaces:["main_workspace"],inspect:()=>{let l=be();return l.groups.map(c=>({id:c.id,label:c.name,value:!l.hiddenGroups.includes(c.id),type:"boolean"}))},render:()=>a.createElement(Bl,null)})),o.push(e.interop.extensions.provide(ra,{id:"calendar.sources",label:"Sources",labelKey:"calendar.filter.sources",icon:"layers",pluginSurfaces:["main_workspace"],inspect:hi,render:()=>a.createElement(yi,{sources:!0})})),o.push(e.interop.extensions.provide(ra,{id:"calendar.noteDates",label:"Note dates",labelKey:"calendar.filter.noteDates",icon:"push-pin",pluginSurfaces:["main_workspace"],inspect:async()=>(await pa()).filter(l=>!l.hidden).map(l=>({id:l.id,label:l.title||d("calendar.noteDatePreset.blank"),value:l.visible,type:"boolean"})),render:()=>a.createElement("div",{className:"right-panel-body"},a.createElement(mi,{embedded:!0}))}));let i=0,s=()=>{let l=++i;for(let[c,u]of Se().selected)u.kind!=="noteDate"&&Ve({id:u.id,sourceId:u.sourceId}).then(f=>{t||l!==i||Se().selected.get(c)?.id!==u.id||(Se().selected.set(c,f),ea())}).catch(()=>{t||ea()})};return o.push(tt(s)),()=>{t=!0,n(),o.forEach(l=>l())}}function Xn(e,t){let[n,r]=a.useState([]),{items:o,reload:i}=oo(),s=Ct(),l=a.useSyncExternalStore(s.subscribe,s.getEvents),c=a.useRef(null),u=a.useCallback(()=>{i(),c.current?.reload()},[i]);a.useEffect(()=>{let h=Oa(()=>Oe(e,t),r,S=>console.error("[calendar] events reload failed",S));c.current=h,h.reload();let g=tt(u),w=p.subscribe(u);return()=>{h.dispose(),c.current===h&&(c.current=null),g(),w()}},[t,u,e]);let f=a.useMemo(()=>[...n,...l],[n,l]);return{sourced:o,events:f,reload:u}}var vi={high:Te("red"),medium:Te("amber"),low:Te("green"),normal:Te("gray")},wi={active:Te("primary-blue"),paused:Te("amber"),suspended:Te("violet"),completed:Te("green"),open:Te("gray")},Yl=Te("gray");function xi(e){return e.priority&&vi[e.priority]?vi[e.priority]:e.status&&wi[e.status]?wi[e.status]:Yl}function Xl(e,t){if(e.color)return e.color;if(e.groupId){let n=t.find(r=>r.id===e.groupId);if(n)return n.color}return xi({priority:e.priority,status:e.status})}function Zl(e){return e.endDate?go(e.date,e.endDate).map(t=>({...e,date:t,occurrenceKey:`${e.id}@${t}`})):[e]}function ki(e){return e.filePath?[e.filePath,e.date,e.endDate??e.date,e.startTime??"",e.endTime??""].join("\0"):null}function Ql(e){let t=new Set(e.filter(n=>n.kind==="sourced").map(ki).filter(n=>n!==null));return e.filter(n=>{if(n.kind!=="event"||n.event?.source||n.event?.endDate)return!0;let r=ki(n);return r===null||!t.has(r)})}function nn(e={}){let{focusYear:t}=e,{indexEntries:n}=ut(),{groups:r,hiddenGroups:o,hiddenSources:i}=$e(),s=Ht(),l=en(),c=a.useMemo(()=>ii(new Date,t),[t]),{sourced:u,events:f}=Xn(`${c[0]}-01-01`,`${c.at(-1)}-12-31`),h=a.useRef({signature:"",years:"",entries:[]}),g=a.useMemo(()=>{let E=si(n,l),v=t??new Date().getFullYear(),y=`${v}:${c.join(",")}`,O=h.current;if(O.years===y&&O.signature===E)return O.entries;let D=li(n,l,c,v);return h.current={signature:E,years:y,entries:D},D},[t,n,l,c]),w=a.useMemo(()=>[...u.map(Yt),...f.map(Be),...g.map(jo)],[u,f,g]),S=a.useMemo(()=>{let E=[];for(let v of w)E.push(...v.kind==="event"?Zl(v):[v]);return Ql(ui(E,r,o,i))},[w,r,o,i]),_=a.useMemo(()=>{let E=[{id:xt,label:d("calendar.filter.events"),count:f.length},{id:kt,label:d("calendar.filter.noteDates"),count:g.length}],v=new Set;for(let y of s){if(v.has(y.sourceKey))continue;v.add(y.sourceKey);let O=y.integration?.localized?.[p.ui.language()];E.push({id:y.sourceKey,label:O?.name??y.integration?.name??y.owner,count:u.filter(D=>D.sourceOwner===y.owner).length})}return E},[f.length,g.length,s,u]),R=a.useMemo(()=>{let E=Object.fromEntries(r.map(v=>[v.id,0]));for(let v of w){let y=v.groupId?r.find(O=>O.id===v.groupId):Jr(r,v.group);y&&(E[y.id]=(E[y.id]??0)+1)}return E},[w,r]),V=a.useCallback(E=>Xl(E,r),[r]),z=a.useMemo(()=>{let E=new Map;for(let v of S){let y=E.get(v.date)??[];y.push(v),E.set(v.date,y)}for(let v of E.values())v.sort((y,O)=>(y.startTime??"99:99").localeCompare(O.startTime??"99:99"));return E},[S]);return{sourced:u,events:f,items:S,itemsByDay:z,noteDates:g,sourceOptions:_,groupCounts:R,colorFor:V}}var Jl=["normal","low","medium","high"],es={normal:"calendar.priority.none",low:"calendar.priority.low",medium:"calendar.priority.medium",high:"calendar.priority.high"};function rn(e){let t=p.runtime.getOrCreate("calendar.eventDrafts",()=>new Map),n=t.get(e);return n||(n={fields:new Map,listeners:new Set},t.set(e,n)),n}function ve(e,t,n){let r=rn(e),o=a.useRef(n);o.current=n;let i=a.useCallback(()=>{if(!r.fields.has(t)){let c=o.current;r.fields.set(t,typeof c=="function"?c():c)}return r.fields.get(t)},[r,t]),s=a.useSyncExternalStore(a.useCallback(c=>(r.listeners.add(c),()=>{r.listeners.delete(c)}),[r]),i,i),l=a.useCallback(c=>{r.fields.set(t,typeof c=="function"?c(i()):c);for(let u of r.listeners)u()},[r,t,i]);return[s,l]}function Zn({title:e,children:t}){return a.createElement("div",{className:"calendar-quickadd-section"},a.createElement("span",{className:"calendar-quickadd-section-label"},e),t)}function At({glyph:e,children:t}){return a.createElement("div",{className:"calendar-quickadd-row"},a.createElement("span",{className:"calendar-quickadd-row-glyph","aria-hidden":"true"},e),a.createElement("div",{className:"calendar-quickadd-row-body"},t))}function on(e){let t=e.state.editItem,n=t?.kind==="sourced",r=n?t.sourceId??"":"",o=n?t.id:"",i=a.useRef(e.onClose);return i.current=e.onClose,a.useEffect(()=>{n&&Ut(r,o).then(()=>i.current())},[n,r,o]),n?null:a.createElement(ts,{...e})}function ts({state:e,groups:t,indexEntries:n,onClose:r,onAdded:o}){let i=e.editItem,s=i?`${i.sourceId??i.kind}:${i.id}`:`new:${e.kind??""}:${e.date}:${e.startTime??""}`,[l]=a.useState(()=>lo()),c=e.kind??l[0]?.id??"event",[u,f]=ve(s,"kind",i?.kind==="sourced"?i.sourceId??c:i?.kind==="event"?"event":c),[h,g]=ve(s,"title",i?.title??""),[w,S]=ve(s,"date",i?.date??e.date),[_,R]=ve(s,"endDate",i?.event?.endDate??""),[V,z]=ve(s,"start",i?.startTime??e.startTime??""),[E,v]=ve(s,"end",i?.endTime??e.endTime??""),[y,O]=ve(s,"groupId",()=>{let T=i?.event?.groupId??i?.sourced?.group??"";return t.find(Z=>Z.id===T)?.id??t.find(Z=>Z.name===T)?.id??""}),[D,J]=ve(s,"location",i?.event?.location??i?.sourced?.location),[ne,te]=ve(s,"note",i?.event?.note??i?.sourced?.note??""),[B,fe]=ve(s,"urls",i?.event?.urls??i?.sourced?.urls??[]),[we,Ee]=ve(s,"attachments",i?.event?.attachments??i?.sourced?.attachments??[]),[b,K]=a.useState(!1),[P,W]=a.useState(""),[de,C]=a.useState(!1),[H,U]=a.useState(""),[se,re]=ve(s,"priority",i?.sourced?.priority??"normal"),[ue,He]=ve(s,"tags",i?.sourced?.tags??i?.event?.tags??[]),[Pe,ze]=ve(s,"filePath",i?.sourced?.filePath??i?.event?.filePath??""),[Re,Ye]=ve(s,"busy",!1),[Nt,Ie]=ve(s,"error",""),x=T=>{let Z=kn(T);Z&&!B.includes(Z)&&fe([...B,Z]),U(""),C(!1)},A=!V&&!E,Y=T=>{T?(z(""),v("")):(z(e.startTime??"09:00"),v(e.endTime??"10:00"))},[M]=ve(s,"expectedUpdatedAt",i?.event?.updatedAt),[k,oe]=ve(s,"documentRevision",void 0),X=i?.kind==="event"&&!i.readOnly?{pluginId:"calendar",sourceId:"events",itemId:i.id}:void 0,ge=async()=>{if(!Re)try{X&&await p.documents.drafts.clear(X),rn(s).fields.clear(),r()}catch(T){Ie(T instanceof Error?T.message:String(T))}},he=async()=>{let T=h.trim();if(!(!T||rn(s).fields.get("busy")||i?.readOnly)){Ye(!0),Ie("");try{let Z=new Date().toISOString(),ot=w||e.date,cn=t.find(Ze=>Ze.id===y)?.name,it={location:D,urls:B.length>0?B:void 0,attachments:we.length>0?we:void 0,filePath:Pe.trim()||void 0,note:ne},aa={...it,groupId:y||void 0,tags:ue},un={...it,group:cn,tags:ue,priority:se};if(i){if(i.kind==="event"&&i.event){if(!k)throw new Error(d("calendar.error.save"));let Ze=(await Oe()).find(tr=>tr.id===i.id);if(!Ze)throw new Error(d("calendar.error.missing"));if(Ze.updatedAt!==M)throw new Error(d("calendar.error.changed"));if(!await Da(i.id,{...Ze,allDay:!V&&!E,title:T,date:ot,endDate:_||void 0,startTime:V||void 0,endTime:E||void 0,...aa,updatedAt:Z},M,k))throw new Error(d("calendar.error.save"))}}else if(u==="event"){if(!await Br(Aa(T,ot,{endDate:_||void 0,startTime:V||void 0,endTime:E||void 0,...aa})))throw new Error(d("calendar.error.save"))}else if(!await Ga(u,ot,{title:T,startTime:V||void 0,endTime:E||void 0,...un,completed:!1}))throw new Error(d("calendar.error.save"));X&&await p.documents.drafts.clear(X),rn(s).fields.clear(),o(),r()}catch(Z){Ie(Z instanceof Error?Z.message:String(Z))}finally{Ye(!1)}}},Me=u==="event",pt=T=>T==="event"?d("auto.ad8919ace091"):p.ui.t(l.find(Z=>Z.id===T)?.labelKey??T),{SelectField:ta,DateField:mt,TimeField:rt,Segmented:Xe,Toggle:De}=p.ui.settings;return a.createElement(p.ui.Modal,{title:i?d("calendar.quickadd.editTitle",{kind:pt(u)}):d("auto.61cc55aa0453"),bodyClassName:"calendar-quickadd",onClose:()=>{ge()},footer:a.createElement(a.Fragment,null,a.createElement("button",{className:"calendar-quickadd-cancel",type:"button",disabled:Re,onClick:()=>{ge()}},d("auto.77dfd2135f4d")),!i?.readOnly&&a.createElement("button",{className:"calendar-quickadd-save",type:"button",onClick:()=>{he()},disabled:!h.trim()||Re||!!X&&!k},i?d("auto.efc007a393f6"):d("auto.61cc55aa0453")))},!i&&a.createElement("div",{className:"calendar-quickadd-head"},a.createElement(Xe,{value:u,onChange:f,ariaLabel:d("calendar.quickadd.kind"),options:[{value:"event",label:d("auto.ad8919ace091")},...l.map(T=>({value:T.id,label:p.ui.t(T.labelKey)}))]})),a.createElement("div",{className:"calendar-quickadd-body hidescrollbar"},a.createElement("fieldset",{disabled:!!i?.readOnly,style:{display:"contents"}},a.createElement("input",{"data-modal-initial-focus":"true","aria-label":d("auto.768e0c1c6957"),className:"calendar-quickadd-title",value:h,onChange:T=>g(T.target.value),onKeyDown:T=>{T.key==="Enter"&&he()},placeholder:Me?d("auto.0cd372226ee9"):d("auto.33a5a701e541")}),a.createElement(Zn,{title:d("calendar.quickadd.when")},a.createElement(At,{glyph:a.createElement(ct,null)},a.createElement("div",{className:"calendar-quickadd-dates"},a.createElement(mt,{className:"calendar-quickadd-date",value:w,onChange:S,clearable:!1,ariaLabel:Me?d("calendar.quickadd.startDate"):d("calendar.quickadd.dueDate")}),Me&&a.createElement(a.Fragment,null,a.createElement("span",{className:"calendar-quickadd-dash","aria-hidden":"true"},"\u2192"),a.createElement(mt,{className:"calendar-quickadd-date",value:_,onChange:R,min:w,placeholder:d("calendar.quickadd.endDate"),ariaLabel:d("calendar.quickadd.endDate")})))),a.createElement(At,{glyph:a.createElement(da,null)},a.createElement("div",{className:"calendar-quickadd-times"},a.createElement(rt,{value:V,disabled:A,onChange:z,ariaLabel:d("auto.88d8206d586a")}),a.createElement("span",{"aria-hidden":"true"},"\u2013"),a.createElement(rt,{value:E,disabled:A,onChange:v,ariaLabel:d("auto.cd7800da7f4f")}),a.createElement("span",{className:"calendar-quickadd-allday"},d("calendar.quickadd.allDay"),a.createElement(De,{checked:A,onChange:Y,label:d("calendar.quickadd.allDay")}))))),a.createElement(Zn,{title:d("calendar.quickadd.details")},t.length>0&&a.createElement(At,{glyph:a.createElement(ko,null)},a.createElement(ta,{className:"calendar-quickadd-select",value:y,onChange:O,ariaLabel:d("auto.dbed7864623f"),options:[{value:"",label:d("auto.f6b2246c64fa")},...t.map(T=>({value:T.id,label:T.name,color:T.color}))]})),a.createElement(At,{glyph:a.createElement(Bt,null)},a.createElement(Ko,{value:D,onChange:J})),a.createElement(At,{glyph:a.createElement(Wt,null)},a.createElement(Mn,{value:Pe,onChange:ze,indexEntries:n})),a.createElement(At,{glyph:a.createElement(Eo,null)},a.createElement(p.ui.TagInput,{value:ue,onChange:He,readOnly:!!i?.readOnly})),!Me&&a.createElement(At,{glyph:a.createElement(Io,null)},a.createElement(Xe,{value:se,onChange:T=>re(T),ariaLabel:d("calendar.quickadd.priority"),options:Jl.map(T=>({value:T,label:d(es[T])}))}))),a.createElement(Zn,{title:d("calendar.attachments")},we.map(T=>a.createElement(zo,{key:T,relPath:T,onRemove:()=>Ee(we.filter(Z=>Z!==T))})),B.map(T=>a.createElement("div",{className:"calendar-quickadd-url-row",key:T},a.createElement("button",{className:"calendar-quickadd-url",type:"button",onClick:Z=>{let ot=xa(T);ot?p.workspace.openFile(ot,void 0,{newTab:p.ui.hasModKey(Z)}):p.files.openExternalUrl(T)}},T),a.createElement("button",{className:"calendar-field-btn",type:"button",title:d("calendar.removeUrl"),"aria-label":d("calendar.removeUrlOf",{p0:T}),onClick:()=>fe(B.filter(Z=>Z!==T))},a.createElement(at,null)))),b?a.createElement(Mn,{value:P,placeholder:d("calendar.attachmentPlaceholder"),ariaLabel:d("calendar.attachmentPath"),onChange:T=>{W(T),n.some(Z=>Z.relPath===T)&&(we.includes(T)||Ee([...we,T]),W(""),K(!1))},indexEntries:n}):null,de?a.createElement("input",{className:"calendar-quickadd-input",value:H,autoFocus:!0,placeholder:d("calendar.urlPlaceholder"),"aria-label":d("calendar.url"),onChange:T=>U(T.target.value),onBlur:T=>x(T.target.value),onKeyDown:T=>{T.key==="Enter"&&(T.preventDefault(),x(T.currentTarget.value)),T.key==="Escape"&&(U(""),C(!1))}}):null,a.createElement("div",{className:"calendar-quickadd-adders"},!b&&a.createElement("button",{className:"calendar-quickadd-add",type:"button",onClick:()=>K(!0)},a.createElement(st,null)," ",d("calendar.addAttachment")),!de&&a.createElement("button",{className:"calendar-quickadd-add",type:"button",onClick:()=>C(!0)},a.createElement(Et,null)," ",d("calendar.addUrl"))),a.createElement(p.ui.NoteInput,{onRevisionChange:T=>oe(Z=>!Z||T.expectedRevision<Z.expectedRevision?T:Z),className:"calendar-quickadd-note",value:ne,onChange:te,context:{sourcePath:Pe||void 0,ref:X},tags:ue,onTagsChange:He,onSave:()=>{he()},onCancel:()=>{ge()},placeholder:d("auto.1a29d1bf66f5"),minHeight:100,maxHeight:340,readOnly:!!i?.readOnly}))),Nt&&a.createElement("div",{role:"alert"},Nt)))}function as(e,t){return e.getFullYear()===t.getFullYear()&&e.getMonth()===t.getMonth()&&e.getDate()===t.getDate()}function ns(e){let t=e.getFullYear(),n=String(e.getMonth()+1).padStart(2,"0"),r=String(e.getDate()).padStart(2,"0");return`${t}-${n}-${r}`}function Ci(){let e=new Date,t=ns(e),[n,r]=Ya();an("left_sidebar",n);let{items:o,sourceOptions:i,groupCounts:s,colorFor:l}=nn(),{groups:c,hiddenGroups:u,hiddenSources:f}=$e(),h=a.useRef(null),g=yt(),w=a.useSyncExternalStore(a.useCallback(b=>g.subscribe(b),[g]),a.useCallback(()=>{let b=g.get();return b?.surface==="agenda"?b:null},[g]),a.useCallback(()=>{let b=g.get();return b?.surface==="agenda"?b:null},[g])),S=a.useRef(new Map),_=a.useRef(!1),R=a.useRef(null),[V,z]=a.useState(!0),[E,v]=a.useState(""),[y,O]=a.useState(null),D=a.useRef(null),J=a.useCallback(b=>{We(b,"left_sidebar"),D.current&&clearTimeout(D.current),D.current=setTimeout(()=>{D.current=null,R.current=b.date,Go(b)},220)},[]),ne=a.useCallback(b=>{if(D.current&&(clearTimeout(D.current),D.current=null),We(b,"left_sidebar"),!b.readOnly){if(b.kind==="sourced"){Ut(b.sourceId??"",b.id);return}O({date:b.date,editItem:b})}},[]);a.useEffect(()=>()=>{D.current&&clearTimeout(D.current)},[]);let te=a.useMemo(()=>{let b=E.trim().toLowerCase();return b?o.filter(K=>[K.title,K.note,K.group,K.status,K.location?.name,...K.tags??[],...(K.fields??[]).flatMap(P=>[P.key,P.value])].some(P=>P?.toLowerCase().includes(b))):o},[o,E]),{days:B,byDay:fe}=a.useMemo(()=>{let b=new Map;for(let P of te){let W=b.get(P.date)??[];W.push(P),b.set(P.date,W)}for(let P of b.values())P.sort((W,de)=>(W.startTime??"99:99").localeCompare(de.startTime??"99:99"));return!E.trim()&&n.selectedDate&&!b.has(n.selectedDate)&&b.set(n.selectedDate,[]),{days:[...b.keys()].sort((P,W)=>W.localeCompare(P)),byDay:b}},[E,n.selectedDate,te]);a.useEffect(()=>{if(_.current||B.length===0)return;let b=B.includes(t)?t:[...B].reverse().find(P=>P>=t);if(!b){_.current=!0;return}let K=S.current.get(b);K&&typeof K.scrollIntoView=="function"&&(K.scrollIntoView({block:"start"}),_.current=!0)},[B,t]),a.useEffect(()=>{if(!n.selectedDate)return;if(R.current===n.selectedDate){R.current=null;return}let b=S.current.get(n.selectedDate);b&&typeof b.scrollIntoView=="function"&&b.scrollIntoView({behavior:"smooth",block:"start"})},[n.selectedDate]),a.useEffect(()=>{if(!w)return;let b=requestAnimationFrame(()=>{[...h.current?.querySelectorAll("[data-calendar-item-id]")??[]].find(W=>W.dataset.calendarItemId===w.itemId&&(W.dataset.calendarSourceId??"")===w.sourceId)?.scrollIntoView({behavior:"smooth",block:"center"})});return()=>cancelAnimationFrame(b)},[w]),a.useEffect(()=>{let b=h.current;if(!b)return;let K=()=>{let P=S.current.get(t);if(!P){z(!1);return}let W=b.getBoundingClientRect(),de=P.getBoundingClientRect();z(de.bottom>W.top&&de.top<W.bottom)};return b.addEventListener("scroll",K,{passive:!0}),K(),()=>b.removeEventListener("scroll",K)},[t,B]);function we(){let b=S.current.get(t);b&&b.scrollIntoView({behavior:"smooth",block:"start"})}let Ee=async(b,K)=>{K.preventDefault(),K.stopPropagation(),We(b,"left_sidebar");let P=await qa(b,{onEdit:()=>ne(b)}),W=Ba(b),de=Wa(b),C=[...P,...de],H=C.length>0?[]:Zt(b),U=[...C,...C.length>0&&(H.length>0||W.length>0)?[{type:"separator"}]:[],...H,...W];U.length!==0&&await p.ui.openMenu(U,{x:K.clientX,y:K.clientY})};return a.createElement("div",{className:"panel calendar-agenda-panel"},a.createElement("div",{className:"panel-header"},a.createElement("span",{className:"panel-title"},d("auto.891e9d6d47f1")),a.createElement("div",{className:"agenda-header-actions"},a.createElement(tn,{label:d("calendar.filter.sources"),icon:a.createElement(wo,null),options:i.map(b=>({...b,color:"palette:primary-blue"})),hidden:f,settingsKey:Vt,emptyText:d("calendar.filter.noSources")}),a.createElement(tn,{label:d("calendar.filter.groups"),icon:a.createElement(xo,null),options:c.map(b=>({id:b.id,label:b.name,color:b.color,count:s[b.id]??0})),hidden:u,settingsKey:Ma,emptyText:d("calendar.filter.noGroups"),onOpenSettings:()=>p.workspace.openSettings("groups")}),a.createElement(fi,null),!V&&a.createElement("button",{className:"agenda-today-btn",onClick:we},d("auto.24345a14377f")),a.createElement("button",{className:"plugin-open-page",onClick:()=>p.workspace.openMainTab(),"aria-label":d("auto.9ee309dcedc9"),title:d("auto.9ee309dcedc9")}))),a.createElement("div",{className:"agenda-search search-field"},a.createElement(vo,{className:"search-field-icon"}),a.createElement("input",{className:"search-field-input",value:E,onChange:b=>v(b.target.value),onKeyDown:b=>{b.key==="Escape"&&v("")},placeholder:d("calendar.agenda.searchPlaceholder"),"aria-label":d("calendar.agenda.searchLabel")}),E&&a.createElement("button",{className:"search-field-action",type:"button",onClick:()=>v(""),"aria-label":d("calendar.agenda.clearSearch")},a.createElement(at,null))),a.createElement("div",{className:"panel-body agenda-body hidescrollbar",ref:h},B.length===0?a.createElement("div",{className:"tree-empty"},d("auto.418713defbf7")):B.map((b,K)=>{let P=me(b),W=fe.get(b)??[],de=as(P,e),C=n.selectedDate===b,H=P.getFullYear(),U=K>0?me(B[K-1]).getFullYear():null;return a.createElement("div",{key:b,className:"agenda-section",ref:re=>{re?S.current.set(b,re):S.current.delete(b)}},U!==null&&H!==U&&a.createElement("div",{className:"agenda-year-sep"},H),a.createElement("button",{type:"button",className:`agenda-day-header${de?" today":""}${C?" selected":""}`,onClick:()=>r({selectedDate:C?null:b,rangeStart:null,rangeEnd:null})},a.createElement("span",{className:"agenda-day-dow"},Je(P.getDay(),p.ui.language())),a.createElement("span",{className:"agenda-day-num"},P.getDate()),a.createElement("span",{className:"agenda-day-month"},et(P.getMonth(),p.ui.language()))),W.length===0?a.createElement("div",{className:"agenda-day-empty"},d("auto.f4e12416c6b8")):W.map(re=>{let ue=w?.itemId===re.id&&w.sourceId===(re.sourceId??"");return a.createElement(Ua,{key:`${re.occurrenceKey??re.id}:${ue?w?.nonce:0}`,item:re,sourceId:re.sourceId??"",color:l(re),revealNonce:ue?w?.nonce:void 0,onClick:()=>J(re),onDoubleClick:()=>ne(re),onContextMenu:He=>{Ee(re,He)}})}))})),y&&a.createElement(on,{key:`${y.editItem?.sourceId??y.editItem?.kind}:${y.editItem?.id}`,state:y,groups:c,indexEntries:p.getState().indexEntries,onClose:()=>O(null),onAdded:()=>O(null)}))}var rs=60,os=5,is=.22;function ds(e){let t=[];return e.forEach((n,r)=>{if(!n.startTime)return;let o=Ne(n.startTime),i=n.endTime?Ne(n.endTime):o+rs;t.push({id:n.id,start:o,end:Math.max(i,o+os),order:r})}),t.sort((n,r)=>n.start-r.start||r.end-n.end||n.order-r.order)}function ls(e,t){return e.start<t.end&&t.start<e.end}function ss(e,t,n,r){return!e.some(o=>o.id!==r.id&&t.get(o.id)===n&&ls(o,r))}function cs(e,t){let n=[],r=new Map;for(let s of e){let l=n.findIndex(c=>c<=s.start);l===-1&&(l=n.length),n[l]=s.end,r.set(s.id,l)}let o=n.length;if(o===1){for(let s of e)t.set(s.id,{left:0,width:1,z:1});return}let i=1/o;for(let s of e){let l=r.get(s.id)??0,c=1;for(;l+c<o&&ss(e,r,l+c,s);)c++;let u=l>0?is*i:0;t.set(s.id,{left:l*i-u,width:c*i+u,z:l+1})}}function Si(e){let t=new Map,n=[],r=-1,o=()=>{n.length>0&&cs(n,t),n=[],r=-1};for(let i of ds(e))n.length>0&&i.start>=r&&o(),n.push(i),r=Math.max(r,i.end);return o(),t}var ke=44,nt=15,Qn=24;function us(e,t,n){let r=Math.max(0,Math.min(t,Qn-1)),o=Math.min(Qn,Math.max(n,r+1));for(let i of e){if(!i.startTime)continue;let s=Ne(i.startTime),l=i.endTime?Ne(i.endTime):s;r=Math.min(r,Math.max(0,Math.floor(s/60))),o=Math.max(o,Math.min(Qn,Math.ceil(l/60)))}return{startHour:r,endHour:o}}function Ii({days:e,items:t,dayStartHour:n,dayEndHour:r,colorFor:o,selectedItemKey:i,onSelectItem:s,onEditItem:l,onCommit:c,onCreate:u,onContextMenu:f,onItemAction:h,compact:g,weekDays:w,selectedDay:S,selectedTime:_,itemsByDay:R,onPickDay:V,revealTarget:z}){let E=new Date,v=a.useRef(null),[y,O]=a.useState(0),[D,J]=a.useState(null),ne=a.useRef(null);ne.current=D;let te=a.useRef(!1),[B,fe]=a.useState(()=>new Date);a.useEffect(()=>{let x=setInterval(()=>fe(new Date),6e4);return()=>clearInterval(x)},[]);let we=e.length;a.useEffect(()=>{let x=v.current,A=x?.ownerDocument.defaultView?.ResizeObserver??globalThis.ResizeObserver;if(!x||!A)return;let Y=new A(()=>{O(Math.max(0,(x.clientWidth-48)/we))});return Y.observe(x),()=>Y.disconnect()},[we]);let Ee=e.map(Q),{startHour:b,endHour:K}=a.useMemo(()=>us(t,n,r),[t,n,r]),P=b*60,W=K*60,de=Array.from({length:K-b},(x,A)=>b+A);a.useEffect(()=>{let x=v.current;if(!x||!_)return;let A=Math.max(0,(Ne(_)-P)/60*ke-ke);typeof x.scrollTo=="function"?x.scrollTo({top:A,behavior:"smooth"}):x.scrollTop=A},[_,P]);let C=t.filter(x=>x.startTime),H=e,U=t.filter(x=>!x.startTime),se=a.useMemo(()=>{let x=new Map;for(let Y of t){if(!Y.startTime)continue;let M=x.get(Y.date)??[];M.push(Y),x.set(Y.date,M)}let A=new Map;for(let[Y,M]of x)for(let[k,oe]of Si(M))A.set(`${Y}:${k}`,oe);return A},[t]),re=B.getHours()*60+B.getMinutes(),ue=e.findIndex(x=>Ke(x,B)),He=ue>=0&&re>=P&&re<=W,Pe=(re-P)/60*ke,ze=(x,A,Y)=>{if(x.preventDefault(),x.stopPropagation(),A.readOnly)return;let M=Ee.indexOf(A.date);if(M===-1)return;te.current=!1;let k=A.startTime?Ne(A.startTime):P,oe=A.endTime?Ne(A.endTime):k+60;J({id:A.id,mode:Y,startX:x.clientX,startY:x.clientY,origDateIndex:M,origStartMin:k,origEndMin:oe,dateIndex:M,startMin:k,endMin:oe}),x.target.setPointerCapture?.(x.pointerId)},Re=x=>{let A=ne.current;if(!A)return;(Math.abs(x.clientX-A.startX)>3||Math.abs(x.clientY-A.startY)>3)&&(te.current=!0);let Y=x.clientY-A.startY,M=Math.round(Y/ke*60/nt)*nt;if(A.mode==="create"){let k=A.origStartMin+M,oe=Math.max(P,Math.min(A.origStartMin,k)),X=Math.min(W,Math.max(A.origStartMin,k));J({...A,startMin:oe,endMin:X>oe?X:oe+nt})}else if(A.mode==="move"){let k=x.clientX-A.startX,oe=y?Math.round(k/y):0,X=A.origEndMin-A.origStartMin,ge=Math.max(0,Math.min(we-1,A.origDateIndex+oe)),he=Math.max(P,Math.min(W-X,A.origStartMin+M));J({...A,dateIndex:ge,startMin:he,endMin:he+X})}else{let k=Math.max(A.origStartMin+nt,Math.min(W,A.origEndMin+M));J({...A,endMin:k})}},Ye=()=>{let x=ne.current;if(!x)return;if(J(null),x.mode==="create"){let M=Ee[x.dateIndex];u(M,_e(x.startMin),_e(x.endMin));return}let A=C.find(M=>M.id===x.id);if(!A)return;(x.dateIndex!==x.origDateIndex||x.startMin!==x.origStartMin||x.endMin!==x.origEndMin)&&c(A,Ee[x.dateIndex],_e(x.startMin),_e(x.endMin))},Nt=(x,A)=>{if(ne.current)return;x.preventDefault();let Y=x.currentTarget.getBoundingClientRect(),M=x.clientY-Y.top,k=P+M/ke*60,oe=Math.round(k/nt)*nt,X=Math.max(P,Math.min(W-nt,oe));te.current=!1,J({id:"__create__",mode:"create",startX:x.clientX,startY:x.clientY,origDateIndex:A,origStartMin:X,origEndMin:X+60,dateIndex:A,startMin:X,endMin:X+60}),x.target.setPointerCapture?.(x.pointerId)},Ie=(x,A)=>{let Y=A.getBoundingClientRect(),M=x.clientY-Y.top,k=P+M/ke*60;return _e(Math.round(k/nt)*nt)};return a.createElement("div",{className:"calendar-weekgrid",style:{"--week-cols":we}},g&&w&&V?a.createElement("div",{className:"calendar-weekgrid-daypicker"},w.map(x=>{let A=S?Ke(x,S):!1,Y=Ke(x,E),M=(R?.get(Q(x))?.length??0)>0;return a.createElement("button",{key:Q(x),type:"button",className:`calendar-daypick${A?" selected":""}${Y?" today":""}`,onClick:()=>V(x)},a.createElement("span",{className:"calendar-daypick-dow"},Je(x.getDay(),p.ui.language())),a.createElement("span",{className:"calendar-daypick-num"},x.getDate()),a.createElement("span",{className:`calendar-daypick-dot${M?" on":""}`}))})):a.createElement("div",{className:"calendar-weekgrid-head"},a.createElement("div",{className:"calendar-weekgrid-gutter calendar-weekgrid-headgutter"}),e.map(x=>{let A=S?Ke(x,S):!1;return a.createElement("button",{key:Q(x),type:"button",className:`calendar-weekgrid-dayhead${Ke(x,E)?" today":""}${A?" selected":""}`,onClick:()=>V?.(x)},a.createElement("span",{className:"calendar-weekgrid-dow"},Je(x.getDay(),p.ui.language())),a.createElement("span",{className:"calendar-weekgrid-dom"},x.getDate()))})),U.length>0&&a.createElement("div",{className:`calendar-weekgrid-allday${g?" calendar-weekgrid-allday--compact":""}`},a.createElement("div",{className:"calendar-weekgrid-gutter"},d("auto.1ac1ff7616a6")),H.map(x=>{let A=Q(x),Y=U.filter(M=>M.date===A);return a.createElement("div",{key:A,className:"calendar-weekgrid-alldaycol"},Y.map(M=>{let k=Ei(M,z),oe=je(M)===i;return a.createElement("button",{key:`${M.occurrenceKey??M.id}:${k?z?.nonce:0}`,className:`calendar-chip${M.borderColor?" outlined":""}${oe?" selected":""}${k?" calendar-reveal-target":""}`,"aria-pressed":oe,"data-calendar-source-id":M.sourceId,"data-calendar-item-id":M.id,style:{"--chip-color":ce(o(M)),...M.borderColor?{"--chip-border":ce(M.borderColor)}:{}},title:Xt(M),onClick:X=>{X.stopPropagation(),s(M)},onDoubleClick:X=>{X.stopPropagation(),l(M)},onContextMenu:X=>{X.preventDefault(),X.stopPropagation(),h?.(M,X)}},M.icon&&a.createElement(Fe,{id:M.icon,className:"calendar-chip-glyph"}),a.createElement("span",{className:"calendar-chip-title"},M.title),a.createElement(It,{badges:M.badges}))}))})),a.createElement("div",{className:"calendar-weekgrid-body",ref:v,onPointerMove:Re,onPointerUp:Ye,onPointerCancel:Ye},a.createElement("div",{className:"calendar-weekgrid-gutter calendar-weekgrid-hours"},de.map(x=>a.createElement("div",{key:x,className:"calendar-weekgrid-hour",style:{height:ke}},String(x).padStart(2,"0"),":00"))),e.map((x,A)=>{let Y=Q(x),M=C.filter(k=>k.date===Y);return a.createElement("div",{key:Y,className:"calendar-weekgrid-col",style:{height:de.length*ke},onPointerDown:k=>Nt(k,A),onContextMenu:k=>{k.preventDefault(),k.stopPropagation(),f?.(k,Y,Ie(k,k.currentTarget))}},de.map(k=>a.createElement("div",{key:k,className:"calendar-weekgrid-cell",style:{height:ke}})),M.map(k=>{let oe=Ei(k,z),X=je(k)===i,ge=D?.id===k.id,he=ge?D.startMin:Ne(k.startTime),Me=ge?D.endMin:k.endTime?Ne(k.endTime):he+60,pt=(he-P)/60*ke,ta=Math.max(18,(Me-he)/60*ke),mt=D?.mode==="move"&&D.id===k.id&&D.dateIndex===A,rt=D?.mode==="move"&&D.id===k.id&&D.dateIndex!==A,Xe=ge?void 0:se.get(`${Y}:${k.id}`);return a.createElement("div",{key:`${k.occurrenceKey??k.id}:${oe?z?.nonce:0}`,className:`calendar-weekgrid-block${k.borderColor?" outlined":""}${k.completed?" completed":""}${X?" selected":""}${ge&&D.mode!=="move"||mt?" dragging":""}${rt?" drag-ghost":""}${oe?" calendar-reveal-target":""}`,"aria-selected":X,"data-calendar-source-id":k.sourceId,"data-calendar-item-id":k.id,style:{top:rt?k.startTime?(Ne(k.startTime)-P)/60*ke:0:pt,height:rt?Math.max(18,((k.endTime?Ne(k.endTime):(k.startTime?Ne(k.startTime):0)+60)-(k.startTime?Ne(k.startTime):0))/60*ke):ta,"--chip-color":ce(o(k)),...k.borderColor?{"--chip-border":ce(k.borderColor)}:{},zIndex:ge&&D.mode!=="move"||mt?9:X?7:Xe?.z,...Xe?{"--block-left":`${Xe.left*100}%`,"--block-width":`${Xe.width*100}%`}:{}},onPointerDown:De=>ze(De,k,"move"),onClick:De=>{De.stopPropagation(),te.current||s(k)},onDoubleClick:De=>{De.stopPropagation(),te.current||l(k)},onContextMenu:De=>{De.preventDefault(),De.stopPropagation(),h?.(k,De)},title:`${Xt(k)} \xB7 ${_e(he)}\u2013${_e(Me)}`},a.createElement("span",{className:"calendar-weekgrid-block-time"},_e(he)),a.createElement("span",{className:"calendar-weekgrid-block-title"},k.icon&&a.createElement(Fe,{id:k.icon,className:"calendar-chip-glyph"}),a.createElement("span",{className:"calendar-weekgrid-block-name"},k.title),a.createElement(It,{badges:k.badges})),!k.readOnly&&a.createElement("div",{className:"calendar-weekgrid-resize",onPointerDown:De=>ze(De,k,"resize")}))}),D?.mode==="create"&&D.dateIndex===A&&a.createElement("div",{className:"calendar-weekgrid-block calendar-weekgrid-block--create",style:{top:(D.startMin-P)/60*ke,height:Math.max(18,(D.endMin-D.startMin)/60*ke),"--chip-color":"var(--accent-color)"}},a.createElement("span",{className:"calendar-weekgrid-block-time"},_e(D.startMin)),a.createElement("span",{className:"calendar-weekgrid-block-title"},_e(D.startMin),"\u2013",_e(D.endMin))),D?.mode==="move"&&D.dateIndex===A&&D.id!=="__create__"&&(()=>{let k=C.find(he=>he.id===D.id);if(!k||Ee.indexOf(k.date)===A)return null;let oe=(D.startMin-P)/60*ke,X=D.endMin-D.startMin,ge=Math.max(18,X/60*ke);return a.createElement("div",{className:"calendar-weekgrid-block calendar-weekgrid-block--ghost",style:{top:oe,height:ge,"--chip-color":ce(o(k))}},a.createElement("span",{className:"calendar-weekgrid-block-time"},_e(D.startMin)),a.createElement("span",{className:"calendar-weekgrid-block-title"},k.title))})())}),He&&a.createElement("div",{className:"calendar-weekgrid-now",style:{top:Pe}},a.createElement("span",{className:"calendar-weekgrid-now-time"},_e(re)),a.createElement("span",{className:"calendar-weekgrid-now-line"}),a.createElement("span",{className:"calendar-weekgrid-now-line calendar-weekgrid-now-line--today",style:{left:48+ue*y,width:y}}),a.createElement("span",{className:"calendar-weekgrid-now-dot",style:{left:48+ue*y}}))))}function Ei(e,t){return!!t&&(e.sourceId??"")===t.sourceId&&e.id===t.itemId}function ps({items:e,colorFor:t,selectedItemKey:n,onSelectItem:r,onEditItem:o,onItemAction:i,revealTarget:s}){if(e.length===0)return null;let l=e.slice(0,3),c=e.length-l.length;return a.createElement("div",{className:"calendar-chips"},l.map(u=>{let f=dn(u,s),h=je(u)===n;return a.createElement("button",{key:`${u.occurrenceKey??u.id}:${f?s?.nonce:0}`,className:`calendar-chip${u.completed?" completed":""}${u.borderColor?" outlined":""}${h?" selected":""}${f?" calendar-reveal-target":""}`,"aria-pressed":h,"data-calendar-source-id":u.sourceId,"data-calendar-item-id":u.id,style:{"--chip-color":ce(t(u)),...u.borderColor?{"--chip-border":ce(u.borderColor)}:{}},title:Xt(u),onClick:g=>{g.stopPropagation(),r(u)},onDoubleClick:g=>{g.stopPropagation(),o(u)},onContextMenu:g=>{g.preventDefault(),g.stopPropagation(),i(u,g)}},u.icon&&a.createElement(Fe,{id:u.icon,className:"calendar-chip-glyph"}),u.startTime&&a.createElement("span",{className:"calendar-chip-time"},u.startTime),a.createElement("span",{className:"calendar-chip-title"},u.title),a.createElement(It,{badges:u.badges}))}),c>0&&a.createElement("span",{className:"calendar-chip-more"},"+",c))}function Di({year:e,month:t,today:n,selected:r,weekStart:o,compact:i,itemsByDay:s,colorFor:l,onPick:c,onPickWeek:u,selectedItemKey:f,onSelectItem:h,onEditItem:g,onItemAction:w,inRange:S,onRangeStart:_,onRangeOver:R,onRangeEnd:V,onContextMenu:z,revealTarget:E}){let v=ka(e,t,o);return a.createElement("div",{className:"calendar-grid",onMouseUp:V},a.createElement("div",{className:"calendar-week-heading"},"W"),Ca(o).map(y=>a.createElement("div",{className:"calendar-day-heading",key:y},Je(y,p.ui.language()))),Array.from({length:6},(y,O)=>a.createElement(a.Fragment,{key:O},a.createElement("button",{type:"button",className:"calendar-week-number",onClick:()=>u(v[O*7]),title:d("auto.4869ac12717f")},bt(v[O*7])),v.slice(O*7,O*7+7).map(D=>{let J=s.get(Q(D))??[],ne=J.some(te=>dn(te,E));return a.createElement(ms,{key:`${D.toISOString()}:${ne?E?.nonce:0}`,date:D,outside:D.getMonth()!==t,today:n,selected:r,compact:i,items:J,colorFor:l,inRange:S(D),onPick:c,selectedItemKey:f,onSelectItem:h,onEditItem:g,onItemAction:w,onRangeStart:_,onRangeOver:R,onContextMenu:z,revealTarget:E})}))))}function Ai({year:e,today:t,weekStart:n,onPickMonth:r,revealTarget:o}){let i=Ca(n);return a.createElement("div",{className:"calendar-year"},Array.from({length:12},(s,l)=>{let c=ka(e,l,n),u=et(l,p.ui.language());return a.createElement("button",{className:"calendar-mini",key:l,onClick:()=>r(l)},a.createElement("div",{className:"calendar-mini-name"},u),a.createElement("div",{className:"calendar-mini-grid"},i.map(f=>a.createElement("div",{className:"calendar-mini-heading",key:f},Je(f,p.ui.language(),"narrow"))),c.map(f=>{let h=f.getMonth()!==l,g=Ke(f,t),w=!h&&Q(f)===o?.date;return a.createElement("div",{key:`${f.toISOString()}:${w?o?.nonce:0}`,className:`calendar-mini-day ${h?"outside":""} ${g?"today":""}${w?" calendar-reveal-target":""}`},f.getDate())})))}))}function ms({date:e,outside:t,today:n,selected:r,compact:o,items:i,colorFor:s,inRange:l,onPick:c,selectedItemKey:u,onSelectItem:f,onEditItem:h,onItemAction:g,onRangeStart:w,onRangeOver:S,onContextMenu:_,revealTarget:R}){let V=Ke(e,n),z=Ke(e,r),E=i.findIndex(y=>dn(y,R)),v=E>=0&&(o||E>=3);return a.createElement("div",{className:`calendar-day-cell ${t?"outside":""} ${V?"today":""} ${z?"selected":""} ${l?"in-range":""}${v?" calendar-reveal-target calendar-reveal-day":""}`,onMouseDown:()=>w(e),onMouseEnter:()=>S(e),onContextMenu:y=>_(y,e),onClick:y=>{y.target.closest(".calendar-chip")||c(e,y)}},a.createElement("div",{className:"calendar-day-cell-head"},a.createElement("span",{className:"calendar-day-num"},e.getDate())),!o&&a.createElement(ps,{items:i,colorFor:s,selectedItemKey:u,onSelectItem:f,onEditItem:h,onItemAction:g,revealTarget:R}),o&&i.length>0&&a.createElement("div",{className:"calendar-day-dots"},i.slice(0,4).map(y=>a.createElement("span",{key:y.occurrenceKey??y.id,className:`calendar-day-dot${dn(y,R)?" calendar-reveal-dot":""}`,style:{background:ce(s(y))}}))))}function dn(e,t){return!!t&&(e.sourceId??"")===t.sourceId&&e.id===t.itemId}function Tt(){return{acc:0,fired:!1,peak:0,lastAbsX:0,decayFrames:0,coasting:!1,reswipeAcc:0,reswipeLastAbsX:0}}function Jn(e,t,n){if(Math.abs(t)<=Math.abs(n))return{gesture:e,step:0};let r=Math.abs(t);if(e.fired){if(e.reswipeAcc!==0&&Math.sign(e.reswipeAcc)===Math.sign(t)&&r>=e.reswipeLastAbsX+3){let g=e.reswipeAcc+t;return Math.abs(g)>=60?{gesture:{...Tt(),fired:!0,peak:r,lastAbsX:r},step:g>0?1:-1}:{gesture:{...Tt(),acc:g,peak:r,lastAbsX:r},step:0}}let s=Math.max(e.peak,r),l=r<e.lastAbsX?e.decayFrames+1:0,c=e.coasting||l>=3&&r<s*.5,u=c&&r>=e.lastAbsX+6;return{gesture:{...e,peak:s,lastAbsX:r,decayFrames:l,coasting:c,reswipeAcc:u?t:0,reswipeLastAbsX:u?r:0},step:0}}let i=(Math.sign(e.acc)===Math.sign(t)?e.acc:0)+t;return Math.abs(i)<60?{gesture:{...e,acc:i,peak:Math.max(e.peak,r),lastAbsX:r},step:0}:{gesture:{...Tt(),fired:!0,peak:r,lastAbsX:r},step:i>0?1:-1}}var gs=20;function hs(e,t){return!!(e&&e.view===t.view&&e.cursor===t.cursor&&e.selectedDate===t.selectedDate&&e.rangeStart===t.rangeStart&&e.rangeEnd===t.rangeEnd)}function ys(e){if(e.rangeStart&&e.rangeEnd){let[t,n]=e.rangeStart<=e.rangeEnd?[e.rangeStart,e.rangeEnd]:[e.rangeEnd,e.rangeStart];return{selectedDate:e.selectedDate,rangeStart:t,rangeEnd:n}}return e.selectedDate?{selectedDate:e.selectedDate,rangeStart:null,rangeEnd:null}:null}function bs(){let e=yt(),t=a.useCallback(r=>e.subscribe(r),[e]),n=a.useCallback(()=>{let r=e.get();return r?.surface==="main"?r:null},[e]);return a.useSyncExternalStore(t,n,n)}function ln({variant:e="main",navigation:t}){let n=new Date,{weekStart:r,indexEntries:o}=ut(),{groups:i,dayStartHour:s,dayEndHour:l,itemClickTarget:c}=$e(),u=oa[r]??1,[f,h]=Ya(),g=bs(),w=a.useMemo(()=>Qe(),[]),[S,_]=a.useState(f.view??w.view),[R,V]=a.useState(f.cursor??w.cursor),[z,E]=a.useState(()=>({entries:[{view:f.view??w.view,cursor:f.cursor??w.cursor,selectedDate:f.selectedDate??null,rangeStart:f.rangeStart??null,rangeEnd:f.rangeEnd??null}],index:0})),v=a.useCallback(m=>{E(I=>{if(hs(I.entries[I.index],m))return I;let ye=[...I.entries.slice(0,I.index+1),m].slice(-gs);return{entries:ye,index:ye.length-1}})},[]),y=a.useCallback((m,I={})=>{let G={view:m.view??S,cursor:m.cursor??R,selectedDate:m.selectedDate===void 0?f.selectedDate??null:m.selectedDate,rangeStart:m.rangeStart===void 0?f.rangeStart??null:m.rangeStart,rangeEnd:m.rangeEnd===void 0?f.rangeEnd??null:m.rangeEnd};I.pushHistory!==!1&&v(G),m.view!==void 0&&_(m.view),m.cursor!==void 0&&V(m.cursor),Object.keys(m).length>0&&h(m)},[R,h,v,f.rangeEnd,f.rangeStart,f.selectedDate,S]),O=a.useCallback(m=>{let I=z.index+m;if(I<0||I>=z.entries.length)return;let G=z.entries[I];E({...z,index:I}),y(G,{pushHistory:!1})},[z,y]),D=e==="main"?"main_workspace":"right_sidebar";an(D,f,a.useMemo(()=>({canGoBack:z.index>0,canGoForward:z.index<z.entries.length-1,goBack:()=>O(-1),goForward:()=>O(1)}),[O,z.entries.length,z.index])),a.useEffect(()=>{if(!(e!=="main"||!t))return t.setController({canGoBack:z.index>0,canGoForward:z.index<z.entries.length-1,goBack:()=>O(-1),goForward:()=>O(1)}),()=>t.setController(null)},[O,z.entries.length,z.index,t,e]),a.useEffect(()=>{_(f.view??w.view),V(f.cursor??w.cursor)},[w.cursor,w.view,f.view,f.cursor]),a.useEffect(()=>{if(e==="right")return()=>p.interop.state.publish($t,null)},[e]),a.useEffect(()=>{e==="right"&&p.interop.state.publish($t,ys({view:S,cursor:R,selectedDate:f.selectedDate,rangeStart:f.rangeStart,rangeEnd:f.rangeEnd}))},[R,f.rangeEnd,f.rangeStart,f.selectedDate,e,S]);let J=me(R),ne=f.selectedDate?me(f.selectedDate):n,[te,B]=a.useState(!1),fe=e!=="main"||te,[we,Ee]=a.useState(1),b=a.useRef({...Tt(),idleTimer:null}),[K,P]=a.useState(null),[W,de]=a.useState(null),C=a.useRef(null),H=a.useRef(0),{items:U,itemsByDay:se,colorFor:re}=nn({focusYear:Number(R.slice(0,4))}),ue=a.useRef(null),He=a.useCallback(m=>{de(je(m)),We(m,D),ue.current&&clearTimeout(ue.current),ue.current=setTimeout(()=>{if(ue.current=null,c==="owner"&&m.kind==="sourced"&&m.sourceId){io(m.sourceId,m.id).then(I=>{I||$n(m)});return}$n(m)},220)},[c,D]),Pe=a.useCallback(m=>{if(ue.current&&(clearTimeout(ue.current),ue.current=null),de(je(m)),We(m,D),!m.readOnly){if(m.kind==="sourced"){Ut(m.sourceId??"",m.id);return}P({date:m.date,editItem:m})}},[D]),ze=_n(),Re=a.useSyncExternalStore(a.useCallback(m=>ze.subscribe(m),[ze]),a.useCallback(()=>ze.get(),[ze]),a.useCallback(()=>ze.get(),[ze]));a.useEffect(()=>{e!=="main"||!Re||(Re.item.readOnly?P({date:Re.item.date,editItem:Re.item}):Pe(Re.item),ze.publish(null))},[Pe,Re,ze,e]),a.useEffect(()=>()=>{ue.current&&clearTimeout(ue.current)},[]),a.useEffect(()=>{let m=C.current,I=m?.ownerDocument.defaultView?.ResizeObserver??globalThis.ResizeObserver;if(!m||!I)return;let G=new I(ye=>{let Ue=ye[0]?.contentRect.width??m.clientWidth;B(ft=>ft?Ue<=380:Ue<340)});return G.observe(m),()=>G.disconnect()},[]),a.useEffect(()=>()=>{b.current.idleTimer&&clearTimeout(b.current.idleTimer)},[]);let Ye=a.useCallback(async(m,I)=>{I.stopPropagation(),I.preventDefault(),de(je(m)),We(m,D),P(null);let G=++H.current,ye={x:I.clientX,y:I.clientY},Ue=await qa(m,{onEdit:()=>Pe(m)});if(G!==H.current)return;let ft=m.kind==="event"?Wa(m):m.kind==="sourced"&&Ue.length===0?Zt(m):[],gt=m.readOnly?[{label:d("auto.1cb00f4b1daf"),description:m.title,enabled:!1},...Ba(m),...Ue.length>0||ft.length>0?[]:Zt(m)]:[...m.kind==="sourced"&&Ue.some(fa=>fa.id==="edit")?[]:[{label:d("auto.5301648dcf6b"),icon:a.createElement(Ha,null),onSelect:()=>Pe(m)}],{label:d("auto.f6fdbe48dc54"),icon:a.createElement(Va,null),danger:!0,onSelect:()=>p.ui.openMenu([{label:d("auto.7c1496f9a7dc",{p0:m.title}),enabled:!1},{label:d("auto.77dfd2135f4d")},{label:d("auto.ae8a5b196587"),danger:!0,onSelect:()=>Nt(m)}],ye)}],Pt=[...Ue,...ft],Mt=Pt.length>0&&gt.length>0?[...Pt,{type:"separator"},...gt]:[...Pt,...gt];p.ui.openMenu(Mt,ye)},[Pe,D]),Nt=async m=>{m.kind!=="noteDate"&&(m.kind==="event"?await Wr(m.id):m.sourced&&m.sourceId&&await Ka(m.sourceId,m.sourced.id))},Ie=J.getFullYear(),x=J.getMonth(),A=m=>y({view:m}),Y=()=>{let m=new Date;y({selectedDate:Q(m),rangeStart:null,rangeEnd:null,cursor:`${m.getFullYear()}-${String(m.getMonth()+1).padStart(2,"0")}-01`})},M=m=>y({view:"week",selectedDate:Q(m),rangeStart:null,rangeEnd:null,cursor:`${m.getFullYear()}-${String(m.getMonth()+1).padStart(2,"0")}-01`}),k=m=>{if(Ee(m),S==="year")y({cursor:`${Ie+m}-${String(x+1).padStart(2,"0")}-01`});else if(S==="week"){let I=Kt(ne,u),G=new Date(I.getFullYear(),I.getMonth(),I.getDate()+m*7);y({selectedDate:Q(G),rangeStart:null,rangeEnd:null,cursor:`${G.getFullYear()}-${String(G.getMonth()+1).padStart(2,"0")}-01`})}else{let I=new Date(Ie,x+m,1);y({cursor:`${I.getFullYear()}-${String(I.getMonth()+1).padStart(2,"0")}-01`})}},oe=()=>{b.current.idleTimer&&clearTimeout(b.current.idleTimer),b.current.idleTimer=setTimeout(()=>{Object.assign(b.current,Tt()),b.current.idleTimer=null},80)},X=m=>{if(oe(),Math.abs(m.deltaX)<=Math.abs(m.deltaY))return;m.preventDefault();let I=Jn(b.current,m.deltaX,m.deltaY);Object.assign(b.current,I.gesture),I.step!==0&&k(I.step)},ge=a.useRef(null),he=a.useRef(!1),Me=a.useRef(0),pt=a.useRef(R);pt.current=R,a.useEffect(()=>{let m=()=>{ge.current=null,Me.current=0},I=C.current?.ownerDocument.defaultView;return I?.addEventListener("mouseup",m),()=>I?.removeEventListener("mouseup",m)},[]);let ta=m=>{if(!ge.current||S!=="month")return;let I=C.current?.querySelector(".calendar-grid");if(!I)return;let G=I.getBoundingClientRect(),ye=m.clientY<G.top+44,Ue=m.clientY>G.bottom-44;if(!ye&&!Ue){Me.current=0;return}let ft=Date.now();if(ft-Me.current<450)return;Me.current=ft;let gt=Ue?1:-1;Ee(gt);let Pt=me(pt.current),Mt=new Date(Pt.getFullYear(),Pt.getMonth()+gt,1),fa=`${Mt.getFullYear()}-${String(Mt.getMonth()+1).padStart(2,"0")}-01`,Ki=gt===1?fa:Q(new Date(Mt.getFullYear(),Mt.getMonth()+1,0));he.current=!0,y({cursor:fa,rangeStart:ge.current.anchor,rangeEnd:Ki})},mt=(m,I)=>{if(he.current){he.current=!1;return}de(null),We(null,D);let G=Q(m);if(I?.shiftKey&&f.selectedDate){y({rangeStart:f.selectedDate,rangeEnd:G});return}y({selectedDate:f.selectedDate===G?null:G,rangeStart:null,rangeEnd:null,cursor:`${m.getFullYear()}-${String(m.getMonth()+1).padStart(2,"0")}-01`})},rt=m=>{ge.current={anchor:Q(m)},he.current=!1},Xe=m=>{let I=ge.current;if(!I)return;let G=me(pt.current);if(m.getFullYear()!==G.getFullYear()||m.getMonth()!==G.getMonth())return;let ye=Q(m);ye!==I.anchor&&(he.current=!0,y({rangeStart:I.anchor,rangeEnd:ye}))},De=()=>{ge.current=null,Me.current=0},T=m=>{if(!f.rangeStart||!f.rangeEnd)return!1;let I=Q(m);return ei(f.rangeStart,f.rangeEnd).includes(I)},Z=(m,I,G,ye)=>{P({date:Q(m),startTime:I,endTime:G,kind:ye})},ot=(m,I)=>{if(m.preventDefault(),m.stopPropagation(),K)return;let G=Q(I);p.ui.openMenu([{label:d("auto.ec42f1f55523"),icon:a.createElement(st,null),onSelect:()=>Z(I,void 0,void 0,"todo")},{label:d("auto.7f8a6fad8b7c"),icon:a.createElement(ct,null),onSelect:()=>Z(I,void 0,void 0,"event")},{type:"separator"},{label:d("auto.22819a02167d"),icon:a.createElement(da,null),onSelect:Y},{label:d("auto.4869ac12717f"),icon:a.createElement(St,null),onSelect:()=>M(me(G))}],{x:m.clientX,y:m.clientY})},cn=(m,I,G)=>{K||(m.preventDefault(),m.stopPropagation(),p.ui.openMenu([{label:d("auto.ec42f1f55523"),icon:a.createElement(st,null),onSelect:()=>Z(me(I),G,void 0,"todo")},{label:d("auto.7f8a6fad8b7c"),icon:a.createElement(ct,null),onSelect:()=>Z(me(I),G,void 0,"event")},{type:"separator"},{label:d("auto.22819a02167d"),icon:a.createElement(da,null),onSelect:Y},{label:d("auto.4869ac12717f"),icon:a.createElement(St,null),onSelect:()=>M(me(I))}],{x:m.clientX,y:m.clientY}))},it=Kt(ne,u),aa=Array.from({length:7},(m,I)=>{let G=new Date(it);return G.setDate(it.getDate()+I),G}),un=S==="year"?`y-${Ie}`:S==="week"?`w-${Q(it)}`:`m-${Ie}-${x}`,Ze=S==="year"?a.createElement("h2",null,a.createElement("span",null,Ie)):S==="week"?a.createElement("h2",null,"W",bt(it)," ",a.createElement("span",null,it.getFullYear())):a.createElement("h2",null,et(x,p.ui.language())," ",a.createElement("span",null,Ie)),pn=f.selectedDate?U.filter(m=>m.date.slice(0,10)===f.selectedDate).sort((m,I)=>(m.startTime??"99:99").localeCompare(I.startTime??"99:99")):[],ar=fe&&S==="week"?[ne]:aa,$i=m=>y({selectedDate:Q(m),rangeStart:null,rangeEnd:null,cursor:`${m.getFullYear()}-${String(m.getMonth()+1).padStart(2,"0")}-01`}),Fi=["week","month","year"].map(m=>a.createElement("button",{key:m,role:"tab","aria-selected":S===m,className:`calendar-switcher-btn ${S===m?"active":""}`,onClick:()=>A(m)},m==="month"?d("auto.082bc378cd60"):m==="week"?d("auto.f82be68a7fb4"):d("auto.879e32326c52"))),Ri=a.createElement("div",{className:"calendar-actions"},a.createElement("button",{"aria-label":d("auto.50f94286ba30"),onClick:()=>k(-1)},"\u2039"),a.createElement("button",{"aria-label":d("auto.24345a14377f"),onClick:Y},d("auto.7a46866bc719")),a.createElement("button",{"aria-label":d("auto.bc981983e7f5"),onClick:()=>k(1)},"\u203A"));return a.createElement("div",{ref:C,className:`calendar-view ${e==="main"?"calendar-view-main":"calendar-view-sidebar"}${fe?" calendar-view-compact":""}`},a.createElement("div",{className:"calendar-topbar"},a.createElement("div",{className:"calendar-topbar-leading"},Ze),a.createElement("div",{className:"calendar-topbar-actions"},a.createElement("div",{className:"calendar-switcher calendar-switcher-inline",role:"tablist"},Fi),Ri)),a.createElement("div",{className:"calendar-view-body"},a.createElement("div",{className:"calendar-scroll-area","data-view":S},a.createElement("div",{className:"calendar-stage",onWheel:X,onMouseMove:ta,onMouseLeave:()=>{Me.current=0}},a.createElement("div",{className:"calendar-grid-wrap",key:un,"data-dir":we},S==="month"&&a.createElement(Di,{year:Ie,month:x,today:n,selected:ne,weekStart:u,compact:fe,itemsByDay:se,colorFor:re,onPick:mt,onPickWeek:M,selectedItemKey:W,onSelectItem:He,onEditItem:Pe,onItemAction:Ye,inRange:T,onRangeStart:rt,onRangeOver:Xe,onRangeEnd:De,onContextMenu:ot,revealTarget:g}),S==="week"&&a.createElement(Ii,{days:ar,items:U.filter(m=>ar.some(I=>Q(I)===m.date)),dayStartHour:s,dayEndHour:l,colorFor:re,selectedItemKey:W,onSelectItem:He,onEditItem:Pe,onCommit:(m,I,G,ye)=>{Vo(m,I,G,ye)},onCreate:(m,I,G)=>P({date:m,startTime:I,endTime:G}),onContextMenu:cn,onItemAction:Ye,compact:fe,weekDays:aa,selectedDay:ne,selectedTime:f.selectedTime,itemsByDay:se,onPickDay:$i,revealTarget:g}),S==="year"&&a.createElement(Ai,{year:Ie,today:n,weekStart:u,revealTarget:g,onPickMonth:m=>y({view:"month",cursor:`${Ie}-${String(m+1).padStart(2,"0")}-01`})}))),fe&&S==="month"&&f.selectedDate&&a.createElement("div",{className:"calendar-todos"},pn.length===0?a.createElement("div",{className:"agenda-day-empty"},d("auto.d669db3f6b34")):pn.map(m=>{let I=m.sourceId??m.kind,G=I===g?.sourceId&&m.id===g.itemId?g.nonce:void 0;return a.createElement(Ua,{key:`${I}:${m.id}:${m.occurrenceKey??m.date}:${G??0}`,item:m,sourceId:I,color:re(m),revealNonce:G,onClick:()=>He(m),onDoubleClick:()=>Pe(m),onContextMenu:ye=>{Ye(m,ye)}})})))),K&&a.createElement(on,{key:K.editItem?.id??`new:${K.kind??""}:${K.date}:${K.startTime??""}`,state:K,groups:i,indexEntries:o,onClose:()=>P(null),onAdded:()=>{}}))}function Ti(){return a.createElement(ln,{variant:"right"})}function Ni({navigation:e}){return a.createElement(ln,{variant:"main",navigation:e})}var sn=e=>a.createElement(p.ui.settings.Button,e),vs=({onDelete:e,label:t})=>{let[n,r]=a.useState(!1),o=a.useRef(null),i=a.useCallback(()=>{o.current!==null&&window.clearTimeout(o.current),o.current=null,r(!1)},[]);return a.useEffect(()=>i,[i]),a.createElement(sn,{className:"notedate-source-toggle",variant:n?"danger":"ghost",size:"small",onClick:()=>{if(n){i(),e();return}r(!0),o.current!==null&&window.clearTimeout(o.current),o.current=window.setTimeout(()=>r(!1),3500)},onBlur:i,title:n?d("auto.d75a293ea22a"):d("auto.c845e23963ef",{p0:t})},a.createElement(Va,null)," ",n?d("auto.04a212215ef9"):d("auto.f6fdbe48dc54"))},ws=({value:e,onCommit:t})=>{let[n,r]=a.useState(e.length?e:[""]),o=i=>i.map(s=>s.trim()).filter(Boolean);return a.createElement("div",{className:"notedate-source-show"},n.map((i,s)=>a.createElement("div",{className:"notedate-source-show-row",key:s},a.createElement("input",{className:"settings-path-input",value:i,"aria-label":d("auto.ef5ea5a743b3"),placeholder:"phone",onChange:l=>r(n.map((c,u)=>u===s?l.target.value:c)),onBlur:()=>t(o(n))}),a.createElement("button",{type:"button",className:"notedate-source-show-remove","aria-label":d("auto.4fda04775bdc"),onClick:()=>{let l=n.filter((c,u)=>u!==s);r(l.length?l:[""]),t(o(l))}},"\xD7"))),a.createElement(sn,{variant:"ghost",size:"small",className:"notedate-add-field",onClick:()=>r([...n,""])},a.createElement(st,null)," ",d("calendar.noteDate.addField")))},Pi=({variant:e,value:t,label:n,onChange:r})=>{let{ColorField:o}=p.ui.settings;return a.createElement("span",{className:"notedate-color-wrap"},a.createElement(o,{variant:e,unset:!t,value:t??Te("primary-blue"),ariaLabel:n,onChange:r}),t&&a.createElement("button",{type:"button",className:"notedate-color-clear","aria-label":d("auto.f4a0d0857b02",{p0:n}),onClick:()=>r(void 0)},a.createElement(at,null)))},xs=({icon:e,color:t,borderColor:n,onChange:r})=>{let[o,i]=a.useState(!1),s=a.useRef(null);return a.useEffect(()=>{if(!o)return;let l=u=>{s.current&&!s.current.contains(u.target)&&i(!1)},c=s.current?.ownerDocument;return c?.addEventListener("mousedown",l,!0),()=>c?.removeEventListener("mousedown",l,!0)},[o]),a.createElement("div",{className:"notedate-glyph-picker",ref:s},a.createElement("button",{type:"button",className:e?"notedate-source-swatch":"notedate-source-swatch unset",style:{...t?{"--swatch-fill":ce(t),"--swatch-on":Qr(t)}:void 0,...n?{"--swatch-ring":ce(n)}:void 0},"aria-label":d("auto.92bcda7f379e"),title:d("auto.7bf74c2d99d6"),onClick:()=>i(l=>!l)},e?a.createElement(Fe,{id:e}):a.createElement("span",{className:"notedate-swatch-none"},"\u2014")),o&&a.createElement("div",{className:"notedate-glyph-grid"},a.createElement("button",{type:"button",className:e?"notedate-glyph-opt":"notedate-glyph-opt active","aria-label":d("auto.95553ba8a405"),title:d("auto.95553ba8a405"),onClick:()=>{r(void 0),i(!1)}},"\u2014"),_o().map(l=>a.createElement("button",{key:l.id,type:"button",className:l.id===e?"notedate-glyph-opt active":"notedate-glyph-opt","aria-label":l.label,title:l.label,onClick:()=>{r(l.id),i(!1)}},a.createElement(Fe,{id:l.id})))))},ks=({source:e,entries:t})=>{let n=a.useMemo(()=>Qa(t,e),[t,e.matchKey,e.matchValue,e.folder,e.dateField,e.dateFormat,e.match]);return Un(e)?n.matched===0?a.createElement("div",{className:"notedate-source-stats warn"},d("auto.257ff123e390",{p0:e.matchKey,p1:e.matchValue})):n.dated===0?a.createElement("div",{className:"notedate-source-stats warn"},d("auto.e6ffec68b5ae",{p0:n.matched,p1:e.dateField})):a.createElement("div",{className:"notedate-source-stats"},d("auto.d4ea5b59b68b",{p0:n.matched,p1:n.dated})):null},Cs=({source:e,entries:t,onChange:n,onDelete:r})=>{let{VaultFolderField:o,SelectField:i,Toggle:s}=p.ui.settings,[l,c]=a.useState(!!e.folder),u=!e.dateFormat||gn(e.dateFormat)!==null,f=(h,g,w=!1)=>a.createElement("div",{className:w?"notedate-source-field wide":"notedate-source-field"},a.createElement("label",null,h),g);return a.createElement("div",{className:"notedate-source-row"},a.createElement("div",{className:"notedate-source-head"},a.createElement(xs,{icon:e.icon,color:e.color,borderColor:e.borderColor,onChange:h=>n({icon:h})}),a.createElement("input",{className:"settings-path-input notedate-source-title",defaultValue:e.title,placeholder:d("auto.35b023ecbb81"),"aria-label":d("auto.475b6ce898d4"),title:d("auto.4da8c4eff514"),onBlur:h=>n({title:h.target.value.trim()})}),a.createElement("div",{className:"notedate-source-color"},a.createElement(Pi,{variant:"fill",value:e.color,label:d("auto.9fa90b203761"),onChange:h=>n({color:h})}),a.createElement(Pi,{variant:"ring",value:e.borderColor,label:d("auto.981f473aa731"),onChange:h=>n({borderColor:h})})),a.createElement("div",{className:"notedate-source-actions"},a.createElement(sn,{className:"notedate-source-toggle",variant:"ghost",size:"small",onClick:()=>n({hidden:!e.hidden}),title:e.hidden?d("auto.408a0d16a8ba"):d("auto.736a07e01797")},e.hidden?a.createElement(Co,null):a.createElement(So,null)," ",e.hidden?d("auto.d97d1ee339e4"):d("auto.34d8b60fe253")),a.createElement(vs,{label:e.title||"source",onDelete:r}))),a.createElement(ks,{source:e,entries:t}),a.createElement("div",{className:"notedate-source-grid"},f(d("auto.b82220d034e7"),a.createElement("input",{className:"settings-path-input",defaultValue:e.matchKey,placeholder:"type","aria-label":d("auto.b82220d034e7"),onBlur:h=>n({matchKey:h.target.value.trim()})})),f(d("auto.2bc9464d49e9"),a.createElement("input",{className:"settings-path-input",defaultValue:e.matchValue,placeholder:"contact","aria-label":d("auto.a3fa4c4a4715"),onBlur:h=>n({matchValue:h.target.value.trim()})})),f(d("auto.691b674766e5"),a.createElement("input",{className:"settings-path-input",defaultValue:e.dateField,placeholder:"birthdate","aria-label":d("auto.691b674766e5"),title:d("auto.7bf039eeb194"),onBlur:h=>n({dateField:h.target.value.trim()||"date"})})),f(d("auto.94ee88690828"),a.createElement("input",{className:u?"settings-path-input":"settings-path-input invalid",defaultValue:e.dateFormat??"",placeholder:"dd-mm-yyyy","aria-label":d("auto.94ee88690828"),title:d("auto.8bbc96d44546"),onBlur:h=>n({dateFormat:h.target.value.trim()||void 0})})),f(d("auto.e10282ef1972"),a.createElement("div",{className:"notedate-source-inline"},a.createElement(i,{value:e.match,onChange:h=>n({match:h==="day-month"||h==="day"?h:"exact"}),options:[{value:"exact",label:d("auto.fd303c72a405")},{value:"day-month",label:d("auto.dd4b99ddaf61")},{value:"day",label:d("auto.b6f727f0c520")}],ariaLabel:d("auto.e10282ef1972")}),e.match==="day-month"&&a.createElement("label",{className:"notedate-source-inline-toggle",title:d("auto.5210c5c047ea")},a.createElement(s,{checked:e.showCount,onChange:h=>n({showCount:h}),label:d("auto.9ddab8990070")}),a.createElement("span",null,d("auto.9ddab8990070"))))),e.match!=="exact"&&f(d("auto.24bdcf2d51f8"),a.createElement("input",{type:"number",min:0,max:Xa,className:"settings-path-input notedate-source-limit",defaultValue:e.recurrenceLimitYears??"",placeholder:d("auto.48a7b8889e15"),"aria-label":d("auto.1389fda4dae3"),title:d("auto.6d07b3164ac0"),onBlur:h=>{let g=h.target.value.trim();if(!g){h.currentTarget.value="",n({recurrenceLimitYears:void 0});return}let w=Math.max(0,Math.min(Xa,Math.floor(Number(g))));h.currentTarget.value=String(w),n({recurrenceLimitYears:w})}})),f(d("auto.611f3791dc68"),a.createElement("input",{className:"settings-path-input",defaultValue:e.startTimeField??"",placeholder:d("auto.48a7b8889e15"),"aria-label":d("auto.611f3791dc68"),title:d("auto.519b42369442"),onBlur:h=>n({startTimeField:h.target.value.trim()||void 0})})),f(d("auto.aee875c4edbf"),a.createElement("input",{className:"settings-path-input",defaultValue:e.endTimeField??"",placeholder:d("auto.48a7b8889e15"),"aria-label":d("auto.aee875c4edbf"),onBlur:h=>n({endTimeField:h.target.value.trim()||void 0})})),f(d("auto.768e0c1c6957"),a.createElement("div",{className:"notedate-source-inline"},a.createElement(i,{value:e.labelMode,onChange:h=>n({labelMode:h==="property"?"property":"filename"}),options:[{value:"filename",label:d("auto.a3cbb98ddf5e")},{value:"property",label:d("auto.9ae33a7d0ecb")}],ariaLabel:d("auto.768e0c1c6957")}),e.labelMode==="property"&&a.createElement("input",{className:"settings-path-input",defaultValue:e.labelField??"",placeholder:"firstName","aria-label":d("auto.55f1c767a3b1"),onBlur:h=>n({labelField:h.target.value.trim()||void 0})})),!0),f(d("auto.d97d1ee339e4"),a.createElement(ws,{value:e.showFields,onCommit:h=>n({showFields:h})}),!0)),a.createElement("button",{type:"button",className:"notedate-source-advanced-toggle","aria-expanded":l,onClick:()=>c(h=>!h)},a.createElement("span",{className:"notedate-caret","data-open":l},"\u25B8")," ",d("auto.4d064726954a")),l&&a.createElement("div",{className:"notedate-source-grid"},f(d("auto.0623bfa38c8f"),a.createElement(o,{value:e.folder??"",onChange:h=>n({folder:h.trim()||void 0}),onCommit:h=>n({folder:h.trim()||void 0}),placeholder:d("auto.ad980036b394"),ariaLabel:d("auto.0623bfa38c8f")}),!0)))},Mi=()=>{let{Row:e}=p.ui.settings,{indexEntries:t}=ut(),[n,r]=a.useState(null);if(a.useEffect(()=>{let l=!0;return pa().then(c=>{l&&r(c)}),()=>{l=!1}},[]),!n)return a.createElement("div",{className:"notedate-settings"});let o=l=>{r(l),Ja(l)},i=(l,c)=>o(n.map(u=>u.id===l?{...u,...c}:u)),s=l=>{p.ui.openMenu([...Hn.map(c=>({id:c.id,label:d(c.labelKey)||c.label,icon:a.createElement(Fe,{id:c.patch.icon}),onSelect:()=>o([...n,ai(c.id,n)])})),{type:"separator"},{id:"blank",label:d("calendar.noteDatePreset.blank"),onSelect:()=>o([...n,Za()])}],{anchor:l,align:"start"})};return a.createElement("div",{className:"notedate-settings"},a.createElement(e,{title:d("auto.958788fc103f"),description:"Each source puts a read-only calendar entry on every note whose frontmatter matches (e.g. type: contact), reading the date from the property you name \u2014 birthdays, deadlines, anniversaries. Match decides how much of the date has to line up: the exact date lands once, day + month comes round every year, day alone every month. Set a date format when the property is not written as 1990-05-04. Icon and colours are optional; an unset colour uses the normal calendar fallback."}),n.length===0&&a.createElement(e,{title:d("auto.1780c4a5f967"),description:d("auto.65c01f7ba330")}),n.map(l=>a.createElement(Cs,{key:l.id,source:l,entries:t,onChange:c=>i(l.id,c),onDelete:()=>o(n.filter(c=>c.id!==l.id))})),a.createElement(sn,{variant:"secondary",className:"notedate-add-source","aria-haspopup":"menu",onClick:l=>s(l.currentTarget)},a.createElement(st,null)," ",d("calendar.noteDate.addSource")))};function Ss(){let e=$e(),[t,n]=a.useState({accounts:[],providers:[]}),[r,o]=a.useState(null),[i,s]=a.useState(!0),[l,c]=a.useState(null),[u,f]=a.useState(!1),h=Ct(),g=a.useSyncExternalStore(h.subscribe,h.getStatus),{Button:w,Row:S,Toggle:_,SelectField:R}=p.ui.settings,V=a.useCallback(async()=>{s(!0),c(null);try{let C=await qe(p).listCalendarConnections();if(!C.ok||!C.data)throw new Error(C.error||d("calendar.sync.accountsError"));n(C.data)}catch(C){c(C instanceof Error?C.message:d("calendar.sync.accountsError"))}finally{s(!1)}},[]);a.useEffect(()=>{V()},[V]);let z=async(C,H)=>{f(!0),c(null);try{let U=await p.settings.set(C,H);if(!U.ok)throw new Error(U.error||d("calendar.sync.saveError"))}catch(U){c(U instanceof Error?U.message:d("calendar.sync.saveError"))}finally{f(!1)}},E=(C,H,U)=>{let se=be().remoteCalendars;z("remoteCalendars",{...se,[C]:{...se[C],[H]:{...se[C]?.[H],...U}}})},v=(C,H)=>{let U=new Set(be().disabledCalendarAccounts);H?U.delete(C):U.add(C),z("disabledCalendarAccounts",[...U])},y=t.accounts.find(C=>C.id===r),O=t.providers.find(C=>C.id===(y?.oauthSetupId||y?.provider||r)),D=y?.displayName||y?.address||O?.label||O?.name||"",J=y?.capabilities.includes("calendar")&&(!y.secretState||y.secretState==="ok"),ne=!!y&&!e.disabledCalendarAccounts.includes(y.id),te=y?g.accounts[y.id]:void 0,[B,fe]=a.useState({}),[we,Ee]=a.useState(!1);a.useEffect(()=>{if(!y||!J)return;let C=!1;return Ee(!0),qe(p).listCalendars(y.id).then(H=>{C||(H.ok&&H.data?fe(U=>({...U,[y.id]:H.data.calendars})):c(H.error||d("calendar.sync.calendarsError")))}).catch(H=>{C||c(H instanceof Error?H.message:d("calendar.sync.calendarsError"))}).finally(()=>{C||Ee(!1)}),()=>{C=!0}},[y,J]);let b=y?g.calendars[y.id]??B[y.id]:void 0,K=()=>p.workspace.openSettings("accounts"),P=C=>C.secretState&&C.secretState!=="ok"?d("calendar.sync.reconnect"):C.capabilities.includes("calendar")?d(e.disabledCalendarAccounts.includes(C.id)?"calendar.overview.disabled":"calendar.sync.connected"):d("calendar.sync.permission"),W=(C,H,U,se)=>a.createElement("button",{key:C,type:"button",className:"settings-list-row calendar-account-row",onClick:()=>{o(C),c(null)}},a.createElement("span",{className:"settings-list-glyph"},a.createElement(ct,null)),a.createElement("span",{className:"settings-list-meta"},a.createElement("span",{className:"settings-list-name"},H),U&&a.createElement("span",{className:"settings-list-sub"},U),a.createElement("span",{className:"settings-list-sub"},se)),a.createElement(St,null)),de=t.providers.filter(C=>!t.accounts.some(H=>(H.oauthSetupId||H.provider)===C.id));return a.createElement("div",{className:"calendar-sync-settings settings-listpage"},r&&(y||O)?a.createElement(a.Fragment,null,a.createElement("div",{className:"settings-listpage-crumbs"},a.createElement(w,{onClick:()=>{o(null),c(null)}},d("calendar.sync.back")),a.createElement("span",{className:"settings-crumb-current"},D)),a.createElement("div",{className:"calendar-account-identity"},a.createElement("span",{className:"settings-list-glyph"},a.createElement(ct,null)),a.createElement("span",{className:"settings-list-meta"},a.createElement("span",{className:"settings-list-name"},D),(y?.address||O?.email)&&a.createElement("span",{className:"settings-list-sub"},y?.address||O?.email)),a.createElement(w,{onClick:K},d("calendar.sync.manage"))),J?y&&a.createElement(a.Fragment,null,a.createElement(S,{title:d("calendar.sync.account"),description:d("calendar.sync.readOnly")},a.createElement(_,{checked:ne,disabled:u,onChange:C=>v(y.id,C),label:d("calendar.sync.account")})),we&&!b&&a.createElement("p",{role:"status"},d("calendar.sync.loadingCalendars")),b?.length===0&&a.createElement("p",{className:"settings-empty-text"},d("calendar.sync.noCalendars")),b?.map(C=>{let H=e.remoteCalendars[y.id]?.[C.id],U=H?.enabled??C.primary;return a.createElement("div",{key:C.id,className:"calendar-sync-calendar"},a.createElement(S,{title:C.name,description:C.primary?d("calendar.sync.primary"):void 0},a.createElement(_,{checked:U,disabled:u||!ne,onChange:se=>E(y.id,C.id,{enabled:se}),label:d("calendar.sync.select",{name:C.name})})),U&&a.createElement(S,{title:d("calendar.field.groupId")},a.createElement(R,{value:H?.groupId??"",disabled:u||!ne,onChange:se=>E(y.id,C.id,{groupId:se}),options:[{value:"",label:d("calendar.sync.noGroup")},...e.groups.map(se=>({value:se.id,label:se.name,color:se.color}))],ariaLabel:d("calendar.sync.group",{name:C.name})})))}),te?.lastSyncAt&&a.createElement("p",{className:"settings-empty-text",role:"status"},d("calendar.sync.last",{time:new Date(te.lastSyncAt).toLocaleString(p.ui.language()),count:te.eventCount})),a.createElement(w,{disabled:g.syncing||u||!ne,onClick:()=>{h.sync()}},d(g.syncing?"auto.221ca63005ea":"auto.2b7d938e6787"))):a.createElement("p",{className:"settings-empty-text"},y?P(y):d(O?.configured?"calendar.sync.saved":"calendar.sync.setup"))):a.createElement(a.Fragment,null,a.createElement("div",{className:"settings-listpage-header"},a.createElement("h4",{className:"settings-label"},d("calendar.overview.accounts")),a.createElement(w,{onClick:K},d("calendar.sync.manage"))),a.createElement("p",{className:"settings-empty-text"},d("calendar.sync.description")),i?a.createElement("p",{role:"status"},d("calendar.sync.loadingAccounts")):a.createElement("div",{className:"settings-list"},t.accounts.map(C=>W(C.id,C.displayName||C.address,C.displayName?C.address:void 0,P(C))),de.map(C=>W(C.id,C.label||C.name,C.email,d(C.configured?"calendar.sync.savedShort":"calendar.sync.setupShort"))),!t.accounts.length&&!de.length&&a.createElement("p",{className:"settings-empty-text"},d("auto.7eacb0e385b4"))),a.createElement("div",{className:"settings-row-actions"},a.createElement(w,{disabled:i||g.syncing,onClick:()=>{V(),h.sync()}},d("calendar.sync.refresh")))),(l||te?.error||g.error)&&a.createElement("p",{className:"settings-path-error",role:"alert"},l||te?.error||g.error))}function Es({dayStartHour:e,dayEndHour:t}){let{NumberField:n,Row:r}=p.ui.settings;return a.createElement(a.Fragment,null,a.createElement(r,{title:d("auto.46fbb53a9be2"),description:d("auto.f07b365f8502")},a.createElement(n,{min:0,max:23,value:e,onChange:()=>{},onCommit:o=>{o!=null&&p.settings.set("dayStartHour",o)},ariaLabel:d("auto.46fbb53a9be2")})),a.createElement(r,{title:d("calendar.dayEndHour"),description:d("calendar.dayEndHourDesc")},a.createElement(n,{min:1,max:24,value:t,onChange:()=>{},onCommit:o=>{o!=null&&p.settings.set("dayEndHour",o)},ariaLabel:d("calendar.dayEndHour")})),a.createElement("span",{className:"settings-empty-text"},d("auto.808d7dca8a74")," ",Dn,":00\u2013",An,":00."," ",d("calendar.dayWindowGrows")))}function Is(){let{Button:e,Row:t,Section:n}=p.ui.settings;return a.createElement(n,{title:d("calendar.settings.groups")},a.createElement(t,{title:d("calendar.settings.groups"),description:d("calendar.settings.groupsDesc")},a.createElement(e,{onClick:()=>p.workspace.openSettings("groups")},d("calendar.settings.groups"))))}function Ds(){let{dayStartHour:e,dayEndHour:t,itemClickTarget:n}=$e(),{Row:r,Section:o,SelectField:i}=p.ui.settings;return a.createElement(a.Fragment,null,a.createElement(o,null,a.createElement(r,{title:d("calendar.settings.openItemsIn"),description:d("calendar.settings.openItemsInDesc")},a.createElement(i,{value:n,onChange:s=>{p.settings.set(no,s)},options:[{value:"owner",label:d("calendar.settings.openItemsOwner")},{value:"agenda",label:d("calendar.settings.openItemsAgenda")}],ariaLabel:d("calendar.settings.openItemsIn")})),a.createElement(Es,{dayStartHour:e,dayEndHour:t})),a.createElement(Is,null))}function As(){let{Section:e}=p.ui.settings;return a.createElement(e,null,a.createElement(Ss,null))}function Ts(){let e=Ht(),{hiddenSources:t}=$e(),{PluginCard:n,Section:r}=p.ui.settings,o=new Set(t),i=(s,l)=>{let c=new Set(o);l?c.delete(s):c.add(s),p.settings.set(Vt,[...c])};return a.createElement(r,{className:"calendar-plugins-settings"},e.length===0?a.createElement("span",{className:"settings-empty-text"},d("calendar.plugins.empty")):a.createElement("div",{className:"settings-plugin-list"},e.map(s=>{let l=s.integration,c=l?.localized?.[p.ui.language()],u=c?.name??l?.name??s.owner,f=!o.has(s.sourceKey);return a.createElement(n,{key:s.sourceId,name:u,version:l?.version??s.version,versionLabel:d("calendar.plugins.version"),author:l?.author,authorLabel:d("calendar.plugins.by"),description:c?.description??l?.description,enabled:f,onChange:h=>i(s.sourceKey,h),toggleLabel:d(f?"calendar.plugins.disable":"calendar.plugins.enable",{p0:u}),onConfigure:s.methods.includes("configure")?()=>{so(s.sourceId)}:void 0,configureLabel:d("calendar.plugins.configure",{p0:u})})})))}function Li({section:e}){return e==="dates"?a.createElement(Mi,null):e==="sync"?a.createElement(As,null):e==="plugins"?a.createElement(Ts,null):a.createElement(Ds,null)}var Oi=(e,t=[])=>({type:"object",properties:e,required:t,additionalProperties:!1}),er=e=>({type:"string",description:e});async function _i(e,t,n,r){let o=await e.commands.executeOwn(t,n,{...r,autonomous:!0});if(!o.ok)throw new Error(o.error.message);return o.value}function zi(e){return lr([{name:"list_events",description:"List Calendar events, optionally filtered by a day or month.",parameters:Oi({on:er("Optional YYYY-MM-DD day or YYYY-MM month")}),sideEffect:"read",commandId:"list",run:async(t,n)=>{let r=String(t.on??"").trim(),o=/^\d{4}-\d{2}-\d{2}$/.test(r)?{from:r,to:r}:/^\d{4}-\d{2}$/.test(r)?{from:`${r}-01`,to:`${r}-31`}:{from:"",to:""},i=await _i(e,"list",o,n);return i.length?i.slice(0,40).map(s=>`- ${s.date??""}: ${s.title??""}`).join(`
`):"No events."}},{name:"add_event",description:"Add an event to the Calendar plugin.",parameters:Oi({title:er("Event title"),date:er("Date YYYY-MM-DD")},["title","date"]),sideEffect:"write",commandId:"add",run:async(t,n)=>{let r={title:String(t.title??""),date:String(t.date??"")},o=await _i(e,"add",r,n);return`Added event "${o.title||r.title}" on ${o.date||r.date}.`}}])}function Ns(e){Mr(e),wr(e);let t=Cr(),n=e.workspace.onOpenOwnLink(h=>{let g=ua(h);g&&e.workspace.patchTimeControl(g)});e.registerView("calendar.agenda",Ci),e.registerView("calendar.panel",Ti),e.registerView("calendar.page",Ni),e.registerView("calendar.settings",Li);let r=to(),o=Wo(e),i=bi(e),s=e.interop.services.provide(gr,zi(e)),l=Jo(),c=yt(),u={id:"calendar",labelKey:"manifest.name",openDate:h=>wa(h)},f=e.interop.services.provide(pr,u);return e.interop.state.publish($t,null),c.publish(null),()=>{o(),i(),s(),l(),f(),r(),n(),t(),e.interop.state.publish($t,null),c.publish(null)}}var Ps={register:Ns},zg=Ps;export{zg as default,Ns as register};
