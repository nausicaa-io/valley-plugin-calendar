var aa="valley";var _s=`.${aa}`,zs=`app.${aa}`;function Vi(e){return e.trim().replace(/\\/g,"/").replace(/\/{2,}/g,"/").replace(/^\.?\/+/,"").replace(/\/+$/,"")}var Hi=/^[a-zA-Z]:/;function mn(e){if(typeof e!="string")return"";let t=Vi(e);return!t||t==="."||Hi.test(t)||t.split("/").some(n=>n==="..")?"":t}function ga(e){if(typeof e=="string")return mn(e)||void 0}var Le=`.${aa}`,Ui="plugins",ha=`${Le}/${Ui}`,qi="external",Ks=`${ha}/${qi}`,Rs=`${ha}/data`;var Gs=`${ha}/plugin.json`,js=`${ha}/config.json`,nr=`${Le}/state`,Pt=`${Le}/settings`,ba=`${Le}/app`,ya=`${Le}/accounts`,Vs=`${ya}/providers`,Hs=`${ya}/providers.lock.json`,Us=`${Le}/trash`,fn=`${Le}/cache`,qs=`${fn}/accounts`,Bi=`${fn}/search`,Bs=`${fn}/providers`;var Ws=`${ba}/logs`,Ys=`${ba}/whats-new`,Xs=`${ba}/setup.json`,Zs=`${Bi}/index.jsonl`,Qs=`${nr}/journal`,Js=`${nr}/txjournal`;var fa="design";var ec={app:`${ba}/app.json`,appearance:`${Le}/${fa}/appearance.json`,pallette:`${Le}/${fa}/pallette.json`,group:`${Le}/${fa}/group.json`,metadata:`${Pt}/metadata.json`,notification:`${Pt}/notification.json`,preferences:`${Pt}/preferences.json`,markdown:`${Pt}/markdown.json`,files:`${Pt}/files.json`,search:`${Pt}/search.json`,design:`${Le}/${fa}/appearance.json`,accounts:`${ya}/accounts.json`},tc=`${ya}/secrets.json`;var rr=aa,or="open";var ir=["http:","https:","mailto:","obsidian:"];var rc=[Le,`${Le}/**/secrets.json`,".git","node_modules","**/.env","**/.env.*"];var Yi=new Map;function pe(e,t,n,r,o,i,s,l,c="owner"){let u=Object.freeze({id:e,kind:t,version:n,cardinality:r,validate:o,identities:i,identityScope:c,serviceCalls:s,serviceMetadata:l});return Yi.set(`${t}:${e}@${n}`,u),u}var va="edit";function sr(e){let t=new Map(e.map(n=>[n.name,n]));return{tools:e.map(({run:n,...r})=>Object.freeze({...r})),execute:async(n,r,o)=>{let i=t.get(n);if(!i)throw new Error(`Unknown provider-owned agent tool: ${n}`);return i.run(r,o)}}}var $=e=>!!e&&typeof e=="object"&&!Array.isArray(e),le=(e,t)=>typeof e[t]=="function",ft=e=>e===void 0,Mt=e=>typeof e=="boolean",F=e=>typeof e=="string",Ae=e=>e===void 0||F(e),Xi=e=>e===void 0||typeof e=="number",Zi=e=>e===void 0||typeof e=="boolean",ee=(e,t)=>e.length===t.length&&t.every((n,r)=>n(e[r])),xe=e=>$(e)&&typeof e.ok=="boolean"&&(e.error===void 0||typeof e.error=="string"),dr=e=>$(e),Qi=e=>$(e)&&F(e.id)&&F(e.title)&&F(e.date)&&(e.documentRef===void 0||$(e.documentRef)&&F(e.documentRef.pluginId)&&F(e.documentRef.sourceId)&&F(e.documentRef.itemId)),Ji=e=>$(e)&&F(e.date)&&Ae(e.startTime)&&Ae(e.endTime)&&Ae(e.sourceId)&&Ae(e.itemId),ed=e=>$(e)&&F(e.url)&&Ae(e.title)&&Zi(e.newTab),td=e=>$(e)&&F(e.query),cr=e=>$(e)&&F(e.name)&&Ae(e.context)&&Number.isFinite(e.lng)&&Number.isFinite(e.lat),ad=e=>Array.isArray(e)&&e.every(cr),nd=e=>e===null||cr(e),rd=e=>e===void 0||$(e)&&Ae(e.approvalToken)&&(e.cancellation===void 0||$(e.cancellation)),od=e=>typeof e=="string"||$(e)&&typeof e.text=="string",id=e=>$(e)&&typeof e.name=="string"&&e.name.trim().length>0&&typeof e.description=="string"&&$(e.parameters)&&(e.sideEffect==="read"||e.sideEffect==="write")&&Ae(e.commandId)&&(e.commandDispatch===void 0||e.commandDispatch==="dynamic")&&(e.timeoutMs===void 0||Number.isSafeInteger(e.timeoutMs)&&Number(e.timeoutMs)>0&&Number(e.timeoutMs)<=3e5),ur=e=>$(e)&&F(e.id)&&F(e.label)&&Ae(e.labelKey)&&Ae(e.description)&&(e.danger===void 0||typeof e.danger=="boolean")&&(e.enabled===void 0||typeof e.enabled=="boolean")&&(e.submenu===void 0||Array.isArray(e.submenu)&&e.submenu.every(ur)),dd={list:{args:e=>e.length===0,result:e=>Array.isArray(e)&&e.every(Qi)},create:{args:e=>ee(e,[F,dr]),result:Mt},update:{args:e=>ee(e,[F,dr]),result:Mt},remove:{args:e=>ee(e,[F]),result:Mt},open:{args:e=>ee(e,[F]),result:ft},configure:{args:e=>e.length===0,result:ft},actions:{args:e=>ee(e,[F]),result:e=>Array.isArray(e)&&e.every(ur)},runAction:{args:e=>ee(e,[F,F]),result:Mt}},ld=e=>$(e)&&F(e.name)&&F(e.version)&&Ae(e.description)&&Ae(e.author)&&(e.localized===void 0||$(e.localized)&&Object.values(e.localized).every(t=>$(t)&&F(t.name)&&Ae(t.description))),Lt=pe("calendar.itemSource","service","1.3.0","many",e=>$(e)&&le(e,"list")&&(e.integration===void 0||ld(e.integration)),void 0,dd,e=>e.integration),pr=pe("calendar.itemSourceRevision","state","1.0.0","many",e=>typeof e=="number"&&Number.isSafeInteger(e)&&e>=0),mr=pe("calendar.navigator","service","1.0.0","one",e=>$(e)&&le(e,"openDate"),void 0,{openDate:{args:e=>ee(e,[Ji]),result:ft}}),Ot=pe("calendar.panelSelection","state","1.0.0","one",e=>$(e)&&(e.selectedDate===null||typeof e.selectedDate=="string")&&(e.rangeStart===null||typeof e.rangeStart=="string")&&(e.rangeEnd===null||typeof e.rangeEnd=="string")),vc=pe("web.activeContext","state","1.0.0","one",e=>$(e)&&typeof e.instanceId=="string"&&typeof e.url=="string"&&typeof e.title=="string");function lr(e){return $(e)&&typeof e.id=="string"&&typeof e.displayName=="string"&&(e.avatarUrl===void 0||typeof e.avatarUrl=="string")&&Array.isArray(e.emails)&&e.emails.every(t=>$(t)&&typeof t.address=="string"&&(t.label===void 0||typeof t.label=="string"))}var wc=pe("contacts.directory","service","1.0.0","one",e=>$(e)&&["search","resolveEmails","open"].every(t=>le(e,t)),void 0,{search:{args:e=>e.length===2&&typeof e[0]=="string"&&e[0].length<=1e3&&Number.isInteger(e[1])&&Number(e[1])>0&&Number(e[1])<=50,result:e=>Array.isArray(e)&&e.length<=50&&e.every(lr)},resolveEmails:{args:e=>e.length===1&&Array.isArray(e[0])&&e[0].length<=200&&e[0].every(t=>typeof t=="string"&&t.length<=1e3),result:e=>Array.isArray(e)&&e.every(t=>$(t)&&typeof t.address=="string"&&Array.isArray(t.contacts)&&t.contacts.every(lr))},open:{args:e=>e.length>=1&&e.length<=2&&typeof e[0]=="string"&&(e[1]===void 0||$(e[1])&&(e[1].newTab===void 0||typeof e[1].newTab=="boolean")),result:ft}}),xc=pe("contacts.directoryRevision","state","1.0.0","one",e=>Number.isSafeInteger(e)&&Number(e)>=0),fr=pe("web.navigator","service","1.0.0","one",e=>$(e)&&le(e,"open"),void 0,{open:{args:e=>ee(e,[ed]),result:ft}}),kc=pe("selection.textAction","extension","1.0.0","many",e=>$(e)&&typeof e.id=="string"&&typeof e.labelKey=="string"&&typeof e.label=="string"&&Array.isArray(e.surfaces)&&le(e,"run"),e=>[e.id]),gr=pe("geo.navigator","service","1.0.0","one",e=>$(e)&&le(e,"open"),void 0,{open:{args:e=>ee(e,[td]),result:ft}}),Cc=pe("geo.search","service","1.0.0","one",e=>$(e)&&le(e,"search")&&le(e,"reverse"),void 0,{search:{args:e=>ee(e,[F]),result:ad},reverse:{args:e=>ee(e,[t=>Number.isFinite(t),t=>Number.isFinite(t)]),result:nd}}),hr=pe("agent.toolProvider","service","1.0.0","many",e=>$(e)&&Array.isArray(e.tools)&&e.tools.every(id)&&le(e,"execute"),e=>e.tools.map(t=>t.name),{execute:{args:e=>ee(e,[F,$,rd]),result:od}},e=>({tools:e.tools}),"global"),Sc=pe("guard.runtime","service","1.0.0","one",e=>$(e)&&["resolve","requestApproval","consumeToken","audit"].every(t=>le(e,t)),void 0,{resolve:{args:e=>ee(e,[$]),result:$},requestApproval:{args:e=>ee(e,[$]),result:Mt},consumeToken:{args:e=>e.length>=1&&e.length<=2&&F(e[0])&&Ae(e[1]),result:Mt},audit:{args:e=>ee(e,[$]),result:ft}}),Ec=pe("browser.automation","service","1.0.0","one",e=>$(e)&&["list","open","switch","close","snapshot","readText","readHtml","screenshot","navigate","back","forward","reload","click","type","select","scroll","pressKey"].every(t=>le(e,t)),void 0,{list:{args:e=>e.length===0,result:xe},open:{args:e=>ee(e,[F]),result:xe},switch:{args:e=>ee(e,[F]),result:xe},close:{args:e=>ee(e,[F]),result:xe},snapshot:{args:e=>ee(e,[F]),result:xe},readText:{args:e=>e.length>=1&&e.length<=2&&F(e[0])&&Xi(e[1]),result:xe},readHtml:{args:e=>ee(e,[F]),result:xe},screenshot:{args:e=>ee(e,[F]),result:xe},click:{args:e=>ee(e,[F,t=>typeof t=="number"]),result:xe},type:{args:e=>e.length>=3&&e.length<=4&&F(e[0])&&typeof e[1]=="number"&&F(e[2])&&(e[3]===void 0||typeof e[3]=="boolean"),result:xe},select:{args:e=>ee(e,[F,t=>typeof t=="number",F]),result:xe},scroll:{args:e=>ee(e,[F,t=>typeof t=="number",t=>typeof t=="number"]),result:xe},pressKey:{args:e=>ee(e,[F,F]),result:xe},navigate:{args:e=>ee(e,[F,F]),result:xe},back:{args:e=>ee(e,[F]),result:xe},forward:{args:e=>ee(e,[F]),result:xe},reload:{args:e=>ee(e,[F]),result:xe}}),Ic=pe("fileTree.contextItem","extension","1.0.0","many",e=>$(e)&&typeof e.id=="string"&&typeof e.label=="string"&&Ae(e.labelKey)&&le(e,"run"),e=>[e.id]),Dc=pe("newTab.entry","extension","1.0.0","many",e=>$(e)&&typeof e.id=="string"&&typeof e.labelKey=="string"&&le(e,"run"),e=>[e.id]),Ac=pe("search.resultCard","extension","1.0.0","many",e=>$(e)&&typeof e.cardKind=="string"&&le(e,"render")&&le(e,"open"),e=>[e.cardKind]),na=pe("metadataPanel.segment","extension","1.0.0","many",e=>$(e)&&typeof e.id=="string"&&typeof e.labelKey=="string"&&le(e,"render"),e=>[e.id]),br=pe("workspace.surface","extension","1.0.0","many",e=>$(e)&&typeof e.id=="string"&&["left_sidebar","right_sidebar","main_workspace","footer"].includes(String(e.surface))&&le(e,"getSnapshot")&&le(e,"subscribe")&&le(e,"restore"),e=>[e.id]),Tc=pe("metadata.plugin","extension","1.0.0","many",e=>$(e)&&typeof e.id=="string"&&typeof e.labelKey=="string"&&le(e,"facts"),e=>[e.id]),Nc=pe("workspace.viewState","extension","1.0.0","many",e=>$(e)&&typeof e.id=="string"&&["left_sidebar","right_sidebar","main_workspace"].includes(String(e.surface))&&le(e,"capture")&&le(e,"restore")&&le(e,"subscribe"),e=>[e.id]);function yr(e,t){return new Date(e,t,0).getDate()}function _t(e,t,n){if(t<1||t>12||n<1||n>31)return!1;let r=new Date(e,t-1,n);return r.getFullYear()===e&&r.getMonth()===t-1&&r.getDate()===n}var sd=/^(dd|mm|yyyy)([^a-z])(dd|mm|yyyy)(?:([^a-z])(dd|mm|yyyy))?$/;function gn(e){let t=sd.exec(e.trim().toLowerCase());if(!t)return null;let n=[t[1],t[3],t[5]].filter(Boolean),r=[t[2],t[4]].filter(o=>o!==void 0);return new Set(n).size!==n.length||!n.includes("dd")||!n.includes("mm")?null:{tokens:n,separators:r}}var cd={dd:"(\\d{1,2})",mm:"(\\d{1,2})",yyyy:"(\\d{4})"};function ud(e){return e.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")}function vr(e,t){let n=gn(t);if(!n)return null;let{tokens:r,separators:o}=n,i=r.map((h,g)=>cd[h]+(g<o.length?ud(o[g]):"")).join(""),s=new RegExp(`^${i}$`).exec(e.trim());if(!s)return null;let l={};r.forEach((h,g)=>{l[h]=Number(s[g+1])});let c=l.dd,u=l.mm,f=l.yyyy;return _t(f??2e3,u,c)?f==null?{month:u,day:c}:{year:f,month:u,day:c}:null}function Qe(){let e=new Date;return{view:"month",cursor:`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}-01`,selectedDate:null,rangeStart:null,rangeEnd:null,selectedTime:null,timeRange:null}}function zt(e){if(typeof e!="string"||!/^\d{4}-\d{2}-\d{2}$/.test(e))return!1;let[t,n,r]=e.split("-").map(Number);return _t(t,n,r)}var hn=e=>typeof e=="string"&&/^(?:[01]\d|2[0-3]):[0-5]\d$/.test(e);function bn(e){if(!e||typeof e!="object"||Array.isArray(e))return null;let{start:t,end:n}=e;return hn(t)&&hn(n)&&t<n?{start:t,end:n}:null}function wr(e){let t=e&&typeof e=="object"?e:{},n=Qe();return{view:t.view==="week"||t.view==="year"||t.view==="month"?t.view:n.view,cursor:zt(t.cursor)?`${t.cursor.slice(0,7)}-01`:n.cursor,selectedDate:zt(t.selectedDate)?t.selectedDate:null,rangeStart:zt(t.rangeStart)?t.rangeStart:null,rangeEnd:zt(t.rangeEnd)?t.rangeEnd:null,selectedTime:hn(t.selectedTime)?t.selectedTime:null,timeRange:bn(t.timeRange)}}var a,p;function xr(e){p=e,a=e.React}function gt(){return p.runtime.getOrCreate("calendar.revealTarget",()=>{let e={value:null,listeners:new Set,get:()=>e.value,publish:t=>{e.value=t;for(let n of[...e.listeners])n()},subscribe:t=>(e.listeners.add(t),()=>e.listeners.delete(t))};return e})}var pd=2400;function kr(e,t){let n=p.runtime.getOrCreate("calendar.revealPulse",()=>({nonce:0,timer:null})),r=gt();if(p.workspace.patchTimeControl({...e.view?{view:e.view}:{},cursor:`${e.date.slice(0,7)}-01`,selectedDate:e.date,selectedTime:e.startTime??null,timeRange:bn({start:e.startTime,end:e.endTime}),rangeStart:null,rangeEnd:null}),n.timer&&clearTimeout(n.timer),r.publish(null),e.itemId){let o={surface:t,sourceId:e.sourceId??"",itemId:e.itemId,date:e.date,nonce:++n.nonce};r.publish(o),n.timer=setTimeout(()=>{r.get()?.nonce===o.nonce&&r.publish(null),n.timer=null},pd)}}function wa(e){kr(e,"main"),p.workspace.openMainTab()}function Cr(e){kr(e,"agenda"),p.workspace.revealOwnPanel("left_sidebar")}var md=`
